...
\node [anchor = east,color=red] at (16,18){$ \frac {R}{2 \sqrt{\lambdabar_p \lambdabar_H}}  = \sqrt{\frac {H}{p} (\frac {M}{m_e}  = \frac {d}{\lambdabar_e})} = \frac {\hbar c}{Gm_em_p}  $};


\node [anchor = east,color=red] at (-15,18){$ 3^{3^3-1} \approx (2^{2^2-1})^{\sqrt {a_{00}}/2} \approx a^ {(\frac {137}{a})^2\sqrt {a_s}/2} \approx {a_s}^{a^{11}/P} $};
