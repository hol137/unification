...
\begin{equation}
 \left\{
    \begin{array}{ll}
    2h_1^4 \approx 2+3+5+7 = 17 \\
    h_1^{10} \approx \mu_0            ~~~~\Rightarrow ~~~~ h_1^{14} \approx \tau_0/2 ~~~~\Rightarrow \\
    ~~~~~~~~ \mu_0^7 \approx (\tau_0/2)^5 ~~~~ \rightarrow ~~~~ (\mu p_t/n_t)^7 \approx (\tau n_t/2p_t)^7 ~~~~\rightarrow~~~~ n_t/p_t \approx (61/60)^{1/12}\\
    \\
...
These relations confirm the arithmetic character of the physical parameters. The overwhelming liaison with the U(1) coupling $g_1$ and $a_s$ opens future research.
