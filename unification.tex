...
\node [anchor = north,color=red] at (-10, 33) {$\hbar,G, u  m_{bicodon}, m_{photon}, m_{graviton} \Rightarrow  R_{Cosmos} = R_e^2/2l_P  \approx \lambdabar_e \frac {6^{128}}{1+1/\sqrt 2} \approx l_P (6^{p_G/sqrt a} \approx \Phi^{17a^2/ (4\times 137)} \approx 3570^{137/4}) $};
