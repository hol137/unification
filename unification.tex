...
\begin{table}
\caption[Table \ref{CosmosTable}: 28 Cosmos radius formula]{28 formula for the Cosmos radius $R_C$}
\label{CosmosTable}
  \hskip-2.0cm\begin{tabular}{lll}
    \toprule
   % \multicolumn{3}{c}{}                   \\
