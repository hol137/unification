...
\node [anchor = west,color= red] at (-14.2,-23.3) {$ \frac {ct_1}{0.6l_1} \approx \frac {l_1}{r_{ADN}} \approx \frac {p_{hol}^3}{4\pi} \approx 150^4 \approx p^{8/3}  ~~~~~~~~~ v_T = \frac {2\pi R_T}{Jour} \approx \frac {p_{hol} l_1}{4t_1} ~~~~~~~~~ r_{ADN} \approx 2 nm  $};
...
\node [anchor = west,color= red] at (-25.2,-25.6) {7s+6p+4d+df = $ 7\times 2 + 6\times 6 + 4\times 10 + 2\times 14 = 118 $ (Ogamesson) };
\node [anchor = west,color= red] at (-27.2,-27.1) {$ 7\times (2+1) + 6\times (6+1) + 4\times (10+1) + 2\times (14+1) = 107 + 30 = 137 \approx a = a cos^2 \theta + a cos^2 \theta$ };

\node [anchor = west,color= red] at (-27.2,-28.6) {$ (2+1) + (6+1) + (10+1) + (14+1) + (18+1) + (22+1) + (26+1) + (30+1) = 2^7 + 2^3 = 136 $ };
