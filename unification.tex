...
Rap. de masse Proton/Electron $m_p/m_e$ ;~$n_t/p_t \approx (4\pi (p_W/p_t)^2)^{1/\sqrt{p_tn_t}} \approx (n_t-p_t)^{1/(26p_t/n_t)^2} $ & $p_t$   & \underline {1836.15267343}  & 0.06 ppb \\ 
 Ct. de   Wyler  \cite{Wyler} $ p_W = 6\pi^5 \approx (ap_t/137)^2/H \approx \sqrt p_t (s_{65}\sqrt {p_{00}}/p_{Ed})^3 /H\approx (Hp_{00}^7)^{1/2}/p_t^3$ & $p_W$   & \underline {1836.118109}  & $P \approx a_w \sqrt a n_t^3 (p_W/p_t)^5$ \\ 
 ...
 Rap. de masse   Neutron/El. ~ $n_t \approx (\pi^2{\color{black}W_5}/4)^3 \approx  (WFe_2\beta/Z^2)^2/d_e \approx p_t (61/60)^{1/12} $  & $n_t$ & 1838.6836617  & 0.5 ppb $n_t\approx  p_t + 1 +1/g_0 $\\     
 ...
 R23W pour $d$ = 8:  Eddington's formula\cite{Eddington}: $u_{8}= 136 + 1$ & $u_{8}$   & $ \underline {137} $ & $v_{8}= 495 + 496$ \\      
  ...
  $u_{2d} = 1 + 2d(4d+1)$ Bisection of odd central polygonal numbers for \underline {d = 4}  & $a_{00} $    & \underline {137}  & OEIS (A188135) \\
   % Eddington-Atiyah constant $2^7 + 2^3 + 2^0$  & $a_{00}$    & $\underline {137}$ & from three algebra \cite{Atiyah} \\
    ...
    %Square root of $105^2 + 88^2 $, where 105 = Part(19) , 88 = Part(18)    & $a_{00}$    & $\underline {137}$ & $88 \times 105 = 5\times s_{65}$ \\
    Sum {\color{black}u$'_1$} = $ u_1^2 + u_2^2$ implying usual 4D  and supergravity 11D    & $a_{00}$    & $\underline {137}$ & $u_1 = 4$; $u_2 = 11$ \\
    Troisième terme de la HYiérarchie Combinatoire $(2^2-1) + (2^3-1) + (2^7-1)$  & $a_{00}$    & $\underline {137}$ & \cite{Bastin} $\Rightarrow$ 4 = 3 + 1 \\ 
    El. Ct. $a = \alpha^{-1} = c/v_1(1+1/p_t)$~;~$ln\pi \approx \pi_q -2 \approx p_t\beta^4/a^{3/2}\approx 1+320/(33\times67)$  & $a$    & $\underline {137.035999084(21)}$ & 0.15 ppb ;~$aq^2= 4\pi_q$\\
    Opt. ser. with $p_{W2} = 3511 = p_{495}-28$, the Wieferich prime: $137 + 1/28 + 1/p_{W2}$  & $a_0$    & $\underline {137.035999104}$ & $p_{W2}\approx 18\pi\sqrt6 \beta\tau/ad_e $ \\
...
Charge électrique $q \approx e^{-16a/p_t} \approx (3/10)\sqrt(6F)/p_{00} \approx (6^2/\beta d_e)^{-1/3}\approx (6\mu/137g_0\Gamma)^2$  & $q$ & 0.30297311 & $6 \approx 2^{137/53}$ (indian music) \\
 ...
 Couplage SU(2)-Gravitational $p_tp_G/2a^3 \approx g_1\tau p^2 p_{Ed}/H^4$ & $ g_0$  & $ 0.6534149985$ & 1 ppb, this work \\
  ...
  Opt. "Sq. Ef. $(m_Z)$ Weak-mixing angle" $e/ 32 sin \theta  (cos \theta)^2 \approx (ln\Phi)^2 (a/137)^{1/2}$  & $(\sin \theta_{1})^2$    & 0.2315965 & $(\sin \theta_{1})^2_{mes}$: 0.23153(4) \\
Rap. de masse DNA Adenine-Thymine /$m_H$: $o_1\approx\mu g_0/g_1g_2 \approx o_2 \mu/\Pi_0 g_2g_3\approx o_24g_2g_3/\pi $  &  $o_1 $   & 612.312280 & \cite{Huang} \\
Rap. de masse DNA Guanine-Cytosine/$m_H$: $o_2 \approx \ p_t/3g_1 \sqrt a_s \approx \Pi_0 g_0g_3/g_1 $  &  $o_2$   & 613.299802 & \cite{Huang} \\ 
 Rap. de masse Muon/El. mass ratio $\mu \approx Z (sin\theta)^9 \approx 1/g_1^5 -2\approx (n_t/p_W)^{1/2}Fa^{3/2}/9\pi W$ & $\mu$ & 206.7682869  & $\mu_{mes}$: 206.7682830 \\     
Rap. de masse Tau/El. ratio, with $p_K =(1+\mu+\tau) /2 = (1+\sqrt\mu+\sqrt\tau)^2/3~; ~\tau \approx 120/61g_1^7$ & $\tau$ & 3477.441701  &  $\tau_{mes}$: 3477(2) \\ 
...
Rap. de masse de Fermi : $\sqrt {a_w} \approx (4\pi/3)(lnP)^3\approx (y\Pi_+/2d_eq)^2\approx (p_t/n_t) (137aa_s)^2/4\pi \tau$ \cite{Sanchez2} & $F$   & 573007.3652  & $F_{mes}$: 573007.362 \\
