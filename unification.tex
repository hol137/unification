...
The Number Theory comes back as the heart of an unified Science, in a Computing Cosmos using the bases 2;3;5;7 whose two symmetric combinaisons explain the main lepton masse ratios. The corresponding Holic Principle induces a symmetry between the Newton and Planck constants which confirms the Permanent Sweeping Holography Bang Cosmology, with invariant baryon density 3/10, the dark baryons being dephased matter-antimatter oscillation.
...
\right.
\end{equation}
 and a partition of 1839, \textit{showing the arithmetic origin of the DNA bi-codon partition in 6 nucleotides.} The number of nucleons in the Guanine is 329, see below, while $ N_9 + K_9 = 495 = \sqrt{H^{(0)}} $. 
%\begin{equation}
