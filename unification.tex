...
\node [anchor = west,color= red] at (-27,-28.5) {$ 2^{1/665} \approx 3^{1/1054} \approx (a/137)^4 \approx 4g_1g_Z \approx (sin\theta)^{-3571/a^3} \approx S^{p_G/a^3} \approx g_1^{-1/2^{10}} \approx g_0^{-9/2H} \approx (R_C/\lambdabar_e)^{(2\pi^2 + 1)/e^{16}} ~;~ (R_C/\lambdabar_e)^{(2\pi^2} \approx 137^{1836} \approx \phi^{137^2}  $ };
