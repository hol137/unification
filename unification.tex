...
\node [anchor = west,color=blue] at (20.,20.0){$R_{HUBBLE}~\times$ 6};
...
\node [anchor = east ,color=red] at (21.5,20.5){~$f(26)/6 \approx 2^{2^7}\approx 2 (f(31/2))^6 \a pprox (f(-5))^{211} \approx R \approx (2R/R_e)^{210}\approx(6/\pi)^a    $~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
