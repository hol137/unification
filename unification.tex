...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Ext. Max. Numb. of Inters. of Diagonals from a 16-gone $1836\approx (3a^3/20q)^{1/2}/g_2^2g_3^2$ & $p_{00}$   & \underline {1836} $\approx(a^3/\Phi sin \theta)^{1/2}$ & OEIS (A000332 + n) \\ 
