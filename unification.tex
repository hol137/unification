...
\node [anchor = west,color= red] at (-26.5,-29.6) {~~~~~~$ \frac {1}{g_1g_2g_3} \approx g_1\frac {2a^2}{\tau} \approx \frac {g_2}{2} \sqrt {\frac {Hç 0}{p}}\approx \frac {H}{\sqrt {H^0}}  $};
...
\node [anchor = east,color=red] at (-3,2) {$\Phi_0^{18} \approx 48 \approx \Phi^7 + 1 $};
