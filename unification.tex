...
\node [anchor = east,color=red] at (24,24.250){Synthèse triconceptuelle : $\hbar,G, m_{3570}^3 \rightarrow 2l_K \rightarrow masse_{photon} \approx masse_{graviton} \times (a_w \approx \frac {f(26)} {f(24)}$};
