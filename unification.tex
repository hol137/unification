...
\node [anchor = west,color=black!40!green] at (0.,0.0) {\LARGE{BI-CODON d'ADN~$\times~\Phi_0^2$}};
\node [anchor = east,color=black!40!green] at (0.,0.0) {$m_e~f(16) / \Phi_0^2 \approx H m_H \approx $ masse du}};
...
\node [anchor = east ,color=red] at (13.3,16.0){$f(24)= e^{64} = (f(12))^8\approx~ $ NOMBRE DU MONSTRE $/H^8$~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
