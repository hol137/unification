...
Opt. El. charge $q \approx 3/\pi^2 \approx (3/10)\sqrt(6F)/p_{00} \approx (6^2/\beta d_e)^{-1/3}\approx (6\mu/137g_0\Gamma)^2 \approx 2 a^{1/4} (8/5)^8 \tau/pH$  & $q$ & 0.30297311 & $6 \approx 2^{137/53}$ (indian music) \\
