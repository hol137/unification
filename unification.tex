...
\node [anchor = east,color=red] at (0.5{$\frac {R}{2\lambdabar_e} \approx N_{Lucas} = 2^{2^{2^{2^2-1}-1}-1}-1$};
...
%\node [anchor = east,color=black!40!green] at (22.75,-20.250){\LARGE{MACRO-PHYSIQUE}};
