...
This series has been deduced from the fact that $u_30 = v_{12} = w_{15} = 1831 \approx p_G$ (table 1). 

\textit{This shows clearly that the compactification operates from the Topologic dimension 30, by groups of 3 dimensions, where 12 is the half of the 24 transverse dimensions. The 4D appears as 3D + 1D, separatibg the Space from the Time. The latter 1D is interpreted as the predicted Hol sweeping of the Universe \cite {Sanchez1}} 
