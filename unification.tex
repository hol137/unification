...
\section{The Topological Axis, the Weak Bosons and the $8^{th}$ Weigel number $K_8 = 165$}
...
The EOIS presents the crystallographic series (A120963), without citing Herman, the first discoverer. By contrast, there is a reference to the Weigel team, but without presenting the specific series of positive symmetry number 1,5,5,19,19,59,59,165,165,419,419,1001,1001,... (Table 7), which shows here a paramount importance, connected with the string dimensional compactification. The Weigel series (Table 7) shows up the following "transdimensionnal Weigel Theorem": the number of positive operations is the same for dimensions 2n and 2n+1. Moreover, the number of positive operations in dimension $n$ is equal to the number of negative operations in dimension $n+1$. This implies that, for an odd dimension the number of positive and negative operations are equal. Among these numbers, 165 is both the number of positive point operations in dimensions 8 and 9, and also the number of negative point operations in dimensions 9 and 10. 
