...
\node [anchor = west,color= red] at (-7,-7.9) {$ 4a^3/3 \approx (a-136)^{1/2} (1836^2 + a -44 (2\times 153)^{1/5}) \Rightarrow a \approx 137.035999099043  $};



\node [anchor = east,color= red] at (-5.5,-9.9) {~~~~~~$ \Phi^{210} \approx p^{p/a} \approx RAM_{1836} \approx P^2a \frac {\sqrt {Hn_t}}{p} ~~ (2~ ppm) $};

\node [anchor = west,color= red] at (-5.5,-9.9) {$ (\frac {ln(a^{3/2}/3)}{2})^2 - \frac {a(2pp_G)^{1/2}}{Hn_tp_{hol}} \approx a^2 - 137^2 = \pi_a^2  ~~~~\Rightarrow  a \approx 137.0359909944$};
