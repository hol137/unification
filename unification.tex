...
%{\color{red} 
%\begin{abstract}
 Dramatic confirmations of the previous article "Towards Science Unification Through Number Theory" are presented. The Pell-Fermat and Lucas-Lehler numbers are central in confirming the liaison between the electrical constant a, the gauge couplongs and the Topological Axis function
...
These relations confirm the arithmetic character of the physical parameters. The overwhelming liaison with the U(1) coupling $g_1$ and the strong coupling $a_s$ opens future research.
...
\begin{equation}
 \left\{
    \begin{array}{ll}
    T/t_e \approx 33 f(30)/32 \approx e^a 2^{l27/2} \approx F^4 O_M (p_G/a)^{3/2}\\
    \\
