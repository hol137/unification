...
\node [anchor = north] at (-14.8, 33.6) {$\tiny{R_C/\lambdabar_e \approx e^{e^{e^{e^{e^{-\tiny{g_2}}}}}}} ~~~~~g_2 = m_W/m_{HIGGS} ~~ ~  f(32) = e^{2^{2^{2^{2}}}} \approx (R_C/\lambdabar_e)(\tau/n_t)^{128/3} ~~~~~~~~~~~~~~~~ (4\pi^2/3)(R_C/r_H)^3 \approx a^a$};
