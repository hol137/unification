...
\node [anchor = east,color=red] at (37,16){$ 3^{3^3-1} \approx (2^{2^2-1})^{\sqrt {a_{00}}/2} \approx a^ {(\frac {137}{a})^2\sqrt {a_s}/2} \approx {a_s}^{a^{11}/P} \Rightarrow a^a \approx (\sqrt {a_s} ^  {1/ \sqrt {a_s}})^{\sqrt {pH}} 
...
\node [anchor = west,color=red] at (15,22.5){ $ R = \sqrt{\lambdabar_p\lambdabar_H} (WZ)^4 \approx \frac {\lambdabar_e}{f(\sqrt a)}(\frac {Z}{W})^{5\times 153} $};
...
\node [anchor = east,color=red] at (-22,15){$  \frac {f(e^{\pi})} {f(23)} \approx \frac {g_0 495 \beta^{1/4}} {2 \sqrt {1836}} $};
