...
\node [anchor = east,color= red] at (-15.5,-14.5) {~~~~~~$ w_5 \approx \frac {2a^2 sin \theta}{3570-1} \approx (a_s \sqrt {\pi e})^{1/2} $ };

\node [anchor = east,color= red] at (-15.5,-15.5) {$\Delta_{Ed} = \sqrt{136^2-40} \approx 2a/\pi g_2$};
