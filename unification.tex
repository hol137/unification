...
\node [anchor = east,color=red] at (13.25,14.5){FREQUENCE COSMO-NEURONALE 52,255 Hz $ \rightarrow $ Lab (La = 442,9 Hz)  };
...
\node [anchor = east,color=red] at (0,26.250){Synthèse triconceptuelle : $\hbar,G, m_e, m_p, m_H \rightarrow R/2$};
\node [anchor = east,color=red] at (0,25.250){Synthèse triconceptuelle : $\hbar,G, m_N^3 \rightarrow R_e/2$};
\node [anchor = east,color=red] at (20,24.250){Synthèse triconceptuelle : $\hbar,G, m_{3570}^3 \rightarrow 2l_K \rightarrow masse_{photon} \approx masse_{graviton} \times (a_w \approx \frac {f(26)} {f(24)}$};
\node [anchor = east,color=red] at (0,23.250){Synthèse triconceptuelle : $\hbar,G, m_e, m_p, m_H \rightarrow R/2$};
