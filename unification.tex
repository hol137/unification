...
The Lucas-Lehmer sequence (A003010) is defined by the cmosest intgers to $h_3^{2^n}$, where $h_3 = \sqrt3 + 2$. These numbers are related to $u = 2a^2$, and $g = g_1g_2g_3 \approx 1/h_3$ throught:
\begin{equation}
 \left\{
    \begin{array}{ll}
...
This confirms the pertinence of the gauge coupling and their product $g$.




\section{The Topological Axis term f(30)}

\subsection{Connection with Dimensional Analysis}
...
\subsection{Connexions with the Gauge Couplings}
