...
\node [anchor = east,color=red] at (32.,22.5){$RAM_{1836}\approx P^2 a\sqrt{H/n_t}/p ~(2 ppm) ~ \approx (O_MO_B)^{1/2} \approx f(a^{2/3}) \approx f(2p/a)  \approx a^{2a^2/n_t} \approx p^{p/a} \approx e^{32\pi} \approx \Phi^{210} \approx \phi^j $};
