...
\node [anchor = east,color=red] at (35.7,15.75){$ 3^{3^3-1} \approx \frac {R_e}{3\lambdabar_e} \approx (2^{2^2-1})^{\sqrt {a_{00}}/2} 
\approx a^ {(\frac {137}{a})^2\sqrt {a_s}/2} \approx {a_s}^{a^{11}/P} \Rightarrow a^a \approx (e ^ {1/e})^{p_G\sqrt {n_t/p} } \approx (\sqrt {a_s} ^  {1/ \sqrt {a_s}})^{\sqrt {pH}} 
...
\node [anchor = east,color=red] at (10,25.5){$ 3^{3^3-1} \approx \frac {R_e}{3\lambdabar_e} \approx (2^{2^2-1})^{\sqrt {a_{00}}/2} 
...
\node [anchor = east,color=red] at (9.5,24.5){Synthèse triconceptuelle : $\hbar,G, m_e, m_p, m_H \rightarrow R/2~~;~~ \hbar,G, m_N^3 \rightarrow R_e/2  $};

\node [anchor = east,color=red] at (16,22.5){ $ u = R_e/R = Hp/a^3 \approx e^{2/e^2}  $ ~~(1.6 ppm) ~~ $ p \approx p_W = 6\pi^5 \approx \frac {a^2d_e}{1836} (2-ln2)^2 \sqrt {\frac {p}{p_G} }$ ~~ (30 ppb)};
