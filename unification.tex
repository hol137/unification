...
\node [anchor = east,color=red] at (35.7,26){$ 3^{3^3-1} \approx \frac {R_e}{3\lambdabar_e} \approx (2^{2^2-1})^{\sqrt {a_{00}}/2} 
\approx a^ {(\frac {137}{a})^2\sqrt {a_s}/2} \approx {a_s}^{a^{11}/P} $};
