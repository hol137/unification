...
\node [anchor = text=black] at (-13.,33.75) {\small{Unité de longueur: longueur d'onde Compton de l'électron $\hbar /m_e c=\lambdabar_e = ct_e$}};
...
\node [anchor = east,color=black!40!green] at (26.95,22.50){$\sqrt a sin \theta (H/p) f_3(1/(a-137)) \approx e^a \Rightarrow a \approx 137.0359999099=$ confirmé (1 ppb)~~~~~~~~~~~~};
