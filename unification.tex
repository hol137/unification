...
\node [anchor = west,color= red] at (-18.5,-15.8) {~~~~~~$sin \theta \approx \frac {2\pi (a+1)}{H \sqrt{d_1e}} \approx \frac {a^3}{ \Phi(1836$ 2 -(e/sin \theta)^2)} \approx (\frac {1}{\Phi^3} - \frac {1}{\Phi^9})^{1/2} \approx \frac {g_2}{\Phi^{g_2}}  \approx \frac {\Phi^{g_1}}{g_1}-1$} ;
