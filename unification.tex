...
In the recently published article (DOI 10.4236/apm.2021.111004), several direct dramatict consequences were omitted. Thid notes resumes the main ones.

\section{The Topological Axis, the Weak Bosons and the WFV number $K_4 = 165$}
Considering the ultimate dimension $d = 30$ of the Topological Axis and the optimal base 3, one observes:
