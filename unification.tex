...
\node [anchor = west,color= red] at (-21.5,-22) {7\underline {s}+6\underline {p}+4\underline {d} = $ 7\times 2 + 6\times 6 + 4\times 10 + 2\times 14 = 118 $ (atome Ogamesson) };

\node [anchor = west,color= red] at (23.5,-21.5) {$p_K = \frac {1 + \mu +\tau}{2} \approx \frac {137p_G(N_0^2-1)}{a\sqrt {Hp}}  $};
