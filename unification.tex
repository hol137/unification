...
\label{tab:2:table2}
 ...
 %   Rel. Rad. Ratio $ u_{CMB + CNB}/u_{CMB} = 1 + 3 (7/8) (4/11)^{4/3} \approx (Fp_t/aW)^4 n_t/H^3 \approx p_tn_t/Hp_{W1}$  &  $y$  & 1.681321953  & $p_{W1}$ = 1093 %(A001220) \\
    
    Scale-factor $8\pi^2/ln2 \approx (2^4 q)^3 \approx i^{\pi/i}/g_3 \approx (i^{\pi/i}-1)/4q \approx \pi \Delta'_{Ed}/8 \approx (\Phi^4/g_2)^2$  & $j$ & 113.9106346  & \cite{Sanchez2} $j \approx T_{mam}/T_{CMB}$ \\\approx ()^4
