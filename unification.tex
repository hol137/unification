...
%\label{tab:4:table4}
  \hskip-0.0cm\begin{tabular}{llllllllllllll}
    \toprule
    \multicolumn{14}{c}{Table \ref{tab:4:table4} : Number of Crystallographic Ponctual Symmetry operations $N_d$, Euler ideodal Numbers and Rule 23 Wolfram series $u_d$}                  \\
    \cmidrule(r){1-14}
