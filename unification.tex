...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Golden ratio and Black Body Photon Constant $\phi = \lambda/l_{ph} = (16\pi \zeta(3))^{1/3}$ & $\Phi\approx \phi g_2^2$  & 1.61803398874990 & $\zeta(3) \approx 1.20205691$ \\ 
 ...
 Rad. Rat. $ u_{CMB + CNB}/u_{CMB} = 1 + 3 (7/8) (4/11)^{4/3} \approx (Fp_t/aW)^4 n_t/H^3 \approx p_tn_t/Hp_{W1}$  &  $y$  & 1.681321953  & $p_{W1}$ = 1093 (A001220) \\
