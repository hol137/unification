...
\node [anchor = east,color=blue] at (25.0,8.25){$f(20) = e^{2^5}  \approx (5/3)^{2^6}/2 ~ \approx \frac {\sqrt{m_Pm_F}}{\pi_a sin\theta} \approx \frac {sin^2 \theta l_0 }{r_H} \frac {l_0 }{sin \theta  \sqrt {\lambdabar_e \lambdabar_{\mu} }  }$};
