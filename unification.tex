...
\node [anchor = east,color= red] at (-16,-8.9) {~~~~~~$ (a^2)^{a^3} \approx p^{p^2}$};
\node [anchor = east,color= red] at (-16,-10.9) {~~~~~~$ \Phi^{a} \approx a^{p/a}$};
\node [anchor = east,color= red] at (-16,-12.9) {~~~~~~$ \Phi^{210} \approx p^{p/a}$};
