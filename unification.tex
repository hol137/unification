...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Lucas Large Prime Number, follows 3,7,127 ~~;~~ $P^{3+7}\approx a_w^7 (\sqrt a)^{7+127}~~Rightarrow~ (P/a_w\sqrt a)^7  \approx (\sqrt a)^{127}/P^3)^{1/7} \approx n_t^3  $  & $n_L$    & $2^{127}-1$  & \cite{Bastin}Comb. Hiearachy  $$ \\
