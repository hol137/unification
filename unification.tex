...
\node [anchor = east,color= red] at (-16.5,-16) {~~~~~~$ w_5 \approx \frac {2a^2 sin \theta}{3570-1} \approx (a_s \sqrt {\pi e})^{1/2} $ };

%\node [anchor = east,color= red] at (-16.5,-16) {$\Delta_{Ed} = (136^2-40)^{1/2} \approx 2a/\pi g_2$};
