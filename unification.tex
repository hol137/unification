...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Euler-Napier constant and associated optimal numbers, $e_2 = e^e~;~ e_3 e^{e^e}~;~ e_4 = e^{e^{e^e}} $  & $e$    & 2.718281828459042 & optimal base \\    
...
Eta-Tau mass ratios product  & $ \eta \tau$ with Kaons $K_0 \approx 973.78 and K_+ \approx 966.12  & \underline{$3.728~\times 10^6$}  & $\approx 3K_0K_+p_k^2/a^3 $\\
