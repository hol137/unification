...
\node [anchor = east ,color=blue] at (19,20.2){~$\frac {f(26)}{6} \approx 2^{2^7} \approx 2 f(\frac{31}{2})^6 \approx (f(-5))^{211} \approx (\frac{2}{\Phi})^{2\times 209} \approx R \approx (\frac{2R}{R_e})^{210}\approx(\frac{6}{\pi})^a \approx(\frac{g_3}{g_2})^{a_{00}-1}    $~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
