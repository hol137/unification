...
{\color{red} Contrary to old tradition, the present science shows separated disciplines. In particular, the Number Theory plays a marginal role in Physics. Even the String Theory shows no connection with Reality. Worse, the two pillars of Physics does not agree on the real status of space-time, and the standard physics contains about 30 "free parameters". In the frame of the Permanent Sweeping Holographic Oscillatory Bang model (PSHOB), this article connects the Number Theory with a gravitation-reunified Physics where the final dimension 30 of the Topological Axis reduces to unity, through 12D and 4D compatifications. This 1D Holography means a Sweeping Absolute Space, justifying at last the local time relativity for a moving object. The Euler maximal suitable number plays a central role, showing a connection with the generalised Riemann conjecture. The superstring dimension 11 is identified with the first prime of the base 3 Mirimanoff couple, in connection with 137, while the second prime of the base 2 Wieferich couple defines the fine-structure constant within its 0.15 ppb indetermination. This confirms the Atiyah approach and the Eddington's Fundamental Theory, in particular the non-standard symmetry proton-tau. This "forgotten symmetry", as well as several others described in this article, explain the failure of the present supersymmetry. In particular the symetry between Newton and Planck constants, tied to the mass concept, and the symetry eta-tau, tied to a basic economic number. The Economic Computation Principle and the Holic Principle justify at last the origin of the main particle masses. This implies physical, chemical, biologic and cristallographic parameters untill 0.1 ppm precision. This excludes the concepts of Multiverse, Continuum, Infinity, Locality and Zero mass Particle, and leads to stringent predictions. } 
