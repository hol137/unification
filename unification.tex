...
Acording to Eddington\cite{Eddington}, the mean relation between $a$ and $p_t$ is $a^2 \approx  10 p_t$. With $p_t \around 6 x$, where $x$ is a nucleotide mass, this corresponds precisely to $a^2/60 \approx 313$, the Adenine atomic mass, which is a prime number. The deviation is pertinent: 
