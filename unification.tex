...
Rule 23 Wolfram cellular automaton $ u_d = 1 + d(2d+1)$ for d = 30 & $u_{30}$    & $ \underline {1831} $ & d=30 is the terminal octonion seies in the T.A. \\ 
  Rule 23 Wolfram cellular automaton $u_{2d\prime} = 1 + 2d + 8 d^2$ for d = 12& $u_{8}$    & $ \underline {1831} $ &   Dimension Compactification from 30 to 12 \\
  
  Rule 23 Wolfram cellular automaton $u_d = 1 + d(2d+1)$ for d = 8 & $u_{8}$    & $ \underline {137} $ & 137 = 136 + 1 (Eddington's development) \\   
    
  Combined Rule 23 Wolfram cellular automaton $u_{2d\prime} = 1 + 2d + 8 d^2$ for d = 1& $u_{8}$    & $ \underline {137} $ &  \\    
