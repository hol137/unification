...
\node [anchor = west,color= red] at (-16,-19.3) {~~~~~~~~~~$ \frac {g ~\approx~  c/annee}{g_0} = \frac{gt_1^2 }{l_1} \approx \sqrt {a_{00}} sin(2 \theta) \approx \frac{\pi(1+\mu+\tau)}{4\tau} )  \approx \frac{2Z}{W} (S \approx \frac{u}{q}) \approx \pi^2 ~~~~~~~ $};
...
red
\node [anchor = east,color=red] at (22.75,-4){$(\frac { \sqrt {e^{e^e}}}{a_s} )^3 \approx 3570 \tau$~~ (30 ppm)};
