...
% Critical density $3 c^2/ 8\pi R^2$ & $\rho_{cr}$  & $kg m^{-3}$  & $ 9.41197996 \times 10^{-27} $ & 0.3   \\
  ...
  %Official CMB temperature & $T_{CMBoff}$ & K & $2.7255(6)$ & $2 \times 10^5$ \\    
   ...
   Square root of the ratio CMB photon double number/atomic number & K_n &- & 12087.731  & Eq() \\
...
\textit{This means there is a symmetry between radiation and matter, totally unexpected in the present standard theory. This relation has the same form than that of Eddington : $\sqrt (M/_e) = R/2\lambdabar_H$, equivalent to eq. (1)}
%1/g_0 = 1+g_1^2 +g_2^2 = 1 + (Z/H^{(0)})^2 \approx (R_e/2R) (p_G/H) = g_2/g_1g_3 \approx 2(H/p_t)(\beta sqrt a_s/w_i)^{1/2}
 %\end{equation}

\subsection{The Optimal Computing Principle: the Tachyonic Holographic Cosmos}
