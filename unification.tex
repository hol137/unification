...
showing that the weak force is tied to the connection $e^e \approx 15$, characteristics of the Topological Axis.
 ...
 The Weigel series (Table 7) shows up the transdimensionnal following propery: the number of positive operations in dimension $n$ is equal to the number of negative operationd in dimension $n+1$. Among these numbers, 165 is both the number of positive point operations in dimensions 8 and 9, and also the number of negative point operations in dimensions 9 and 10. Another property of 165 is its non-trivial binomial character. Another case is $K_13 = 1001$ : it is conjectured that these are the only two cases. The number 165 is very singular because it is equal to $\sqrt {H^{(0)}}/3$, where $\sqrt {H^{(0)}} = 495$, another non-trivial binomial number, and the square root of the Higgs/Electron mass ratio. 
...
\begin{equation}
 \left\{
    \begin{array}{ll}
    165 \approx 1837/2d_ea g_1^3 \approx g_1^2a^5/137^2d_e^3 p_t  ~~~~ \Rightarrow~~~~ g_1^5 \approx d_eH^2/2a^4 \\
