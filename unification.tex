...
\subsection{The Prime Number series Connection}
Considering the Prime Number Series including the unity $\sigma(n)$ (EOIS A014284), the connection are unambiguous (Table 7), showing a partition of 137, the edditon-Atiyah constant, which is characteristic of the Periodic Table (Section 5.7), and a partition of 1839,

\textit{showing the arithmetic origin of the DNA bi-codon partition in 6 nucleotides.}
