...
Among the Weigel numbers, only the $8^{th}$(165) and the $12^{th}$ (1001) are non-trivial binomial numbers. It is conjectured that these are the only two such cases. Taking account ot the paramount importance of $K_8$, relations involving between these two numbers are looked for. Indeed: 
...
\begin{equation}
 \left\{
    ...
    \\
    2\times 3 \times 5\times 7 = 210 \approx g_1 g_3 K_{12}/2       ~~~~~~\Rightarrow~~~~~~  g_1 g_3  = g_0 g_2 \approx 4 \times (5/11)\times (3/13) \\
    \\
