...
\node [anchor = west,color= red] at (-27,-25) {Sum $ \sum_{k=0}^{k=7} (d_k+1) = 2^7 + 2^3 = 136  \approx (\tau^{g_1} \mu^{g_2/g_3} )/2 \approx             \frac {\sqrt3 m_{bc}}{2 \sqrt a m_H}  ~;~ \frac {ln\mu}{ln\tau} \approx g_0 = \frac {g_1g_3}{g_2} \approx \frac {pp_G}{2a^3}  ~;~ \mu^a \approx \tau^{\frac {pp_G}{2a^2}} \approx 3^{665} \approx 2^{1054= 2\times 31 \times 17}   $ };
...
\node [anchor = east,color=red] at (12,2){$\sqrt {1 + g_1^2 + g_2^2} \approx \frac {ln\tau} {ln\mu} \approx \frac {1} {g_0}  = \frac {2a^3} {pp_G} = \frac {g_2} {g_1g_1} \approx (\frac {\beta e^{\pi}} {S^2} )^2 ~;~ S \approx \sqrt {a_{00}} sin\theta (cos\theta)^2 ~;~0.01 ppm  $};
