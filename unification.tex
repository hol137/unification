...
\node [anchor = east,color=red] at (-12,-5.9){$  495 \approx g_1g_2g_3H \approx \frac {H}{n_t} ( a_s^{\frac {1}{g_1}} \approx (3u)^{\frac {1}{g_1g_2}} \approx     e^{\frac {e^e}{2g_3} } )$};
...
\node [anchor = east,color=blue] at (30.0,8.25){$3570 \approx \Phi^{17}-1$};
