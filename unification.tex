...
\node [anchor = east,color=red] at (28.25,28.250){$f(30) \approx$ NOMBRE D'EDDINGTON $\times \pi/12 \approx (1/t_e)\times $ Super Période (Cosmon) $\hbar^3/G^2m^5 \approx \hbar^4/G_F^{5/2}\rho_C^{3/2}$ };
...
\node [anchor = east,color=red] at (22.,22.0){$f(2p/(a+1))\approx P^2/4\pi \approx (4\pi/3)(f(26)f(27))^{1/2} \approx e^{32\pi} \approx RAMANUJAN_{\sqrt{pn_t}} \approx a^{a^2/n_t} \approx n_t^{n_t/(a+1/2)} $};
