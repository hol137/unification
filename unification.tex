...
\node [anchor = north] at (-10.9, 34.2) {$ e^{e^{e^{e^{e^{-W/H^0}}}}} ~~~~~ 2e ~~~~~  f(32) = e^{2^{2^{2^{2}}}} \approx (R_C/\lambdabar_e)(\tau/n_t)^{128/3} ~~~~~~~~~~~~~~ (4\pi^2/3)(R_C/r_H)^3 \approx a^a \approx (R/R_e) \Pi_1^{20} O_{M_i}$};
