...
According to Eddington \cite{Eddington}, the main relation between $a$ and $p_t$ is $a^2 \approx 10 p_t$. With $p_t \around 6 x$, where $x$ is a nucleotide mass, this corresponds precisely to $a^2/60 \approx 313 = (5^4 +1) /2$, the Adenine nucleus number, which is a prime number. The deviation is pertinent: 
