...
\node [anchor = east,color=red] at (28.25,27.750){$(6/5)^{2^{10}} \approx 2^{256}pn_t\beta^4/18^2~ (0.1 ppm)  \approx$ (H/24) N_{Ed} \approx (H/2\pi) (f(30) \approx (1/t_e)\times $  (Cosmon) $ =\hbar^4/G_F^{5/2}\rho_c^{3/2}\hbar^3/G^2m^5$ };
