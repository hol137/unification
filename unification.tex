...
{\color{red} Contrary to old tradition, the present science shows separated disciplines. In particular, the Number Theory plays a marginal role in Physics. Even the String Theory does not connect with Reality. Worse, the two pillars of Physics does not agree on the real status of space-time, and the standard physics is incapable to define the values of about 30 "free parameters". Adopting the Optimal Computation Hypothesis, this article connects the Number Theory with a gravitation-reunified Physics implying chemical, biologic and cristallographic parameters untill 0.1 ppm precision. The superstring dimension 11 is identified with the first prime of the base 3 Mirimanoff couple, while the second prime of the base 2 Wieferich couple defines the fine-structure constant within its 0.15 ppb indetermination. The Euler maximal suitable number plays a central role, showing a connection with the generalised Riemann conjecture. This confirms the Eddington's Fundamental Theory, in particular the non-standard symmetry proton-tau. The running number of the string dimension series of the Topological Axis is identified with the orbital quantum number, associating the spin 1/2 and the string dimension 2. This excludes the concepts of Multiverse, Continuum, Infinity, Locality and Zero mass Particle, and leads to stringent predictions.  } 
...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Relative Radiation factor $ u_{CMB + CNB}/u_{CMB} = 1 + 3 (7/8) (4/11)^{4/3}$ &  $y$  & 1.681321953  & "exact" \\
    ...
    Wyler Proton/Electron mass ratio $6\pi^5$ & $p_W$   & \underline {1836.118109}  & 0.06 ppb \\ 
...
Rule 23 Wolfram cellular automaton $ u_d = 1 + d(2d+1)$ for d = 30 & $u_{30}$    & $ \underline {1831} $ & $d$=30 ; $k$ = 7 \\

Combined Rule 23 Wolfram cellular automaton $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 12 & $u_{8}$    & $ \underline {1831} $ & From $d$ = 30 to $d$ = 12 \\
  
  Rule 23 Wolfram cellular automaton $u_d = 1 + d(2d+1)$ for $d$ = 8 & $u_{8}$    & $ \underline {137} $ & $137 = 136 + 1$ (Eddington) \\   
    
  Combined Rule 23 Wolfram cellular automaton $u_{2d\prime = 2(d+3)} = $1 + 2d + 8 d^2$ for d = 1& $u_{2\times (1+3}$    & $ \underline {137} $ & From $d$ = 12 to $d$ = 1 \\ 12D and 4D reduces to 1D \\  
    
    Eddingon-Atiyah constant $(2^7 + 2^3 + 2^0)$  & $a_{00}$    & $\underline {137}$ & exact \\
     
    Electric coupling constant $(\alpha^{-1})$  & $a$    & $\underline {137.035999084(21)}$ & 0.15 \\
    
    Optimised series with the last Wieferich prime $137 + 1/28 + 1/W_2$  & $a_0$    & $\underline {137.035999104}$ & exact \\
    ...
    Optimised massive scalar boson/Electron mass ratio  & $H^{(0)}$ & $ 495^2 = 245025$  & exact, $H^{(0)}_{mes}$: 245000(250)  \\
  ...
  Optimized  charged Pion/Electron mass ratio  & $\Pi_+$ & 273.1328373  & \cite{Sanchez2} $\Pi_{+mes}$: 273.13288(47)  \\     
  Optimized  neutral Pion/Electron mass ratio  & $\Pi_0$ & 264.143971  & \cite{Sanchez2} $\Pi_{0mes}$: 264.14341(97)\\ 
 ...
 DNA Guanine-Cytosine couple principal mass/$m_H$ &  $o_2$   & 613.299802 & \cite{Huang} \\ 
   ...
   % This seems connectedOptimized "Effective m(Z) Squared Weak-mixing angle" $(ln\Phi)^2$  & $(\sin \theta_{effZ})^2$    & 0.23156482 & this work (0.23148(4)) \\
    ...
    Optimized Muon/Electron mass ratio  & $\mu$ & 206.7682869  & 0.1 ppb $\mu_{mes}$: 206.7682830 \\     
   % Measured Tau/Electron mass ratio  & $\tau_{meas}$ & 3477(2)  & $7\times 10^4$ \\        
    Optimized Koide Tau/Electron mass ratio  & $\tau$ & 3477.441701  & 0.1 ppb $\tau_{mes}$: 3477(2) \\  
 Fermi Sanchez-Atiyah mass ratio: $\sqrt {a_w}$ & $F$   & 573007.3652  & 0.22 ppb $F_{mes}$: 573007.362 \\

Product Eta-Tau mass ratioes  & $ \eta \tau$ & \underline{$3.728~\times 10^6$}  &  \\ 

Product of the Wieferich primes 1093 $ \times $ 3511  & $W_1 W_2$  & \underline{$3.837 ~\times 10^6$}  &  $W_1/\eta \approx (W_2 \beta /\tau)^2$ ~~~~(1 ppm)\\ 
...
%\label{tab:4:table4}
  \hskip-0.0cm\begin{tabular}{llllllllllllll}
    ...
    $K_d$ (positive $PSO_{Cr}$)  & 1 & 5 & 5 & 19 & 19 & 59 & 59 & 165 & \underline{165} & 419 & 419 & 1001& 1001 \\
     ...
     $q_d=\binom{3+d}{4}$ (pentapope nbr)  & 1 & 5 & 15 & 35 & 70 & 126 & 210 & 330 & \underline {495} & 715 & 1001 & 1365 & \underline{1820}\\
     ...
     %$K^{(d)}_-$  &  & 1 & 5 & 15 & 35 & 70 & 126 & 210 & 330 & \underline 495& 715 & 2001  \\
      ...
      $v_d = u_{2 d\prime = 2(d+3)} = 8 d\prime^2 +2 d\prime + 1$ & \underline{137}  & 211 & 301 & 407 & 529 & 667 & 821 & 991  & 1177 & 1379 & 1597 & \underline{1831} & 2081 \\
