...
\node [anchor = west,color= red] at (-18,-16.3) {~~~~~~$sin \theta \approx (\frac {1}{\Phi^3} - \frac {1}{\Phi^9})^{1/2} \approx \frac {g_2}{\Phi^{g_2}}  \approx \frac {\Phi^{g_1}}{g_1}-1 ~~~~;~~~~a_{00} = i^{-i \pi} = e^ {\pi^2/2}   \approx a + 2 \approx \frac {\Phi^{16}}{16}  \approx (\frac {\Phi^{g_1}}{g_1})^4$} ;
