...
\node [anchor = east,color=red] at (22.,22.0){$f(2p/a)\approx P^2/4\pi \approx (4\pi/3)(f(26)f(27))^{1/2} \approx e^{32\pi} \approx RAMANUJAN_{\sqrt{pn_t}} = \approx a^{a^2/n_t} \approx n_t^{n_t/(a)} $};
