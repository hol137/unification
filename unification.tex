...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Wien parameter ${\color{black}W_5} = hc/k_BT \lambda_{Wien} = 5(1-e^{-{\color{black}W_5}}) \approx ln2-4lng_1$ &  ${\color{black}W_5}$  & 4.96514245  & {\color{black}$W_3\approx~2.821439372$} \\
