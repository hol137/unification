...
\node [anchor = west,color=blue] at (-12.,-12.) {$ \approx  r_H$ \LARGE{Rayon de l'atome d'Hydrogène}$ \approx 3f(10) \lambdabar_e /2\pi };
...
\node [anchor = west,color=blue] at (7,20.0){\LARGE{R(HUBBLE)} $R \approx \lambdabar_e f(26)/6 $};
