...
\node [anchor = west,color=red] at (-8.2,-8.3) {~~~~~~ $ \frac{l_1}{l_P} \approx \frac{RR_e}{(2ct_1)^2} \approx O_B ( \frac{2ct_0 }{2\pi R_T} = \frac{\Phi^8 }{\pi}) \approx \frac{O_M}{\sqrt{a_G}}  $};

\node [anchor = west,color= red] at (-8.2,-10.3) {~~~~~~$ RR_e(2\pi R_T) \approx (2ct_0)^3 O_B \approx l_1^3 ~ e^{a_{00} -1 \approx ~ a + 1}~~~~ a_{00}= i^{-i\pi} = e^{\pi^2/2}$};

\node [anchor = west,color= red] at (-5.2,-19.3) {~~~~~~~~~~$ \frac {g ~\approx~  c/annee}{g_0} = gt_0^2/l_1 \approx sin(2 \theta)\sqrt {a_{00}}  \approx \frac{2Z}{W} (S \approx \frac{u}{q}) \approx \pi^2 $};

\node [anchor = west,color= red] at (-14.2,-23.3) {$ \frac {ct_0}{coudee} \approx \frac {l_1}{r_{ADN}} \approx \frac {2}{\pi} \frac {2v_T t_1}{l_1} \approx \frac {p_{hol}^3}{4\pi} \approx 150^4 \approx p^{8/3}  ~~~~~~~~~ v_T = \frac {2\pi R_T}{Jour} ~~~~~~~~~ r_{ADN} \approx 2 nm  $};
...
\node [anchor = west,color= red] at (-2,-27.6) {~~~~~~$ \frac {1}{g_1g_2g_3} \approx g_1\frac {2a^2}{\tau}   \approx \frac {g_2}{2} \sqrt {\frac {H^0}{p}}\approx \frac {H}{\sqrt {H^0}}  $};
...
\node [anchor = east,color=red] at (-2.25,-16){$\frac {R}{2\lambdabar_e} \approx 2^{2^{2^{2^2-1}-1}-1}-1$};
