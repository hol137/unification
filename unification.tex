...
\node [anchor = east,color= red] at (-15.5,-13.5) {~~~~~~$ \Phi \approx \frac {a^3  sin \theta}{1836^2} $};

\node [anchor = east,color= red] at (-15.5,-15.5) {~~~~~~$ w_5 \approx \frac {2a^2 sin \theta}{3570-1} \approx (a_s \sqrt {\pi e})^{1/2} $ };
