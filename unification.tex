...
\node [anchor = east,color=black!40!green] at (28.25,28.250){$Super Periode \hbar^3/G^2m^5 \approx \hbar^4/G_F^{5/2}\rho_C^{3/2}$};
\node [anchor = east,color=black] at (29.25,29.250){$TOPON$:Longueur d'onde de l'Univers critique $2l_P^2/R\approx f(30) \times 153^2$};
