...
\node [anchor = north] at (-15.0, 33.7) {$R_C/\lambdabar_e \approx e^{e^{e^{e^{e^{-\tiny{g_2}}}}}} ~~~~~ 2e ~  f(32) = e^{2^{2^{2^{2}}}} \approx (R_C/\lambdabar_e)(\tau/n_t)^{128/3} ~~~~~~~~~~~~~~~~ (4\pi^2/3)(R_C/r_H)^3 \approx a^a$};
