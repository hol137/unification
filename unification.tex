...
\node [anchor = west,color= red] at (-16,-19.3) {~~~~~~~~~~$ \frac {g ~\approx~  c/annee}{g_1} = \frac{gt_1^2 }{l_1} \approx \sqrt {a_{00}} \times ( sin(2 \theta) \approx \sqrt {\frac{\pi 2^{1/12} }{4 \zeta (3)} } \approx \frac{\pi(1+\mu+\tau)}{4\tau} )  \approx \frac{2Z}{W} (S \approx \frac{u}{q}) \approx \pi^2 ~~~~~~~ $};
\node [anchor = west,color= red] at (-14.2,-21.3) {$ \frac {ct_1}{0.6l_1} \approx \frac {l_1}{r_{ADN}} \approx \frac {p_{hol}^3}{4\pi} \approx 150^4 \approx p^{8/3}  ~~~~~~~~~ v_T = \frac {2\pi R_T}{Jour} \approx \frac {p_{hol} l_1}{4t_1} ~~~~~~~~~ r_{ADN} \approx 2 nm  $};
...
\node [anchor = west,color= red] at (-23.2,-23.2) {7s+6p+4d+2f = $ 7\times 2 + 6\times 6 + 4\times 10 + 2\times 14 = 118 $ (Ogamesson) };
\node [anchor = west,color= red] at (-25,-24.5) {$ 7\times (2+1) + 6\times (6+1) + 4\times (10+1) + 2\times (14+1) = 107 + 30 = 137 \approx a = a cos^2 \theta + a sin^2 \theta$ };
\node [anchor = west,color= red] at (-27,-26.5) {$ \Sigma (d_k+1) = 2^7 + 2^3 = 136 \approx (\tau^{g_1} \mu^{g_2/g_3} )/2 \approx             \frac {\sqrt3 m_{bc}}{2 \sqrt a m_H}  ~;~ \frac {ln\mu}{ln\tau} \approx g_0 = \frac {g_1g_3}{g_2} \approx \frac {pp_G}{2a^3}  ~;~ \mu^a \approx \tau^{\frac {pp_G}{2a^2}} \approx 3^{665} \approx 2^{1054= 2\times 31 \times 17}   $ };

\node [anchor = west,color= red] at (-32,-28.5) {$ 2^{\frac {1}{665}} \approx 3^{\frac {1}{1054}} \approx (\frac {a}{137})^4 \approx 4g_1g_Z \approx \frac {WZ \sqrt a}{a_w} \approx \frac {2a_w}{a_s \pi W^2\sqrt \beta} \approx (sin\theta)^{\frac {-3571}{a^3}} \approx S^{\frac {p_G}{a^3}} \approx g_1^{\frac {-1}{2^{10}}} \approx g_0^{\frac {-9}{2H}} \approx (\frac {R_C}{\lambdabar_e})^{\frac {2\pi^2 + 1}{e^{16}}}~;~tg\theta  \approx \frac {g_2}{g_1} \approx \frac {\sqrt a}{4g_F} \approx \frac {\tau}{9\mu} \approx \frac {\pi \Phi}{e}$ };

\node [anchor = west,color= red] at (-27,-30.2) {$ (R_C/\lambdabar_e)^{2\pi^2} \approx 137^{1836} \approx \phi^{137^2} $ };
...
\node [anchor = east,color=red] at (10,2){$\sqrt {1 + g_1^2 + g_2^2} \approx \frac {\tau} {\mu} \approx \frac {1} {g_0}  = \frac {2a^3} {pp_G} = \frac {g_2} {g_1g_1} \approx (\frac {\beta e^{\pi}} {S^2} )^2 ~;~ S \approx \sqrt {a_{00}} sin\theta (cos\theta)^2 ~;~0.01 ppm  $};
