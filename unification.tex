...
\node [anchor = west,color=red] at (-24,-25.1) {$ f(\frac {\sqrt{\sqrt p}}{\sqrt 3}\approx \frac {\sqrt u}{q} ) \approx \Phi^4 \approx (2u \approx 4g_0)^2 \approx \sqrt {ag_1}  \approx (\frac {g_3}{g_2} \approx \frac {6}{\pi} = \frac {metre}{coudee})^3   \approx  (g_Z \approx a/100)^6  \approx ( \frac {1}{g_2g_3} \approx \frac {4}{\pi})^8  $};
...
\node [anchor = west,color=blue] at (-12.,-12.) {$3f(10) \approx 2\pi r_H$ (Rayon de l'atome d'Hydrogène) $\approx (2R/R_e)^{16} \approx (3570)^{16}/O_M$ };
...
\node [anchor = west,color=red] at (-6.2,-6.3) {$f(\frac{\Delta_{Ed}}{10}) \approx ~ $Long. de Rydberg $\lambdabar_{Ryd} \approx l_P \sqrt{O_M}\approx \sqrt{\lambdabar_p l_0}  $ ($l_0=$ 1 mètre) };
...
\node [anchor = west,color= red] at (-21.2,-19.3) {~~~~~~$f(2\pi) \approx (\frac {3R}{2\lambdabar_e})^{\frac {1}{30}} \approx \frac {t_K}{t_{ST} \approx 495 s}  $};
...
\node [anchor = east ,color=blue] at (22,20.2){~$\frac {f(26)}{6} \approx 2^{2^7} \approx 2 f(\frac{31}{2})^6 \approx (f(-5))^{211} \approx (\frac{2}{\Phi})^{2\times 209} \approx R \approx (\frac{2R}{R_e})^{210}\approx(\frac{6}{\pi})^a \approx(\frac{g_3}{g_2})^{a_{00}-1}    $~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
