...
\node [anchor = west,color= red] at (-22.5,-22.5) {\LARGE{Gravitation Terrestre} $g \approx \pi^2~ metre ~ seconde^{-2} \approx c/annee $};
...
\node [anchor = west,color= red] at (-31,18){\LARGE{Rayon terrestre} $R_T/ct_1 \approx 1/\Phi^8 \approx e/2^7 \approx R/f(24)l_1 $};
