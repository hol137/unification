...
\node [anchor = east,color=red] at (8.25,26.250){$f(29) \approx$ (NOMBRE DE RAMANUJAN)$^4 e^{4\pi \sqrt{163}}/2p_{hol} ~(1 ppm)$~~~~~~~~ };
...
\node [anchor = north] at (-15.2, 33.6) {$\tiny{R_C/\lambdabar_e \approx e^{e^{e^{e^{e^{-\tiny{g_2}}}}}}} ~~~~~g_2 = m_W/m_{Higgs} ~~ ~  f(32) = e^{2^{2^{2^{2}}}} \approx (R_C/\lambdabar_e)(\tau/n_t)^{128/3} ~~~~~~~~~~~~~~~~ (4\pi^2/3)(R_C/r_H)^3 \approx a^a$};
