...
%~;~ sin(2 \theta)\approx (\frac{\pi 2^{1/12} {4 \zeta (3))^{1/2} \approx \frac{\pi p_K} {2\tau}    $};

\node [anchor = west,color= red] at (-17.5,-17.8) {$ \frac {g ~\approx~  c/annee}{g_1} =\frac{gt_1^2 }{l_1} \approx \sqrt {a_{00}}  sin(2 \theta)= \frac{2Z}{W}S \approx  \pi^2~;~ S \approx (\beta e^{\pi}\sqrt g_0)^{1/2} \approx \frac{u}{q}~;~ sin(2 \theta)\approx (\frac{\pi 2^{1/12} }{4 \zeta (3))^{1/2}} \approx \frac{\pi p_K} {2\tau} $};
