...
% $ R/\lambdabar_e  \approx 6H (2\pi_{hol} a^3)^5 $& 13.81197676    &  Holographique, avec     $\pi_{hol} = 3 + 1/(7+1/(16+2/e^{2e}))$\\
 ...
 $ (32 \beta^2/\pi^3) \lambdabar_{CMB}^3/\lambdabar_Z^2$ & 13.8119962 & from the holographic relation $2\piR/\lambdabar_e \approx (4\pi/3) (\lambdabar_{CMB}/\lambdabar_{H_2})^3$    \\ 
