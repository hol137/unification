...
\node [anchor = east,color=red] at (-11.25,10){$\sum_{2}^{R_1/\lambdabar_e} \frac {1/n} {1/n^2} \Rightarrow \frac {RR_e} {R_1^2} \approx \frac {419-16} {417-16} \approx 2^{\frac {3} {2\times 209} } $};
