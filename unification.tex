...
Combined Rule 23 Wolfram cellular automaton $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 12 & $u_{8}$    & $ \underline {1831} $ & From $d$ = 30 to $d$ = 12 \\
  ...
  Rule 23 Wolfram cellular automaton $u_d = 1 + d(2d+1)$ for $d$ = 8 & $u_{8}$    & $ \underline {137} $ & $137 = 136 + 1$ (Edd) \\   
    
  Combined Rule 23 Wolfram cellular automaton $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 1 & $u_{2\times (1+3)}$    & $ \underline {137} $ & from 12D to 1D \\  
