...
Considering the Prime Number Series including the unity $\sigma(n)$ (EOIS A014284), the connection are unambiguous, showing a partition of 137, the edditon-Atiyah constant, which is characteristic of the Periodic Table (Section 5.7):
