...
Combined Rule 23 Wolfram cellular automaton $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 12& $u_{8}$    & $ \underline {1831} $ & From $d$ = 30 to $d$ = 12 \\
  ...
  Combined Rule 23 Wolfram cellular automaton $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 1& $u_{2\time (1+3}$    & $ \underline {137} $ & From $d$ = 30 to $d$ = 12 \\ 12D and 4D reduces to 1D   
