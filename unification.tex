...
\node [anchor = east,color= red] at (-20.5,-12.9) {~~~~~~$ (a^2)^{a^3} \approx p^{p^2}$};
\node [anchor = east,color= red] at (-22,-10.9) {~~~~~~$ \Phi^{a} \approx a^{p/a}$};
\node [anchor = east,color= red] at (-17,-8.9) {~~~~~~$ \Phi^{210} \approx p^{p/a} \approx Ram_{1836} \approx P^2a \frac {\sqrt {Hn_t}}{p} ~~ (2 ppm) $};
