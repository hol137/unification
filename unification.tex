...
\node [anchor = west,color=green] at (-12.,-12.) {Rayon de l'atome d'Hydrogène $\times ~ 2\pi/3$ };
...
\node [anchor = west,color=green] at (-4.5,-4.5){Longueur d'onde de Rydberg $\times ~3g$};
...
\node [cross,anchor = west,color=green] at (4.25,4.25){Longuer d'onde Thermique: $~~\pi \times \hbar c/k_BT_{C}$};
\node [cross,anchor = east,color=red] at (3.25,4.75){NOMBRE PREMIER D'EULER $(2^{2^5-1}-1) \times \pi ~~ $};
\node [cross,anchor = west,color=red] at (3.15,3.15){$~~~ T_{C} \approx 2.73 ~Kelvin \approx T_{mam}/j\approx T_{H_2}T_{O_2}/T_{H_2O}$};
...
\node [anchor = west,color=green] at (16.,16.){Longueur de Kotov $\times$ $2\pi$a};
\node [anchor = east ,color=red] at (13.3,16.0){$f(24)= e^{64} = (f(12))^8\approx~ $ NOMBRE DU MONSTRE $/H^8$~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
\node [anchor = west,color=green] at (18.25,18.250){Groupe de galaxies};
\node [anchor = west,color=green] at (18.25,17.750){Galaxie};
\node [anchor = south,color=red] at (18.25,-31.0) {$\Gamma$};
\node [anchor = east,color=black!40!green] at (20.,20.0){$GRAVITONDE$};
\node [anchor = west,color=red] at (20.,20.0){$R_{HUBBLE}~\times$ 6};
...
\node [anchor = east,color=green] at (22.25,-20.250){\LARGE{MACRO-PHYSIQUE}};
\node [anchor = east,color=green] at (14.25,-22.250){$Y = \l_{MACRO}/\lambdabar_{e}$};
