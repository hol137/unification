...
\begin{equation}
 \left\{
    \begin{array}{ll}
    1/g_0 = 1+g_1^2 + g_2^2 = 2a^3/pp_G \approx 2 g_1^{1/4}(pp_W)^{1/2}/H ~~~~~~~\rightarrow~~~~~    1/2g_0 \approx g_1^{1/4} \approx e^{-e^{e^{-e}}/4} \\
   ...
   1/g_0 \approx 2R/R_e \approx 2(g_1\tau/mu)^{1/2}/\pi \approx (H/2g_1 \sqrt {p_tp_W})^4 \approx 2(H/p_t)(\beta \sqrt {a_s}/W_5)^{1/2}\\
