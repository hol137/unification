...
\right.
\end{equation}
\textit{This direct liaison with the Number Theory confirms that the c-Universe acts as a Cosmic {\color{black}gauge boson}, acting by the seventh power, in conformity with the Topological Axis and the Holic Principle}\cite{Sanchez1}. Note that the Lenz-Wyler formula $p_t \approx 6 \pi^5$ implies the special fractional development for $\pi : 3,7,16,n_tH/2ap_t$. 
