...
\node [anchor = west,color=blue] at (16.,16.){$2\pi a \times (ct_K \approx d_{Soleil-Uranus})$ };
...
%\node [anchor = east,color=red] at (23.95,26.250){$f(29) \approx$ (NOMBRE DE RAMANUJAN)$^4 e^{4\pi \sqrt{163}}/2p_{hol} ~(1 ppm) \approx e^{....-Z/H^0}a/8\beta (pHn_t)^{1/3} ~ (3 ppm)$ };
