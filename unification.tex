...
\node [anchor = west,color= red] at (0,-29.6) {~~~~~~$\frac {\pi}{e} \approx ucos \theta \approx (\frac {r_H}{\lambdabar_e})^{1/34} \approx \Phi^q \approx 4\pi q^2 \approx (4\pi /3)(g_0 \approx g_1 \sqrt g_2)^3 $};
