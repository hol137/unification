...
\node [anchor = east,color=red] at (-8,-4.4){$1/g_1g_2g_3 \approx 2 + \sqrt 3 : 3^{ième} nb. d'argent$};
...
\node [anchor = north,color=red] at (-14, 34) {$\hbar,G, u  m_{bicodon}, m_{photon}, m_{graviton} \Rightarrow u R_{Cosmos} $};
