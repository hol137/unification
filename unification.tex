...
Strangely enough, the EOIS presents the crystallographic series (A120963), without citing Herman, the first discoverer. by contrsat, there is a reference to the Weigel team, but without presenting the specific series of positive symmetry number 1,5,5,19,19,59 (Table 7), which seems to connect with the string dimensional compactification.
