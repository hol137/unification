...
\node [anchor = east,color=red] at (24,16){$ 3^{3^3-1} \approx (2^{2^2-1})^{\sqrt {a_{00}}/2} \approx a^ {(\frac {137}{a})^2\sqrt {a_s}/2} \approx {a_s}^{a^{11}/P} \Rightarrow a^a \approx (e ^ {1/e})^{p_G\sqrt {n_t/p} } \approx (\sqrt {a_s} ^  {1/ \sqrt {a_s}})^{\sqrt {pH}} 
