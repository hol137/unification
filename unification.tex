...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Scale-factor $8\pi^2/ln2 \approx (2^4 q)^3 \approx i^{-i\pi}/g_3 \approx (i^{-i\pi}-1)/4q \approx \pi \Delta'_{Ed}/8 \approx (\Phi^4/g_2)^2$  & $j$ & 113.9106346  & \cite{Sanchez2} $j \approx T_{mam}/T_{CMB}$ \\
