...
\node [anchor = east] at (-8.,-8.) {COUPLE (Proton $\times ~\phi $) - (Tau $\times ~6/7$)};
...
\node [anchor = east ,color=red] at (16.,16.0){$f(26)\approx~ $ NOMBRE PREMIER DE LUCAS $(2^{2^{2^{2^2-1}-1}-1}-1)\times 12$~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
