...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Euler-Napier constant and associated optimal numbers, $e_2 = e^e~;~ e_3 = e^{e^e}~;~ e_4 = e^{e^{e^e}} $  & $e$    & 2.718281828459042 & optimal base Eq.(17)\\    
    Archimedes constant & $\pi$    & 3.14159265358979 & $e_4^{1/a(a-1)}\approx (9/2)^{(a-1)} \approx P^4 (sin \theta)^2 $\\    
