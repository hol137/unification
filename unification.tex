...
\label{tab:3:table3}
 ...
 Optimized Gravitation constant   & G & $kg^{-1} m^3 s^{-1}$  & $6.67545375\times 10Rydbergh reduced wavelength $\lambdabar_e(2aH/p)^2$ & $\lambdabar_{Ryd}$  & m  & $1.45190673 \times 10^{-8} $ & 0.3   \\
 $  & \cite{Sanchez2} $G_{mes}$: 6.67430 \\
 ...
 Critical density $3c^2/8\piR^2$ & $\rho_{cr}$  & kg m^{-3}  & $9.41197996 \times 10^{-27} $ & 0.3   \\
  ...
  %Official CMB temperature & $T_{CMBoff}$ & K & $2.7255(6)$ & $2 \times 10^5$ \\    
   ...
   Critical Matter versus radiation ratio & $\rho c^2/u_{CMB+CNB} $ & - &  12045.685 &  \\
   
   Square root of the ratio CMB photon double number/atomic number & - & 12087.731  & Eq() \\
