...
\node [anchor = west,color= blue] at (-21.2,-30.3) {~~~~~~$f(2) = \sqrt{f(6)}  \approx \frac {\sqrt 2}{g_1} \approx \frac {\sqrt 7}{g_2}  \approx \frac {\sqrt \Gamma}{g_3}  \approx \frac {3}{g_Z}  \approx 2\pi g_0 \approx 9\mu/a \approx 4an_t/H^0 $};
