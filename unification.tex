...
\node [anchor = east,color=red] at (16,16){$ 3^{3^3-1} \approx (2^{2^2-1})^{\sqrt {a_{00}}/2} \approx a^ {(\frac {137}{a})^2\sqrt {a_s}/2} \approx {a_s}^{a^{11}/P} \Rightarrow a^a \approx \sqrt {a_s} ^  {\sqrt {pH/a_s}} $};
...
\node [anchor = east,color=red] at (13,14.5){$\hbar,G,G_F \rightarrow 52,255 Hz \rightarrow $ Lab (La = 442,9 Hz)  };
