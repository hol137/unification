...
\node [anchor = east,text=red] at (0,31.9) {2e};
...
\node [anchor = north] at (-11.9, 34.5) {$ e^{e^{e^{e^{e^{-g_2}}}}} ~~~~~ 2e ~~~  f(32) = e^{2^{2^{2^{2}}}} \approx (\frac {R_C}{\lambdabar_e})(\frac {\tau}{n_t})^{128/3} ~~~~ (\frac {4\pi^2}{3})(\frac {R_C}{r_H})^3 \approx a^a \approx \Pi_1^{20} O_{M_i} \approx (\frac {Z}{W})^{35\times 153}$};
