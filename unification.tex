...
\node [anchor = east,color=red] at (12,27.5){ $ N_{Edd} = 136 \times 2^{256} \approx (3/10) M/m_{neutron} $ ~~(0.05 \%)~;~ $12/\pi \approx \frac {pN_{Edd}}{Hf(30) } \approx \sqrt{\frac {a}{3\pi}} \approx 2\pi \sqrt{\frac {d_e}{e}}     $ };
