...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Euler-Napier Ct. and opt. nb. $e_{n+1}=e^{n}$;$e_4^{1/aa'}\approx (9/2)^{a'} \approx P^4 sin^2 \theta $~ ; $a' = a-1 $  & $e$    & 2.718281828459042 & $e_2/e_3^{1/4} \approx e^{-e^{e^{-e}}} \approx g_1$  \\    
...
Combined R23W: ${\color{black}u'_d} = u_{2D = 2(d+3)} = 1 + 2(d+3) + 8 (d+3)^2$ for d = 12 & ${\color{black}u'_{12}}$    & $ \underline {1831} $ & 30D to 12D \\   
 R23W for $d$ = 8:  Eddington's formula\cite{Eddington}: $u_{8}= 136 + 1$ & $u_{8}$   & $ \underline {137} $ & $v_{8}= 495 + 496$ \\      
  ...
  $u_{2d} = 1 + 2d(4d+1)$ Bisection of odd central polygonal numbers for \underline {d = 4}  & $a_{00} $    & \underline {137}  & OEIS (A188135) \\
    ...
    Electric coupling constant $a = \alpha^{-1} = c/v_1(1+1/p_t)= 136 + \delta $  & $a$    & $\underline {137.035999084(21)}$ & 0.15 ppb\\
   ...
   Opt.U(1) coupling $qcos\theta \approx e^{-e^{e^{-e}}} \approx(K_0/\Pi_+^2)^{1/4} \approx (\gamma/y)(n_t/1837)\approx p_W \sqrt 2/H f(2)$ &  $g_1$ & 0.3436256 & $1/g_1 \approx a_s \delta/3 \approx 72^{1/4}p_t/(n_tH)^{1/2}$\\ 
A-dimens. El. charge $q \approx 3/\pi^2 \approx (3/10)\sqrt(6F)/p_{00} \approx (6^2/\beta d_e)^{-1/3}\approx (6\mu/137g_0\Gamma)^2$  & $q$ & 0.30297311 & $6 \approx 2^{137/53}$ (indian music) \\
 ...
 Opt. Muon/El. mass ratio $\mu \approx 1/g_1^5 -2 \approx f(2)^3 - 2\approx (n_t/p_W)^{1/2}Fa^{3/2}/9\pi W$ & $\mu$ & 206.7682869  & $\mu_{mes}$: 206.7682830 \\     
