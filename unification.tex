...
\node [anchor = west,color= red] at (-15,-14) {$\frac {\pi}{e} \approx \gamma (\mu_e = 2d_e) \approx ucos \theta \approx \sqrt6 sin \theta  \approx (\frac {r_H}{\lambdabar_e})^{1/34} \approx \Phi^q \approx 4\pi q^2 \approx \frac {4\pi}{3}(g_0\approx g_1 \sqrt g_2)^3 $};
