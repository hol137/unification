...
\node [anchor = west,color=blue] at (-6.2,-6.3) {$f(\frac{\Delta_{Ed}}{10}) \approx $Long. de Rydberg $\lambdabar_{Ryd} \approx l_P \sqrt{O_M}\approx \sqrt{\lambdabar_p l_0}  $ ($l_0=$mètre) };

\node [anchor = west,color=blue] at (-8.2,-8.3) {t_0 = 1 seconde : $l_0/l_P \approx \frac{RR_e}{(2ct_0)^2} $};
