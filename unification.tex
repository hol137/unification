...
Hence it is not surprising that it appears a kind of energy with complement relative density 0.7.  \textit {So, the deepest mystery of standard cosmology is the clearest evidence for its opponent model, the steady-state model. This means that the standard cosmology interpretation is unduly complicated.} 
