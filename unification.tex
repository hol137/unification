...
\caption[Graphics \ref{AxeCosmique}: AXE COSMIQUE]{\footnotesize{Les rapports Y (/ électron) entourent la loi $e^{2^{d/4}}$, basée sur 8 relations holiques 2D-1D imbriquées micro-macrophysiques.} }}
