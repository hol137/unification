...
The Introduction (Section 2) recalls the Topological Axis and the main physical parameters and  (Table 1, 2,3), including the values specified by the Optimal Computation Principle, which connect to 0.1 ppm with the Permanent Holographic Osillation Bang Cosmology (PHOB).
...
\begin{table}
\caption[Table \ref{CosmosTable}: 34 Cosmos radius formula]{34 formula for the Cosmos radius $R_C$}
\label{CosmosTable}
  \hskip-2.0cm\begin{tabular}{lll}
    \toprule
   % \multicolumn{3}{c}{}                   \\
