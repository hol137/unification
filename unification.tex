...
More fundamentally, this article shows the symmetry between the four basic primes: $2;3;5;7$, considered as the cosmic computation bases. The symmetric combinaisons $2\times 3\times5\times7 = 210 $, and $(2 + 3+  5 +7)(2\times 3\times5\times7) = 3570$ give the brute mass ratios, relative to electron, of the Muon and Tau.
