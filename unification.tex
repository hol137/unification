...
The crytallographic numbers are associated to the unit circle, which characterizes the U(1) group. So there \textit {must} be a connection with the $g_1$ coupling. Indeed: 

\begin{equation}
 \left\{
    \begin{array}{ll}
    165 \approx 1837/2d_ea g_1^3 \approx g_1^2a^5/137^2d_e^3 p_t  ~~~~ \Rightarrow\\
    ~~~~~~~~~~~~ (1/g_1)^5 \approx 2a^4/d_eH^2 \approx 417 (a/137)^2 H \approx (a^3n_td_e\beta/6\pi^2p_t)^{1/2}\\
    \\
...
This suports the Holic Principle : the mass ratios operate by their fifth power, which is also tied to the mean life of unstable particles. Note that the number $417 = K_{10} -2$ appears directely, confirming the ppb relation $/K_{10}/(K_{10}-2)\approx F^5/Pa^3$.
