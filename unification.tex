...
Note that the electric charge is tied to the Mirimanoff prime 11 \cite{Mirimanoff}, showing the connection supersymetry-supergravity 10 = 11 - 1. The small difference between $g_0$ and $g_2$ induces formula in the Hubble and Cosmos Tables. So, the gauge couplings are connected with the  Wien factor $W_5$. The "strange" mesons $K_0 \approx 973.784$ and $K_0 \approx 973.784$ appears in liaison with Eddington's parameters and the Wien parameter $W_5$.
