...
\node [anchor = east,color=red] at (22.,22.0){$RAMANUJAN((pn_t)^{1/2})\approx P^2/4\pi \approx (f(a^{2/3}) \approx f(2p/(a+1)  \approx a^{a^2/n_t} \approx n_t^{n_t/(a+1/2)} \approx e^{32\pi}\approx (O_MO_B)^{1/2} $};
