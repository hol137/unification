...
\textit {The central importance of the scalar BEH boson is thus confirmed}. This shows also a symmetry between 1836 and 1848 = $s_{65}$ the last known Euler convenient number, so close to the Eddington's Proton-Electron mass ratio $\approx$ 1847.599459, which are the $34^{th}$ and $35^{th}$ areas of integer-sided triangles whose area equals 6 times their perimeter (A332879 in OEIS).
