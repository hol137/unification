...
\node [anchor = west,color=red] at (-25.25,10.250){$(ct_N/\lambdabar_e)^2 \approx R_e/2\lambdabar_e \approx D_/l_P ~;~D_{Eg} \approx \sqrt {2R_T l_1} = 3570~ l_1  \Rightarrow  l_1 = 1 metre   $};

\node [anchor = east,color=red] at (2,14){$  \frac {f(e^{\pi}} {f(23)} \approx \frac {g_0 495 \beta^{1/4}} {2 \sqrt {1836}} $};
