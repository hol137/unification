...
% Critical density $3 c^2/ 8\pi R^2$ & $\rho_{cr}$  & $kg m^{-3}$  & $ 9.41197996 \times 10^{-27} $ & 0.3   \\
  ...
  %Official CMB temperature & $T_{CMBoff}$ & K & $2.7255(6)$ & $2 \times 10^5$ \\    
   ...
   Critical Matter versus radiation ratio $\rho c^2/u_{CMB+CNB} $& $K_E$ & - &  \underline {12045.685} & $p_tH/8\bet \pi^2q \sqrt a \beta$ ~(0.4 ppm)~~~~$\p_t^3/(4\pi)^2 \sqrt \pi p_W$~~(1 ppm)  \\
