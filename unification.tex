...
\begin{table}
\caption[Table \ref{CosmosTable}: 43 Cosmos radius formula]{43 formula for the Cosmos radius $R_C$}
\label{CosmosTable}
  \hskip-2.0cm\begin{tabular}{lll}
    \toprule
   % \multicolumn{3}{c}{}                   \\
 ...
 $ l_P ~ (Zd_e/W) ~7^{12^2}  $ & 9.07507 & base 7  \\
 
 
 $ \lambdabar_e ~ 6^{128}/(1+1/sqrt 2)  $ & 9.07540 & base 6 \\
 
 
  $ \lambdabar_e ~ (1+1/\sqrt 2)^{6a_s^2+1}  $ & 9.085 & base $1+1/\sqrt 2$ \\
 
 
  $ \lambdabar_e ~ 5^{2a_s^+1}/6  $ & 9.082 & base 5 \\
