...
% Critical density $3 c^2/ 8\pi R^2$ & $\rho_{cr}$  & $kg m^{-3}$  & $ 9.41197996 \times 10^{-27} $ & 0.3   \\
  ...
  %Official CMB temperature & $T_{CMBoff}$ & K & $2.7255(6)$ & $2 \times 10^5$ \\    
   ...
   Neutron Number in the baryonic mass $(3/10)m_P^4/m_em_pm_Hm_n$ & n_n &$\underline{136.068464\times 2^{256}}$  & 100 \\
   
   Eddington Large Number & $n_{Ed}$    &  $\underline{136\times 2^{256}}$  & exact \\
