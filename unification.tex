...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Maximal Euler Ideonal ("Suitable") Number  & $s_{65} \approx (a/10)^2 \mu \tau^7/p^8$   & \underline {1848} & OEIS (A000926) \\
...
Combined R23W: $v_d = u_{2D = 2(d+3)} = 1 + 2(d+3) + 8 (d+3)^2$ for d = 12 & $v_{12}$    & $ \underline {1831} $ & from 30D to 12D \\ 
 ...
 DNA Guanine-Cytosine couple principal mass/$m_H$ &  $o_2 \approx (Z/sin\theta)^{1/2}(p_t/H)^8$   & 613.299802 & \cite{Huang} \\ 
 DNA Adenine-Thymine couple principal mass/$m_H$ &  $o_1$   & 612.312280 & \cite{Huang} \\
 DNA Guanine-Cytosine couple principal mass/$m_H$ &  $o_2 \approx (Z/sin\theta)^{1/2}(p_t/H)^5$   & 613.299802 & \cite{Huang} \\ 
