...
\node [anchor = west,color= red] at (-29,-28.5) {$ 2^{\frac {1}{665}} \approx 3^{\frac {1}{1054}} \approx (\frac {a}{137})^4 \approx 4g_1g_Z \approx \frac {WZ \sqrt a}{a_w} \approx (sin\theta)^{\frac {-3571}{a^3}} \approx S^{\frac {p_G}{a^3}} \approx g_1^{\frac {-1}{2^{10}}} \approx g_0^{\frac {-9}{2H}} \approx (\frac {R_C}{\lambdabar_e})^{\frac {2\pi^2 + 1}{e^{16}}}~;~tg\theta  \approx \frac {g_2}{g_1} \approx \frac {\sqrt a}{4g_F} \approx \frac {\tau}{9\mu} \approx \frac {\pi \Phi}{e}~;~ g_F \approx \frac {F}{H^{(0)}}$ };
...
\node [anchor = east,color=red] at (-5.25,2){$(\frac {a}{137})^4 \approx \frac {2a_w}{a_s \pi W^2\sqrt \beta}$~ (0.1 ppm)~ $\approx 4g_1g_Z$};
