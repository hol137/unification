...
\node [anchor = west,color=blue] at (-3,-6){$f(\Delta_ Ed}/10)/approx \lambdabar_{Ryd}$Longueur d'onde de Rydberg $\approx l_P \sqrt {O_M \approx \sqrt {\lambdabar_p l_0}$ (mètre)};
