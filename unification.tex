...
Such a pertinence of the Eddington Number means that Number Theory enters Physics: this is the main goal of the present article to confirm this. By contrast, every formalist followed Dirac when he interpreted the Cosmic correlation as age-varying, with a gravitation constant $G$ varying with time.
