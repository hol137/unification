...
\right.
\end{equation}
showing a kind of symmetry between $N$ and $K$.
...
\subsection{The relations with the pentapope numbers and the Euler idoneal numbers}
The connection with the pentapope number $q_{13}$ = 1820 is immediate:
\begin{equation}
