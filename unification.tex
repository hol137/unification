...
\node [anchor = east,color=blue] at (22.75,-6){\LARGE{MACRO-PHYSIQUE}};


\node [anchor = east,color=red] at (16,-3.5){$\rho_c = \frac {3c^2} {8\pi GR^2 } \approx \frac {m_H} {(l_1 / 10^{1/4})^3} \approx \frac {3m_H} {v_{Hum}}  $};
