...
\node [anchor = west,color=red] at (-18.25,20){\LARGE{Nombre egyptien}$3570 = 17 \times 210 \approx \Phi^{17}-1$};
...
\node [anchor = east,color=red] at (16,25){$\frac{1836}{12} = 153 = 1^3 + 3^3 + 5^3 \approx \frac{P^2 \beta}{pf(26)} $~ (0.1 ppm)};
