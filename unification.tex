...
\node [anchor = west,color= red] at (-31,15){\LARGE{Rayon terrestre} $R_T/ct_1 \approx 1/\Phi^8 \approx e/2^7 \approx R/f(24)l_1 $};
...
%\node [anchor = west,color=red] at (-30,16.0){\LARGE{NEURON} $t_N \approx  \frac {8\pi e t_1}{3570}~ (t_1 =$ 1 seconde) };
...
\node [anchor = west,color=blue] at (10,20.0){\LARGE{R(HUBBLE)} $R \approx f(26)/6 $};
