...
\node [anchor = east,color=red] at (36.7,15.75){$ a^a \approx (e ^ {1/e})^{p_G (n_t/p)^  {1/2} } \approx (\sqrt {a_s} ^  {1/ \sqrt {a_s}})^{\sqrt {pH}} \approx ((sin \theta) ^  {-sin \theta})^{(a/\pi)^2} \approx (q ^  {-q})^{2(a sin^2 \theta)^2} \approx (\pi ^ {1/\pi})^{1850} \approx ((a_s^2)^{1/\sqrt a})^{1850} \Rightarrow \pi^{\sqrt a} \approx a_s^{2\pi} \approx e^{p/a} \approx F\pi/e $};
...
\node [anchor = east ,color=blue] at (30,20.2){~$\frac {f(26)}{6} \approx 2^{2^7} \approx (f(-5))^{211} \approx (\frac{2}{\Phi})^{2\times 209} \approx \frac{R}{\lambdabar_e} \approx (\frac{2}{u})^{210} \approx u^{3570q^2} \approx(\frac{6}{\pi})^a \approx (eS)^{36} \approx (\frac{g_3}{g_2})^{a_{00}-1}    $~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
