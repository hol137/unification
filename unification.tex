...
\right.
\end{equation}
where  $\textbf{N}_9 = 9N_9$ is the total number of polynomial zeros on the unit circle for the central string compactification dimension 9, and $N_{9}-1 = 329$ is both the number of non-trivial $9D$ symmetries and the above Guanine atomic number. This is clearly related to the relations with pentapope numbers, showing a kind of symmetry between $N$ and $K:
\begin{equation}
 \left\{
    \begin{array}{ll} 
           q_8 = N_9  \\ 
