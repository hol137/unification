...
La partition de Ramanujan $e^{\pi \sqrt{2d/3}}/4d \sqrt3$ joue un rôle central. De plus, $f(14) = f(10)^2$ implique $g = Z/495^2 \approx 153/(2 \times 3 \times 5 \times 7) \approx 1838.5\sqrt2/3570 $ confirmant le boson de Higgs $495^2$, lié à $\Gamma = \gamma a/\pi$, la constante d'Atiyah, où $a$ est la constante électrique 137.036.}
