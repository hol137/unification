...
The String Theory uses only partially the Number Theory. With its continuum space, its compactification process results in an enormous multiplicity of solutions $(10)^{500}$. One goal of this article is, by replacing the continuum by a Toponic quantinuum, to connect more tightly the two domains. In particular, the jontion is made with the celular automaton physics \cite{tHooft}.     
