...
The general tendency of formalists has been to neglect such correlations, invoking either the hasard or a multiplicity of Universes (Multiverse hypothesis). However, the Large Number Correlations of Eddington, are now confirmed and extended to a Bott octonion sequence by the Topological Axis (Graph 3) which rehabitates the String Theory.
