...
\begin{equation}
 \left\{
   ...
   495 \approx (H/H-p_t)g_1g_2g_3 \approx a_s (\tau/\mu-1)/g_1g_2g_3 \approx a_s^2 \sqrt{n_tH}/\Pi_0 \approx n_t s_{65}/8\pi \Pi_+ \approx (137/a)^4\Delta_{Ed}/g_1g_0g_3 
    \end{array}
\right.
\end{equation}
...
The 26 sporadic groups include 20 "happy" groups tied to the Monster, and 6 "pariah" groups. Many relations with the physical parameters were published \cite{Sanchez3}, two of them implying formula for $R$ and $R_c$ (Tables 2 and 3). The main connections implying the Monster Group order $O_M$ are (4, 1.5 6 and 14 ppm):

\begin{equation}
 \left\{
    \begin{array}{ll}
          e^a \approx 2O_MZ^2p/1839W \\
           e^{1/2a} \approx O_M /(2a^2P)^2 \approx \mu^2W/2a^2Z\\
           2R/R_e \approx O_MZ/P^2FW\sqrt{pH}
    \end{array}
\right.
\end{equation}

Thus \textit {The Monster Group is related to the CMB through the holographic term $e^a$ and the canonical ratio $2R/R_e \approx 1/g_0$}.
