...
\node [anchor = west,color= red] at (-16,-19.3) {~~~~~~~~~~$ \frac {g ~\approx~  c/annee}{g_1} = \frac{gt_1^2 }{l_1} \approx \sqrt {a_{00}} ( sin(2 \theta) \approx \sqrt {\frac{\pi 2^{1/12} }{4 zeta (3)} } \approx \frac{\pi(1+\mu+\tau)}{4\tau} )  \approx \frac{2Z}{W} (S \approx \frac{u}{q}) \approx \pi^2 ~~~~~~~ $};
