...
\node [anchor = east,color=black!40!green] at (27.95,26.250){$O_M \approx (a^{1/3}/2)f(1/\delta) \approx (d_e/a_s)(\delta+1)^{3570}  \Rightarrow DOUBLE a = 137+\delta  \approx 137.0359999099=$ mesuré (0.15 ppb)~~~};
%\node [anchor = west,color=black!40!green] at (27.95,26.250){$\delta = a-137$};
\node [anchor = east,color=black!40!green] at (25.95,24.50){$ f_3(1/(a-137)) \approx \sqrt a sin \theta (H/p)e^a \Rightarrow a \approx 137.0359999099$: idem (0.03 ppb)~~~~~~~~~~~~};
