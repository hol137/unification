...
This means also that a local theory, Relativity, was \textit {unduly} applied to cosmology. Indeed, this Theory is based on the concept of an inertial referential, which cannot be defined by theory, but is observationally evident: the Cosmic Microwave Background (CMB). It was prredicted by the steady-state model, with a Planck thermal spectrum. This was contradictory with the initial standard model, which was obliged to introduce the monstruous inflation step, which introduces as many problems as it resolves. Moreover, one of the three conditions of Sakharov for the elimination of antimatter during the Big Bang is precisely the rupture of thermal equilibrium. So \textit {the CMB is the refutation of the Big Bang, but it was unduly presented as its confirmation.}
...
% Critical density $3 c^2/ 8\pi R^2$ & $\rho_{cr}$  & $kg m^{-3}$  & $ 9.41197996 \times 10^{-27} $ & 0.3   \\
  ...
  %Official CMB temperature & $T_{CMBoff}$ & K & $2.7255(6)$ & $2 \times 10^5$ \\    
   ...
   Critical Matter versus radiation ratio $\rho c^2/u_{CMB+CNB} $& $K_E$ & - &  12045.685 &  \\
   
   Square root of the ratio double CMB photon number/atomic number & $K_n$ &- & 12087.731  & Eq(6) \\
