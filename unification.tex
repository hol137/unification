...
\node [anchor = east,color= red] at (-19.5,-12.5) {~~~~~~$ \Phi \approx \frac {a^3  sin \theta}{1836^2} $};

\node [anchor = east,color= red] at (-19.5,-15.5) {~~~~~~$ w_5 \approx \frac {2a^2 sin \theta}{3570-1} \approx \sqrt {a_s \sqrt {\pi e}} $ };
