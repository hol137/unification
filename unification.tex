...
\title{Erratum of Towards Science Unification Through Number Theory}
...
\section{Direct connection between the Topological Axis and Weak Bosons}
For the ultimate dimension $d = 30$, the Topological Axis shows up the following properties:

\begin{equation}
 \left\{
    \begin{array}{ll}
    f(30) \approx 3^{165} ~~~;~~~ 165 = 495/3 = K(6) = 11 \times 15  \\
...
Now, since the group U(1) characterizes the unit circle, there must be a connection between the crystallographic 165 and $g_1$. Indeed

\begin{equation}
 \left\{
    \begin{array}{ll}
    165 \approx 1837/2d_eag_1^3 \approx a^5g_1^2/137^2d_e^3p_t   ~~~\Rightarrow~~~  g_1^5 \approx d_eH^2/2a^4 \approx \mu + 2\\
    g_1 = Zsin\theta/H^{(0)}   ~~~;~~~  (1/sin\thet)^{10} \approx 3^3a^2/2 \times 137~~~;~~~ (Z/H^{(0))^{10} \approx ((p_tn_t)^{1/2}p_t/H)^5/4a^8\\
    \end{array}
\right.
\end{equation}
