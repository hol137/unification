...
\begin{equation}
 \left\{
    ...
    ~~~~~~~~ \mu_0^7 \approx (\tau_0/2)^5 ~~~~ \rightarrow ~~~~ (\mu p_t/n_t)^7 \approx (\tau n_t/2p_t)^7 ~~~~\rightarrow~~~~ n_t/p_t \approx (61/60)^{2/12}\\
    \\
   (\mu_0+1)\tau_0/\tau\approx \mu_0^3/\mu^2 \approx (5/2)^{2/12} 137  ~~~~(ppm)
    \end{array}
\right.
\end{equation}
...
The 5 first Weigel numbers 5,19,59,165,419 add to 667, which enters four times in the sum of the Herman numbers untill the dimension 12 giving exactly the double of 1836, leading alone the term $W_6 = 1001 = 10^3 + 1$. One observes the following symmetry between the dimensions 10 (Superstring) and 11 (Supergravity):
...
\section{The $4^{th}$ Weigel number and the coupling $g_1$}
...
\section{The correction and extension of the musical relation}
 ...
 \left\{  
    \begin{array}{ll}
       ...
       \\
        ...
        \\
        e^3 \approx (1/d_esin\theta)^4  ~~~~ \rightarrow ~~~~ (1/d_esin\theta)^{1/6} \approx (p_t/p_W)^4ZH/Wn_t
        \\
