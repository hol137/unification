...
\node [anchor = west,color=red] at (-27,10){$(ct_N/\lambdabar_e)^2 \approx R_e/2\lambdabar_e \approx D_{Eg}/l_P ~;~D_{Eg} \approx \sqrt {2R_T l_1} = 3570~ l_1  \Rightarrow  l_1 = 1 metre   $};
