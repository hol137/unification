...
Combined R23W: $v_d = u_{2D = 2(d+3)} = 1 + 2(d+3) + 8 (d+3)^2$ for d = 12 & $v_{12}$    & $ \underline {1831} $ & 30D to 12D \\   
 R23W for $d$ = 8:  Eddington's formula\cite{Eddington}: $u_{8}= 136 + 1$ & $u_{8}$   & $ \underline {137} $ & $v_{8}= 495 + 496$ \\      
  ...
  Adimensional Electric charge $\approx y\Pi_+/2d_e\sqrt F$ $g_1 cos \theta = g_2 sin \theta = (4\pi_q/a)^{1/2}   & $q\approx(6^2/\beta d_e)^{-1/3}$ & 0.30297311 & $3^{10}\approx 6(2\pi_q)^5 \approx \pi a^2$\\
...
\label{tab:3:table3}
 ...
 Rydbergh reduced wavelength $\lambdabar_e(2aH/p)^2$ & $\lambdabar_{Ryd}$  &$ m$  & $1.45190673 \times 10^{-8} $ & $\lambdabar_{Ryd}/l_P \approx \sqrt{O_M}$ ~(Monster Group order) \\
