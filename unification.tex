...
%\node [anchor = west,color=blue] at (-1,-5){Longueur d'onde de Rydberg};  
...
\node [anchor = west,color=black!40!green] at (0.,0.0) {\LARGE{masse du BI-CODON d'ADN}};
\node [anchor = east,color=black!40!green] at (-0.2,-0.2) {$m_e~f(16) / \Phi_0^2 \approx H m_H \approx $ };
...
\node [cross,anchor = west,color=black!40!green] at (3.45,3.15){$ T_{C} \approx 2.73 ~Kelvin \approx T_{H_2}T_{O_2}/T_{H_2O} \approx T_{mam}/j $};
\node [cross,anchor = west,color=black!40!green] at (16.0,1.8){$ hc/k_BT_{mam} \approx \sqrt{Rl_P} $};
...
\node [anchor = west,color=black!40!green] at (12.25,12.250){\LARGE{NEURON}};
...
\node [anchor = west,color=black!40!green] at (-5.25,10.250){~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~$(ct_N/\lambdabar_e)^2 \approx R_e/2\lambdabar_e \approx D_E/l_P$};
