...
\node [anchor = east,color= red] at (-25.5,-10.9) {~~~~~~$ \Phi^{a} \approx a^{p/a}$};
\node [anchor = east,color= red] at (-6,-8.9) {~~~~~~$ \Phi^{210} \approx p^{p/a} \approx Ram_{1836} \approx P^2a \frac {\sqrt {Hn_t}}{p} ~~ (2 ppm) $};
