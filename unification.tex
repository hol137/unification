...
\node [anchor = west,color= red] at (-5.2,-19.3) {~~~~~~~~~~$ \frac {g ~\approx~  c/annee}{g_0} = gt_1^2/l_1 \approx sin(2 \theta)\sqrt {a_{00}}  \approx \frac{2Z}{W} (S \approx \frac{u}{q}) \approx \pi^2 $};

\node [anchor = west,color= red] at (-14.2,-23.3) {$ \frac {ct_1}{coudee} \approx \frac {l_1}{r_{ADN}} \approx \frac {2}{\pi} \frac {2v_T t_1}{l_1} \approx \frac {p_{hol}^3}{4\pi} \approx 150^4 \approx p^{8/3}  ~~~~~~~~~ v_T = \frac {2\pi R_T}{Jour} ~~~~~~~~~ r_{ADN} \approx 2 nm  $};
...
%\node [anchor = west,color= red] at (-2,-29.6) {$\frac {\pi}{e} \approx ucos \theta \approx (\frac {r_H}{\lambdabar_e})^{1/34} \approx \Phi^q \approx 4\pi q^2 \approx \frac {4\pi}{3}(g_0\approx g_1 \sqrt g_2)^3 $};

%g_0 \approx g_1 \sqrt g_2)^3

%\node [anchor = west,color= red] at (-26,-29.6) {~~~~~~$ \frac {1}{g_1g_2g_3} \approx g_1\frac {2a^2}{\tau} \approx  \approx \frac {g_2}{2} \sqrt {\frac {Hç 0}{p}}\approx \frac {H}{\sqrt {H^0}}  $};

%$ \approx l_P \sqrt{O_M}$ \approx \sqrt{\lambdabar_p l_1}$ (mètre)};w_5 = 5(1-e^{-w_5}) 
...
\node [anchor = east,color=red] at (-12,18.850){$2^{2^7-1}-1 $ : NOMBRE DE LUCAS};
...
%\node [anchor = west,color=blue] at (20.,20.0){$R_{HUB}\approx \frac {P (R_T \approx ct_1 /\Phi^8}{a_s (a+1)}$}$};
