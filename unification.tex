...
\node [anchor = west,color= red] at (-10.2,-15.3) {$ \frac {ct_0}{cd} \approx \frac {l_0}{r_{ADN}} \approx \frac {2}{\pi} \frac {2v_T t_0}{l_0} \approx \frac {p_{hol}^3}{4\pi} \approx 150^4 ~~~~~~ v_T = \frac {2\pi R_T}{Jour} ~~~~~~ r_{ADN} \approx 2 nm  $};
