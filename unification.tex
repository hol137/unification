...
\node [anchor = east,color= red] at (-25,-10.9) {~~~~~~$ \Phi^{a} \approx a^{p/a}$};
\node [anchor = east,color= red] at (-5.5,-7.9) {~~~~~~$ a^a \approx (2+\sqrt3)^{2^9} \approx (2a^2)^{2^9} \approx \phi^{5\times 153 = 3(2^8-1) }  $};
