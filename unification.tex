...
It was emphatised that the charged Lepton mass ratio $ \mu $ is closed to the product of the four initial prime numbers $2\times 3\times 5\times 7 = 210 = \mu_0 $ and that their sum is close to the ratio $2+3+5+7 = 17 = \tau_0/\mu_0 $

The couples (2;3) and (5;7) were associated by the Holic Principle to the couples (Time-Space) and (Matter-Feld). But it was not recalled that the fractions 3/2 and 7/5 are the first fractions of the convergent series to $\sqrt 2$, and called Pell (or Lambda) numbers, as solutions of the Pell-Fermat equation $Y^2 - 2X^2 = 1$ (couple 3;2) or $Y^2 - 2X^2 = -1$ (couple 7;5) $. All the Pell numbers (series A000129 and A001333) are associated to the entire powers of the generating function $h_1 = 1 + \sqrt 2$, tied to the reduced generating function $h_1 /\sqrt 2 \approx g_1^{-1/2}\approx a_s^{1/4} $. One observes:
...
\begin{equation}
 \left\{
    ...
    \\
    f(30) = f(-6)^{2^9} \approx h_3^a ~~~~~~~~~~~~~~\Rightarrow\\
    
    \\
    ~~~~~~~~~~~~~~~~~~~~~~~~~ f(-6) \approx (1/g)^{1/g} a/137\beta^2 \approx (1/g)^{H/p_tg}
      
    \end{array}
\right.
\end{equation}

This confirms the pertinence of the product $g$ of the three gauge couplings, which was already noted in the previous article. But here the connexion is made with the canonical economic term $a^a$ and f(30), whose connection with physics is recalled below.
