...
\node [anchor = east ,color=blue] at (27,20.2){~$\frac {f(26)}{6} \approx 2^{2^7} \approx (f(-5))^{211} \approx (\frac{2}{\Phi})^{2\times 209} \approx \frac{R}{\lambdabar_e} \approx (\frac{2}{u})^{210} \approx u^{3570q^2} \approx(\frac{6}{\pi})^a \approx (eS)^{36} \approx (\frac{g_3}{g_2}\approx \frac{\pi a x_0^{420}}{6\beta 137} )^{a_{00}-1}    $~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
