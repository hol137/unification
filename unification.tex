...
Since the Poincare-Hilbert opposition, the mathematians separated in intuitionnists and formalists. In particular, Poincare \cite{Poincare1} explained that the cosmology cannot be founded on differential equations, because of the involved "free parameters" in an \textit{unique} Univers. Las, the mainstream has followed Hilbert and his differential equations, leading nowadays to a blockage of the standard 6 "free parameters" cosmology, with its "mysterious" so-called "dark energy" with the relative density 0.7, by respect to the critical one. 

The situation is even worse in the particle physics: there are about 20 "free parameters". The Table 1 presents the main ones, and the Table 2 recall the main physical constants. For specifying some values, an Optimal Correlation Principle has been applied \cite {Sanchez2}, interpreting the "free parameters" as computation bases in a Computing Cosmos. Also, the standard superssymetry model fails completely, since no confirmation comes from the CERN super-collisionner. This article shows that a number of symmetries have been neglected, in particular the Eddington's proton-tau symmetry. But his Fundamental Theory has been disregarded \cite{Eddington}, since, at his epoch, it was strange to interconnect cosmology and microphysics, presenting a so simple Large Number $ N_{Ed} = 136 \times 2^{256}$ as the number of hydrogen atoms in the Universe. Nowadays, nobody recalls that it is precisely the number of \textit{neutron masses} in 30 \% of the Universe critical mass, using the simplest formula involving the Planck mass, and the four basic masses of electron, proton, Hydrogen and neutron: 
...
\textit {cosmologists, which must consider the Universes as a whole, has not introduced the Topon, which explain at last the $10^{120}$ ratio between the vacuum quantum energy and that of the Universe.}
...
\bibitem{Steinhardt} Obied, Georges; Ooguri, Hirosi; Steinhardt, Paul J. (2018). "On the Cosmological Implications of the String Swampland". Phys. Lett. B. 784: 271–276. arXiv:1806.09718v2. Bibcode:2018PhLB..784..271A
...
\bibitem{Sanchez2} Sanchez F. M. A Coherent Resonant Cosmology Approach and its Implications in Microphysics and Biophysics, Prog. Theor. Chem. and Phys, Springler, v. 30, p. 384, 375-407 (2017).

\bibitem{Davies} Davies P.C.W. The Accidental Universe, p. 50, C.U.P. 1993


\bibitem{Sanchez3} F.M. Sanchez, V. Kotov, M. Grosmann, D. Weigel, R. Veysseyre, C. Bizouard, N. Flawisky, D. Gayral, L. Gueroult, ``Back to Cosmos''. Progress in Physics, vol. 15, issue 2, (2019).
