...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Neutron/Electron mass ratio ~ $(\pi^2w_i/4)^3$  & $n_t$ & 1838.6836617  & 0.5 ppb \\     
    
   Planck ratio $m_P/m_e \approx 2^{2^6}(a/4\pi)^3 p-t\beta^2/n_t$ &$ P$   & $2.389015907 \times 10^{22}$ & ppb  \cite{Sanchez2}  \\
