...
The series $K_n$ (table 7) represents the number of rotations in an Euclidean space of dimension n: 1,5,5,19,19,59,59. The parition of this series leads to the series $W_n$  
1,5,19,59,165, which represents the number of rotations in an Euclidean space of dimension 2n, with $W_0$ = 1. This series can be considered as the generator of Hermann series, the total number of symmetries (rotations + symetry-rotations), through the following law: 
