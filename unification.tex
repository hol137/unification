...
Rule 23 Wolfram cellular automaton $ u_d = 1 + d(2d+1)$ for d = 30 & $u_{30}$    & $ \underline {1831} $ & $d=30 \Rightarrow k = 7$
Combined Rule 23 Wolfram cellular automaton $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 12& $u_{8}$    & $ \underline {1831} $ & Compactification $d= 30 \to 12$ \\
  
  Rule 23 Wolfram cellular automaton $u_d = 1 + d(2d+1)$ for d = 8 & $u_{8}$    & $ \underline {137} $ & 137 = 136 + 1 (Eddington's development) \\   
    
  Combined Rule 23 Wolfram cellular automaton $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 1& $u_{2\time (1+3}$    & $ \underline {137} $ & Compactification $d= 12 to 1$ \\ 4D reduces to 1D   
  ...
  \hskip-0.0cm\begin{tabular}{llllllllllllll}
    ...
    $K_d$ (positive $PSO_{Cr}$)  & 1 & 5 & 5 & 19 & 19 & 59 & 59 & 165 & \underline{165} & 419 & 419 & 1001& 1001 \\
     ...
     %$K^{(d)}_-$  &  & 1 & 5 & 15 & 35 & 70 & 126 & 210 & 330 & \underline 495& 715 & 2001  \\
      ...
      $v_d = u_{2 \underline d = 2(d+3)} = 8\underline d^2 +2\underline d + 1$ & \underline{137}  & 211 & 301 & 407 & 529 & 667 & 821 & 991  & 1177 & 1379 & 1597 & \underline{1831} & 2081 \\
