...
\end{equation}
\textit {This defines $a$ in its 0.15 ppb determination (Table 2)}. Note that:
\begin{equation}
p_{495} = 3511 + 28 = 3539 \approx 419 a_s n_t/p_W \approx  \eta/q \approx 2\pi(9\mu) \approx 495 g_1p_G/g_2a \approx 495 g_3 \sqrt a/2 
\end{equation}
