...
\node [anchor = west,color= red] at (-34,-27.5) {$ 2^{\frac {1}{665}} \approx 3^{\frac {1}{1054}} \approx (\frac {a}{137})^4 \approx 4g_1g_Z \approx \frac {WZ \sqrt a}{a_w} \approx \frac {2a_w}{a_s \pi W^2\sqrt \beta} \approx (sin\theta)^{\frac {-3571}{a^3}} \approx S^{\frac {p_G}{a^3}} \approx g_1^{\frac {-1}{2^{10}}} \approx g_0^{\frac {-9}{2H}} \approx (\frac {R_C}{\lambdabar_e})^{\frac {2\pi^2 + 1}{e^{16}}}~;~tg\theta  \approx \frac {g_2}{g_1} \approx \frac {\sqrt a}{4g_F} \approx \frac {\tau}{9\mu} \approx \frac {\pi \Phi}{e}$ };
...
\node [anchor = north,color=red] at (2, 34.75) {$\hbar,G, u  m_{bicodon}, m_{photon}, m_{graviton} \Rightarrow  R_{Cosmos} = R_e^2/2l_P  \approx \lambdabar_e 6^{128}/(1+1/\sqrt 2) \approx l_P (6^{p_G/ \sqrt a} \approx \Phi^{17a^2/ (4\times 137)} \approx 3570^{\frac {\beta a^2}{4\times 137}}) $};
