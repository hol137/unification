...
\node [anchor = east,color=black] at (-7.25,2){$(\frac {a}{137})^4 \approx \frac {2a_w}{a_s W^2\pi a_S \sqrt \beta}\approx 4g_1g_Z$};
...
\node [anchor = east,color=red] at (15,-8){$\rho_c = \frac {3c^2} {8\pi GR^2 } /\approx \frac {m_H} {(l_1 / 10^{1/4})^3} \approx \frac {3m_H} {v_{Hum}}  $};
