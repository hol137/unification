...
\node [anchor = west,color=blue] at (-10,-10){Longueur d'onde de Rydberg $\times ~3Z/H^0 \approx a_wW/a^3H^0$};
...
\node [anchor = east,color=black!40!green] at (0.,0.0) {$m_e~f(16) / \Phi_0^2 \approx H m_H \approx $ };
