...
\node [anchor = text=black] at (-28.,-38.0) {\small{Nombres spectroscopiques: $d=4k+2$ de k=0 à k=7. Pour k = 6: d = 26 dimension des cordes bosoniques }};
...
\node [anchor = west,color=blue] at (-4.5,-4.5){Longueur d'onde de Rydberg $\times ~3Z/H^0 \approx a_wW/a^3H^0$};
...
\node [anchor = east,color=black!40!green] at (0.,0.0) {$m_e~f(16) / \Phi_0^2 \approx H m_H $ };
...
\node [anchor = west,color=blue] at (20.,20.0){$f(26)/6 \approx R ~ (HUBBLE)};
...
\node [anchor = east ,color=red] at (21.5,20.5){~$f(26)/6 \approx 2^{2^7} \approx 2(f(31/2))^6 \approx (f(-5))^{211} \approx R \approx (2R/R_e)^{210}\approx(6/\pi)^a    $~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
