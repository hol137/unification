...
{\color{red} Contrary to old tradition, the modern science is characterised by an a mutiplicity of separated disciplines. In particulat the Number Theory does not play any role in Physics. Even the String Theory does not connect with reality. The two pillars of Physics seem incompatible on the real status of space-time} 
