...
\textit{It was forgotten that Poincare clearly specified that Physics is not possible with varying constants.}
...
This means that the Restricted Relativity was unduly applied to cosmology. Indeed, it is a \textit{local} theory, based on the concept of an inertial referential, which cannot be defined by theory. However it is observationally evident: the Cosmic Microwave Background (CMB). In liaison with the star on-going production of Helium, this thermal bath was predicted by the steady-state model, with the correct temperature (contrary to the erroneous prediction of Gamow) \cite{Hoyle2}. Even more, the precise thermal spectrum was contradictory with the initial standard model, which was obliged to introduce the monstruous inflation step, with as many problems as it resolves \cite{Sternhardt}. Moreover, one of the three conditions of Sakharov \textit{Sakharov} for the elimination of antimatter during the Big Bang is precisely the rupture of thermal equilibrium. 

So \textit {The CMB is the refutation of the Big Bang, but it is unduly presented as its confirmation.}
...
\bibitem{Poincare1} Poincaré H., Dernières Pensées. “Conférence à l’Université de Londres”, pp. 102-103 (Flammarion, 1913)

\bibitem{Poincare3} Poincaré H., Sur la théorie des quanta, Journal de physique, vol 2, p. 5.(janvier 1912).
...
\bibitem{Steinhardt} Obied, G.; Ooguri, H.; Steinhardt, Paul J. (2018). "On the Cosmological Implications of the String Swampland". Phys. Lett. B. 784: 271–276. arXiv:1806.09718v2.
...
\bibitem{Poincare2} Poincaré H., La mécanique nouvelle, Eds. Gauthiers-Villars (1924), Jacques Gabay (1989).
