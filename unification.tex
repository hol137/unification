...
%\node [anchor = north,color=red] at (-10,34.75){$ \frac {R}{2 \sqrt{\lambdabar_p \lambdabar_H}}  = \sqrt{\frac {H}{p} (\frac {M}{m_e}  = \frac {d}{\lambdabar_e})} = \frac {\hbar c}{Gm_em_p}  $};



\node [anchor = north,color=red] at (10, 33) {$  R_{Cosmos}/l_1 \approx  u^{(137/e^e)^3 +1} \approx u^{3^6}/S^2   $};
