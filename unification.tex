...
{\color{red} \section{Plan of the Article}

The Introduction (Section 2) recalls the Topological Axis and the main physical parameters and  (Table 1, 2,3), including the values specified by the Optimal Computation Principle, which connect to 0.1 ppm with the Permanent Holographic Osillation Bang Cosmology (PHOB). A series of formula, based on several theories, confirm both the \textit{invariant} Hubble radius and the Cosmos radius.
