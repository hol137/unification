...
\node [anchor = text=black] at (-20.,32.75) {\small{Unité pour le Neuron et la la Super Période $t_{sp}:t_e$. Unité pour Photonde et Gravitonde: $2\pi m_N$}};
...
\node [cross,anchor = east,color=black!40!green] at (3.15,6.15){$RAM_{137}\approx a \sqrt{m_em_P}/m_H ~ (8 ppm)\approx f(18) (R_e/R)^2$};
...
\node [anchor = east,color=red] at (22.,22.5){$RAM_{\sqrt(pn_t)}\approx (O_MO_B)^{1/2}\approx P^2/4\pi \approx f(a^{2/3}) \approx f(2p/a)  \approx a^{2a^2/n_t} \approx p^{p/a} \approx e^{32\pi} \approx \Phi^{210} \approx \phi^j $};
