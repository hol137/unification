...
\node [anchor = text=black] at (-10.,34.75) {\small{Les longueurs caractéristiques entourent la loi: $e^{2^{d/4}}$}};
...
\node [cross,anchor = east,color=black!40!green] at (3.15,3.15){$RAM_{137}\approx a \sqrt{m_em_P}/m_H ~ (8 ppm)\approx f(18) (R_e/R)^2$};
...
\node [anchor = east,color=red] at (17.25,17.650){$f(25)\approx 2e^{24\pi}\approx O_B~ (W/F) \approx \sqrt {O_M}~ (8W \approx 7Z \approx 5aH) $};
...
\node [anchor = east ,color=red] at (17.3,20.0){$f(26)\approx~ $ NOMBRE PREMIER DE LUCAS $(2^{2^{2^{2^2-1}-1}-1}-1)\times 12$~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
...
\node [anchor = east,color=black!40!green] at (27.95,22.50){$(a^{1/3}/2)f(1/(a-137)) \approx O_M \approx e^{137e/3} \approx f(30)^{2/3} \Rightarrow a \approx 137.0359999099=$ mesuré (0.15 ppb)~~~~~~~~~~~~};
