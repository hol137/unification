...
\node [anchor = east ,color=red] at (21.3,20.0){$f(26)\approx~ $ NOMBRE PREMIER DE LUCAS $(2^{2^{2^{2^2-1}-1}-1}-1)\times 12$~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
...
\node [anchor = east,color=red] at (23.,23.0){$RAM_{\sqrt(pn_t)}\approx (O_MO_B)^{1/2}\approx P^2/4\pi \approx f(a^{2/3}) \approx f(2p/a)  \approx a^{2a^2/n_t} \approx n_t^{n_t/a} \approx e^{32\pi} \approx \Phi^{210} \approx \phi^j $};
