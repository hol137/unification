...
\node [anchor = west,color= red] at (-14.2,-23.3) {$ \frac {ct_0}{cd} \approx \frac {l_0}{r_{ADN}} \approx \frac {2}{\pi} \frac {2v_T t_0}{l_0} \approx \frac {p_{hol}^3}{4\pi} \approx 150^4 \approx p^{8/3}  ~~~~~~~~~ v_T = \frac {2\pi R_T}{Jour} ~~~~~~~~~ r_{ADN} \approx 2 nm  $};
...
\node [anchor = north] at (-10.9, 34) {$   f(32) = e^{2^{2^{2^{2}}}} \approx (\frac {R_C}{\lambdabar_e})(\frac {\tau}{n_t})^{128/3} ~~~~ (\frac {4\pi^2}{3})(\frac {R_C}{r_H})^3 \approx a^a \approx \Pi_1^{20} O_{M_i} \approx (\frac {Z}{W})^{35\times 153}$};
