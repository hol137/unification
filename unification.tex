...
\begin{equation}
 \left\{
    \begin{array}{ll}
    2\times 1836 = \sum_1^{12} N_d = 4\sum_1^5(W_n) + 10^3  ~~~~;~~~~ 2\times \sum_1^7(W_d) = 11^3 + 5  ~~~~\Rightarrow \\
    \\ 
