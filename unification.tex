...
\node [anchor = east,color=red] at (12,26){Synthèse triconceptuelle : $\hbar,G, m_e, m_p, m_H \rightarrow R/2~~;~~ \hbar,G, m_N^3 \rightarrow R_e/2  $};

\node [anchor = east,color=red] at (12,24){ $ u = R_e/R = Hp/a^3 \approx e^{2/e^2}  $ ~~(1.6 ppm)  };
