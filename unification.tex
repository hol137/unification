...
\draw [-,color=green,dashed] (-12.0,-31.) node[left]{} -- (-12.,-12.) node[right]{};   % ATOM DIAMETER vertical line
...
%\node [anchor = west,color=blue] at (-12.,-12.) {$3f(10) \approx Rayon de l'atome d'Hydrogène \times ~ 2\pi/3 \approx (2R/R_e)^{16}\approx 3570^{16}/O_M $ };
...
%vérifie $Ct_0/\lamdabar_e \approx 5^2 f(30)$, confirmant $C$. } }
