...
\node [anchor = west,color= red] at (-27,-24.5) {$ \Sigma (d_k+1) = 2^7 + 2^3 = 136 \approx (\tau^{g_1} \mu^{g_2/g_3} )/2 \approx             \frac {\sqrt3 m_{bc}}{2 \sqrt a m_H}  ~;~ \frac {ln\mu}{ln\tau} \approx g_0 = \frac {g_1g_3}{g_2} \approx \frac {pp_G}{2a^3}  ~;~ \mu^a \approx \tau^{\frac {pp_G}{2a^2}} \approx 3^{665} \approx 2^{1054= 2\times 31 \times 17}   $ };

\node [anchor = west,color= red] at (-27,-30.5) {$ 2^{1/665} \approx 3^{1/1054} \approx (a/137)^4 \approx 4g_1g_Z \approx (sin\theta)^{-3571/a^3} \approx S^{p_G/a^3} \approx g_1^{-1/2^{10}} \approx g_0^{-9/2H} \approx (R_C/\lambdabar_e)^{(2\pi^2 + 1)/e^{16}}  $ };
