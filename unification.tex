...
\node [anchor = west,color= red] at (16,-21.5) {$\sqrt {a/137}(p_K = \frac {1 + \mu +\tau}{2}) \approx \frac {p_G(N_0^2-1)}{\sqrt {Hp}} \approx \frac {d_e\sqrt {H^{(0)}sin\theta Hp}}{6N_0^{\prime} }   $};



\node [anchor = west,color= red] at (-24,-23.5) {$ 7\times (\underline {s}+1) + 6\times (\underline {p}+1) + 4\times (\underline {d}+1) + 2\times (\underline {f}+1) = 107 + 30 = 137 \approx a = a cos^2 \theta + a sin^2 \theta$ };
