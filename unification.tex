...
{\color{red} The unified Pythagoras Number Natural Philosophy is replaced now by a science showing separated disciplines lacking connections with the Number Theory. The two pillars of Physics do not agree on the real status of space-time, and the standard physics contains about 30 "free parameters". In the frame of the Permanent Sweeping Holographic Oscillatory Bang model (PSHOB), this article uses the Lucas Large Number to connect gravitation and the gauge couplings. Through the Holic Principle, the mass concept induces a symmetry between the Newton and Planck constants. Using a cellular automaton series, the main dimension 30 of the Topological Axis reduces to unity, through 12D and 4D compatifications, debunking the String Theory. This 1D Holography means a "Swept" Absolute Space,  tied to the Cosmic Microwave background (CMB), justifying at last the Parity Violation and the local time relativity for a moving object. The Euler maximal ideonal number, connected with the generalized Riemann conjecture, is tied to the proton-elecron mass ratio. The supergravity dimension 11 identifies with the first prime of the base 3 Mirimanoff couple, in connection with the arithmetical monster 137, the CMB tempeature, the Golden Ratio and the old chinese musical scale. The second prime of the base 2 Wieferich couple specifies the fine-structure constant within its 0.15 ppb indetermination. This confirms the Atiyah approach and the Eddington's Fundamental Theory, in particular the non-standard symmetry proton-tau. The Wieferich couple strongly suggests an eta-tau symmetry, tied to basic "economic" numbers of type exp(exp... These overlooked symmetries explain the failure of the present Supersymmetry. The Economic Computation and the Holic Principles justify at last the origin of the fermion masses. This implies physical, chemical, biologic and crystallographic parameters reaching 0.1 ppm precision. This excludes the concepts of Multiverse, Continuum, Infinity, Locality and Zero-mass Particle, and leads to stringent predictions. } 
