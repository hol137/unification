...
\node [anchor = west,color= red] at (-27,-25.5) { $ \sum_{k=0}^{k=7} (d_k+1) = 2^7 + 2^3 = 136  \approx (\tau^{g_1} \mu^{g_2/g_3} )/2 \approx             \frac {\sqrt3 m_{bc}}{2 \sqrt a m_H}  ~;~ \frac {ln\mu}{ln\tau} \approx g_0 = \frac {g_1g_3}{g_2} \approx \frac {pp_G}{2a^3}  ~;~ \mu^a \approx \tau^{\frac {pp_G}{2a^2}} \approx 3^{665} \approx 2^{1054= 2\times 31 \times 17}   $ };
