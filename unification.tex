...
\node [anchor = text=black] at (-20.,34.5) {\small{Double l'AXE COSMIQUE, qui entoure la loi, pour~ b = e: $f_b = b^{2^{d/4}}$~~~ (1 ppm = $10^{-6})$ }};
...
\node [anchor = west,color= red] at (23.5,-21.5) {$2p_K = 1 + \mu +\tau$};
