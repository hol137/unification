...
\node [anchor = west,color=blue] at (-8.2,-8.3) {~~ $t_0$ = 1 seconde : $l_0/l_P \approx \frac{RR_e}{(2ct_0)^2} \approx \frac{O_M}{\sqrt{a_G}} \approx 137 g_1 O_B/\pi  ~~~~~~g_1 = q cos\theta \approx 0.34362 $};
...
\node [anchor = north] at (-10.9, 34.2) {$ e^{e^{e^{e^{e^{-W/H^0}}}}} ~~~~~ 2e ~~~  f(32) = e^{2^{2^{2^{2}}}} \approx (R_C/\lambdabar_e)(\tau/n_t)^{128/3} ~~~~ (4\pi^2/3)(R_C/r_H)^3 \approx a^a \approx \Pi_1^{20} O_{M_i} \approx (Z/W)^{35\times 153}$};
