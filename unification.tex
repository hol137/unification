...
\node [anchor = east,color=blue] at (30.0,8.25){$f(20) = e^{2^5}  \approx (5/3)^{2^6}/2 ~ \approx \frac {\sqrt{m_Pm_F}}{\pi_a sin\theta} \approx \frac {sin^2 \theta~ l_1 }{r_H} \frac {l_1 }{sin \theta  \sqrt {\lambdabar_e \lambdabar_{\mu} }  }$};
...
\node [anchor = east,color=blue] at (21.25,-16){\LARGE{MACRO-PHYSIQUE}};
