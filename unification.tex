...
\node [anchor = west,color= red] at (-18,-15.8) {~~~~~~$sin \theta \approx \frac {2\pi (a+1)}{H \sqrt{d_1e}} \approx \frac {a^3}{ \Phi(1836^2 -(e/sin \theta)^2)} \approx (\frac {1}{\Phi^3} - \frac {1}{\Phi^9})^{1/2} \approx \frac {g_2}{\Phi^{g_2}} ; a_{00} = i^{-i \pi} = e^ {\pi^2/2}   \approx a + 2 \approx \frac {\Phi^{16}}{16} + 1  \approx (\frac {\Phi^{g_1}}{g_1})^4$} $} ;
...
\node [anchor = east,color=red] at (15,-3.5){$p_{hol} = (4(r_H/\lambdabar_e = aH/p)^3/3)^{1/2}$};


\node [anchor = east,color=blue] at (22.75,-6){\LARGE{MACRO-PHYSIQUE}};


\node [anchor = east,color=red] at (21,-8){$\rho_c = \frac {3c^2} {8\pi GR^2 } \approx \frac {m_H} {(l_1 / 10^{1/4})^3} \approx \frac {3m_H} {v_{Hum}}  $};
