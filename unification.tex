...
\node [cross,anchor = east,color=black!40!green] at (6.15,3.15){$RAM_{137}\approx a \sqrt{m_em_P}/m_H ~ (8 ppm)\approx f(18) (R_e/R)^2$};
...
\node [anchor = east ,color=red] at (21.3,19.0){$f(26)\approx~ $ NOMBRE PREMIER DE LUCAS $(2^{2^{2^{2^2-1}-1}-1}-1)\times 12$~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
...
\node [anchor = east,color=black!40!green] at (27.95,26.250){$(a^{1/3}/2)f(1/(a-137)) \approx O_M \approx e^{137e/3} \approx f(30)^{2/3} \Rightarrow a \approx 137.0359999099=$ mesuré (0.15 ppb)~~~~~~~~~~~~};
...
\node [anchor = east,color=red] at (24.,21.0){$RAM_{\sqrt(pn_t)}\approx (O_MO_B)^{1/2}\approx P^2/4\pi \approx f(a^{2/3}) \approx f(2p/a)  \approx a^{2a^2/n_t} \approx n_t^{n_t/a} \approx e^{32\pi} \approx \Phi^{210} \approx \phi^j $};
