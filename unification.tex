...
R_c = R_e^2/2l_P \approx 2^{128} l_P (Rg_0/ \lambdabar_H)^2 \approx 9.075773 \times 10^{86} m 
 ...
 \textit{The Table \ref{CosmosTable} presents 37 simple formula confirming this Cosmos radius $R_c$.} In particular: 

\begin{equation}\label{Eq7}
(ln(R_c/\lambdabar_e))^2 \approx (ln(M_e/m_e)^2 + 2(ln(R/\lambdabar_e)^2)
\end{equation}

where the 2 factor comes from the local character of the speed $c$ \cite{Sanchez2}. 
