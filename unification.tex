...
\node [anchor = west,color=blue] at (-8.2,-8.3) {~~~~~~ $t_0$ = 1 seconde : $ \frac{l_0}{l_P} \approx \frac{RR_e}{(2ct_0)^2} \approx O_B ( \frac{2ct_0 }{2\pi R_T} = \frac{137 g_1 }{\pi}) \approx \frac{O_M}{\sqrt{a_G}}  $};
