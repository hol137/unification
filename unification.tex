...
\node [anchor = west,color=red] at (-28,22){\LARGE{Nombre Egyptien} $3570 = 17 \times 210 \approx \Phi^{17}-1$};
...
\node [anchor = east,color=red] at (32,25){\LARGE{Nombre Biblique} $153 = \frac{1836}{12} = 1^3 + 3^3 + 5^3 \approx \frac{P^2 \beta}{pf(26)} $~ (0.1 ppm)};
