...
(\tau -1)^{32}/f(32) \approx a^2/137
 ...
 \textit{So, the terminal dimension 32 of the Topological Axis is associated to $\tau$, the terminal lepton. The number three of particle families is therefore confirmed}. The associated nucleotide to the Guanine is the Cytosine, which is clearly tied with the topological function f(10), giving rise to a formula in the Hubble Table. The other couple (AT), is associated with the Fermi constant. One notes the direct correlation implying \textit{the product} of the nucleotide mass ratios: $4d_e G_u^{(0)} C_y^{(0)} \approx 4d_e A_d^{(0)} T_h^{(0)} \approx (H/3)^2 \approx H^{(0)}/g_0 = H^{(0)} + Z^2/H^{(0)}$, confirming the pertinence of the hypothesis Eq.(9.1) defining  $g_0$. This induces the symmetrical relation implying $s_{65} = 1848$, the last known Euler number. Note that these 1836 and 1848 are the $34^{th}$ and $35^{th}$ areas of integer-sided triangles whose area equals 6 times their perimeter (A332879 in OEIS):
\begin{equation}
 \left\{
    \begin{array}{ll}
...
\textit {The standard central importance of the scalar BEH boson is thus confirmed}.
...
\subsection{The relations with the Euler ideonal numbers}
Among the Euler ideonal ("suitable") numbers (series A000926 in EOIS), one finds $N_9 = s_{54}$ and $K_9 = N_9/2 = s_{43 = N_4 + K_4}$, as well as $210 = \binom{10}{4}= s_{47}$. The last known Euler ideonal number $s_{65} = 1848 = 43^2 -1 \approx (4\pi)^2\sqrt {137}$ is related to the usual dimension 4:
\begin{equation}
...
The associated nucleotide to the Guanine is the Cytosine, which is clearly tied with the topological function f(10), giving rise to a formula in the Hubble Table. The other couple (AT), is associated with the Fermi constant. One notes the direct correlation implying \textit{the product} of the nucleotide mass ratios:

 \begin{equation}
4d_e G_u^{(0)} C_y^{(0)} \approx 4d_e A_d^{(0)} T_h^{(0)} \approx (H/3)^2 \approx H^{(0)}/g_0 = H^{(0)} + Z^2/H^{(0)}
 \end{equation} 

confirming the pertinence of the hypothesis Eq.(9.1) defining  $g_0$. This induces the symmetrical relation implying $s_{65} = 1848$, the last known Euler idoneal number. Note that the numbers 1836 and 1848 are the $34^{th}$ and $35^{th}$ areas of integer-sided triangles whose area equals 6 times their perimeter (A332879 in OEIS):
