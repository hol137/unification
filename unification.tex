...
\node [anchor = west,color= red] at (-26,-27) {$ \Sigma (d_k+1) = 2^7 + 2^3 = 136 \approx (\tau^{g_1} \mu^{g_2/g_3} )/2 \approx             \frac {\sqrt3 m_{bc}}{2 \sqrt a m_H};  ~~~~ ln\mu /ln\tau \approx g_0 = \frac {g_1g_3}{g_2}  $ };
