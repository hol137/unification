...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Proton/Electron mass ratio $m_p/m_e$ ; $n_t/p_t \approx (61/60)^{1/12} \approx (4\pi(p_W/p_t)^2)^{1/\sqrt{p_tn_t}} \approx (n_t-p_t)^{1/(26p_t/n_t)^2} $ & $p_t$   & \underline {1836.15267343}  & 0.06 ppb \\ 
