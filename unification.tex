...
\node [anchor = west,color=blue] at (-6.2,-6.3) {$f(\frac{\Delta_{Ed}}{10}) \approx  $~ Long. de Rydberg $\lambdabar_{Ryd} \approx l_P \sqrt{O_M}\approx \sqrt{\lambdabar_p l_0}  $ ($l_0=$ 1 mètre) };
 
\node [anchor = west,color=red] at (-8.2,-8.3) {~~~~~~ $t_0$ = 1 seconde : $ \frac{l_0}{l_P} \approx \frac{RR_e}{(2ct_0)^2} \approx O_B ( \frac{2ct_0 }{2\pi R_T} = \frac{\Phi^8 }{\pi}) \approx \frac{O_M}{\sqrt{a_G}}  $};
...
\node [anchor = east,color=blue] at (30.0,8.25){$f(20) = e^{2^5}  \approx (5/3)^{2^6}/2 ~ \approx \frac {\sqrt{m_Pm_F}}{\pi_a sin\theta} \approx \frac {sin^2 \theta (l_0 = 1 metre)}{r_H}$};

\node [anchor = east,color=black] at (12.25,12.250){BOSON UNIFIANT $X_{GUT}$};
\node [anchor = west,color=blue] at (12.25,12.0){NEURON $t_N \approx  \frac {8\pi e t_0}{3570}$~ (17 ppm) };
...
\node [anchor = west,color=red] at (-5.25,10.250){~~~~~~~~~~~~~~~~~~~~~$(ct_N/\lambdabar_e)^2 \approx R_e/2\lambdabar_e \approx D_{Egy}/l_P ~~~~~D_{Egy} \approx \sqrt {2R_T l_0} = 3570 l_0  \Rightarrow  l_0 = 1 metre   $};
