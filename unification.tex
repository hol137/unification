...
\node [anchor = west] at (-20.,-19.0) {$f(2\pi) \approx (3R/2\lambdabar_e)^{1/30} \approx t_K/t{ST}(\approx 495 s)$};
...
\node [anchor = east,color=blue] at (22.25,-15){\LARGE{MACRO-PHYSIQUE}};
