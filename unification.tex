...
Combined R23W: $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 12 & $u_{8}$    & $ \underline {1831} $ & from 30D to 12D \\ 
  
 R23W for $d$ = 8 & $u_{8}= 136 + 1$ Eddington's formula   & $ \underline {137} $ & $136 + 1$ \cite{Eddington} \\   
  ...
  Combined R23W for d = 1 & $u_{2\times (1+3)}$    & $ \underline {137} $ & from 12D to 1D \\  
    ...
    Bisection (even part) of number of partitions that do not contain 1 as a part A002865  & $a_{00}$    & $\underline {137}$ & OEIS (A182746) \\
