...
\node [anchor = west,color=blue] at (-3,-3){Longueur d'onde de Rydberg $\times ~3Z/H^0 \approx a_wW/a^3H^0$};
...
\node [anchor = west,color=blue] at (-1,-5){Longueur d'onde de Rydberg $ \approx} l_P \sqrt{O_M} \approx \sqrt{\lambdabar_p l_0}$ (mètre)};
