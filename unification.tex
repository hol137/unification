...
\node [anchor = east,color=blue] at (23.95,24.250){$(a^{1/3}/2)f(1/(a-137)) \approx O_M \approx e^{137e/3} \approx f(30)^{2/3} \Rightarrow a \approx 137.0359999099~~=$ mesuré (0.15 ppb)~~~~~~~~~~~~};
