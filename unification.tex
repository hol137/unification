...
\node [anchor = text=black] at (-10.,34.75) {\small{Les longueurs caractéristiques entourent la loi: $f_b = b^{2^{d/4}}~ for~ b = e$}};
...
\node [anchor = east,color=black!40!green] at (27.95,22.50){$\sqrt a sin \theta (H/p) f_3(1/(a-137)) \approx e^a \Rightarrow a \approx 137.0359999099=$ mesuré (0.15 ppb)~~~~~~~~~~~~};
