...
\node [anchor = east,color=red] at (22.,22.0){$f(2p/(a+1)) \approx (4pi/3)(f(26)f(27))^{1/2} \approx \pi^{32} \approx RAMANUJAN~(\sqrt{pn_t}) \approx a^{a^2/n_t} \approx n_t^{n_t/(a+1/2)} $};
