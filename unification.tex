...
\node [anchor = west,color= red] at (-14.2,-20.3) {$ \frac {ct_1}{0.6l_1} \approx \frac {l_1}{r_{ADN}} \approx \frac {p_{hol}^3}{4\pi} \approx 150^4 \approx p^{8/3}  ~~~~~~~~~ v_T = \frac {2\pi R_T}{Jour} \approx \frac {p_{hol} l_1}{4t_1} ~~~~~~~~~ r_{ADN} \approx 2 nm  $};
...
\node [anchor = west,color= red] at (-23.2,-23.6) {7s+6p+4d+df = $ 7\times 2 + 6\times 6 + 4\times 10 + 2\times 14 = 118 $ (Ogamesson) };
