...
\node [anchor = west,color= red] at (-18,-17.8) {$ \frac {g ~\approx~  c/annee}{g_1} = \frac{gt_1^2 }{l_1} \approx \sqrt {a_{00}}  sin(2 \theta) = \frac{2Z}{W} (S \approx (\beta e^{\pi}\sqrt g_0)^{1/2} \approx \frac{u}{q}) \approx (\frac{\pi 2^{1/12} }{4 \zeta (3))^{1/2} } \approx \frac{\pi(1+\mu+\tau)}{4\tau} )  \approx  \pi^2 ~~~~~~~ $};
