...
La partition de Ramanujan $e^{\pi \sqrt{2d/3}}/4d \sqrt3$ joue un rôle central. De plus, $f(14) = f(10)^2$ implique $g = Z/495^2 \approx \mu^{-\mu/\tau} \approx 1838.5\sqrt2/3570 $ confirmant, à $10^{-8}$ près, le boson de Higgs $495^2$, lié à $\Gamma = \gamma a/\pi$, la constante d'Atiyah, où $a$ est la constante électrique 137.036.}
