...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Euler Ct. and nbs. $e_{n+1}=e^{e_n}$;$e_3\approx(\tau/2)^{420/\mu} $;$e_4^{1/aa'}\approx (9/2)^{a'} \approx P^4 sin^2 \theta $~ ; $a' = a-1 $  & $e$    & 2.718281828459042 & $e_2/e_3^{1/4} \approx e^{-e^{e^{-e}}} \approx g_1$  \\    
