...
%\node [anchor = west,color=blue] at (20.,20.0){$R_{(HUBBLE)}\approx R_T P/a_s (a+1)$};
\node [anchor = west,color=blue] at (20.,20.0){$R_{HUB}\approx R_T \frac{P}{a_s (a+1)}}$};
%\node [anchor = east ,color=red] at (21.3,20.5){$f(26)\approx~ $ NOMBRE PREMIER DE LUCAS $(2^{2^{2^{2^2-1}-1}-1}-1)\times 12$~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
\node [anchor = south] at (16.25,-33.0) {\textbf{24}};
\node [anchor = east ,color=blue] at (20,20.2){~$f(26)/6 \approx 2^{2^7} \approx 2(f(31/2))^6 \approx (f(-5))^{211} \approx R \approx (2R/R_e)^{210}\approx(6/\pi)^a    $~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
