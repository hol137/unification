...
\node [anchor = north] at (-12.9, 34) {$   f(32) = e^{2^{2^{2^{2}}}} \approx (\frac {R_C}{\lambdabar_e})(\frac {\tau}{n_t})^{128/3} ~~~~ (\frac {4\pi^2}{3})(\frac {R_C}{r_H})^3 \approx a^a \approx (2a^2)^{64} \approx \Pi_i^{20} O_{M_i} \approx (\frac {Z}{W})^{35\times 153}$};
