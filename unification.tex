...
\node [anchor = text=black] at (-18.,33.75) {\small{Unité de longueur: longueur d'onde Compton de l'électron $\hbar /m_e c=\lambdabar_e = ct_e$}};
...
\node [anchor = north] at (-33.9, 32.5) {$ e^{e^{e^{e^{e^{-g_2}}}}}$};
