...
\node [anchor = west,color= red] at (-21.5,-22) {7\underline {s}+6\underline {p}+4\underline {d} = $ 7\times 2 + 6\times 6 + 4\times 10 + 2\times 14 = 118 $  };

\node [anchor = west,color= red] at (7,-21.8) {$~;~ \sqrt {a/137}(p_K = \frac {1 + \mu +\tau}{2}) \approx \frac {p_G(N_0^2-1)}{\sqrt {Hp}} \approx  \sqrt {\frac {d_e^2H^{(0)}sin\theta Hp}{6N_0^{\prime}} }   $};
...
\node [anchor = west,color= red] at (-34,-27.5) {$ 2^{\frac {1}{665}} \approx 3^{\frac {1}{1054}} \approx g_0^{\frac {-9}{2H}} \approx g_1^{\frac {-1}{(2^{10})}}  \approx (\frac {a}{137})^4 \approx \approx 4g_1g_Z \approx \frac {\beta^2 (\pi_q=aq^2/4)}{\pi}) \approx\frac {WZ \sqrt a}{a_w} \approx \frac {2a_w}{a_s \pi W^2} \approx (sin\theta)^{\frac {-3571}{a^3}} \approx S^{\frac {p_G}{a^3}}  ~;~tg\theta  \approx \frac {g_2}{g_1} \approx \frac {\sqrt a}{4g_F} \approx \frac {\tau}{9\mu} \approx \frac {\pi \Phi}{e}$ };
