...
Among the Weigel numbers, only the $8^{th}$(165) and the $12^{th}$ (1001) are non-trivial binomial numbers. It is conjectured that these are the only two such cases. Taking account ot the paramount importance of $K_8$, its relation with $K_8$ is looked for. Indeed: 


\section{The Lepton Koide sum and the weak $sin\theta$}
