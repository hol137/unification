...
\section{The Topological Axis, the Weak Bosons and the crystallographic number $K_8 = 165$}
...
The EOIS presents the crystallographic series (A120963), without citing Goursat or Herman, the first discoverers. By contrast, there is a reference to the Weigel team, but without presenting the specific series of positive symmetry numbers 1,5,5,19,19,59,59,165,165,419,419,1001,1001,... (Table 7), the Weigel series (Table 7) shows up the following "Transdimensionnal Theorem": the number of positive operations is the same for dimensions 2n and 2n+1. Moreover, the number of positive operations in dimension $n$ is equal to the number of negative operations in dimension $n+1$. This implies that, for an odd dimension the number of positive and negative operations are equal. Among these numbers, 165 is both the number of positive point operations in dimensions 8 and 9, and also the number of negative point operations in dimensions 9 and 10. 


The partition of the above oriented symmetry series could be called "Weigel numbers $W_d$". The 7 first Weigel numbers 1,5,19,59,165,419 add to 668, and enters four times in the sum of the Herman numbers untill the dimension 12 giving exactly the double of 1836, leading alone the term $W_8 = 1001 = 10^3 + 1$. One observes the following symmetry between the dimensions 10 (Superstring) and 11 (Supergravity):

\begin{equation}
 \left\{
    \begin{array}{ll}
    2\times 1836 = \sum_1^{12} N_d = 4\sum_1^7(W_d) + 10^3  ~~~~;~~~~ 2\times \sum_1^7(W_d) = 11^3 + 5  ~~~~\Rightarrow \\
    \\ 
