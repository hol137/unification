...
\node [anchor = east,color=red] at (25,-2){\LARGE{Température Cosmique} $\approx T{mam} \times ~8\pi^2/ln2$};

\node [anchor = east,color=red] at (25,-10){\LARGE{Température Mammifère} $T{mam} \approx hc/k_B \sqrt{Rl_P}$};
