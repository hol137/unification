...
Counting also the quarksIn the four nucleotides, this leads to a number of particles, to 45 ppm,
...
The connection with the pentapope number $q_{13}$ is immediate:
\begin{equation}
...
A "quantinum" replacing the standard continuum, the Cosmos must approximate $\pi$. Indeed, a formal approximation of $\pi$ appears in the Adimensional Electrical Charge (Table 1), with a confirmation of $g_3$: 
