...
\node [cross,anchor = east,color=red] at (3.25,4.75){NOMBRE PREMIER D'EULER $(2^{2^5-1}-1) \times \pi ~~ $};
\node [cross,anchor = west,color=blue] at (3.15,3.15){$ T_{C} \approx 2.73 ~Kelvin \approx T_{H_2}T_{O_2}/T_{H_2O} \approx T_{mam}/j $};
\node [cross,anchor = west,color=blue] at (2.15,2.0){$ hc/k_BT_{mam} \approx \sqrt{Rl_P} $};
