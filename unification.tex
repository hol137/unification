...
\node [cross,anchor = east,color=red] at (4.25,4.25){GRAND NOMBRE PREMIER D'EULER $(2^{2^5-1}-1) \times \pi ~~ $};
...
\node [anchor = east ,color=red] at (20.,20.0){$f(26)\approx~ $GRAND NOMBRE PREMIER DE LUCAS $(2^{2^{2^{2^2-1}-1}-1}-1)\times 12$~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
