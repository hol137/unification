...
Combined R23W: $v_d = u_{2D = 2(d+3)} = 1 + 2(d+3) + 8 (d+3)^2$ for d = 12 & $v_{12}$    & $ \underline {1831} $ & from 30D to 12D \\ 
 ...
 Fermi mass ratio: $\sqrt {a_w} \approx (6(\lambdabar_{CMB} /\lambdabar_e)^3)^{1/5}\approx (4\pi/3)(lnP)^3\approx (p_t/n_t) (137aa_s)^2/4\pi \tau$ \cite{Sanchez2} & $F$   & 573007.3652  & $F_{mes}$: 573007.362 \\
