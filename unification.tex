...
\node [anchor = east,color=red] at (18,17.250){Synth. triconceptuelle : $\hbar,G, m_{3570}^3 \rightarrow 2l_K \rightarrow masse_{photon} \approx masse_{graviton} \times (a_w \approx \frac {f(26)} {f(24)}$};
