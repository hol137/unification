...
\node [anchor = text=black] at (-10.,34.75) {\small{Les longueurs caractéristiques suivent la loi: $e^{2^{d/4}}$}};
...
\node [anchor = east,color=red] at (23.95,23.750){$f(1/(a-137)) \approx 2O_M/a^{1/3} \Rightarrow a \approx 137.0359999099 (exp value (0.15 ppb)$ };
