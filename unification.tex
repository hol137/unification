...
\node [anchor = west,color= red] at (-27,-28.5) {$ 2^{\frac {1}{665}} \approx 3^{\frac {1}{1054}} \approx (\frac {a}{137})^4 \approx 4g_1g_Z \approx (sin\theta)^{\frac {-3571}{a^3}} \approx S^{\frac {p_G}{a^3}} \approx g_1^{\frac {-1}{2^{10}}} \approx g_0^{\frac {-9}{2H}} \approx (R_C/\lambdabar_e)^{\frac {2\pi^2 + 1}{e^{16}}}  $ };
