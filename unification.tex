...
\node [cross,anchor = west,color=blue] at (4.25,4.25){Longueur d'onde Thermique: $~~\pi \times \hbar c/k_BT_{C}$};
\node [cross,anchor = east,color=red] at (3.25,4.75){NOMBRE PREMIER D'EULER $(2^{2^5-1}-1) \times \pi ~~ $};
\node [cross,anchor = west,color=blue] at (3.15,3.15){$~~~ T_{C} \approx 2.73 ~Kelvin \approx T_{mam}/j\approx T_{H_2}T_{O_2}/T_{H_2O}$};
...
\node [anchor = east,color=black!40!green] at (23.95,24.250){$f(1/(a-137)) \approx 2O_M/a^{1/3} \Rightarrow a \approx 137.0359999099~~$ : exp value (0.15 ppb)~~~~~~~~ };
