...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Extended Maximal Number of Intersection of Diagonals from a 16-gone & $p_{00)$   & \underline {1836}  & \\
...
Rule 23 Wolfram cellular automaton series $ u_d = 1 + d(2d+1)$ for d = 30 & $u_{30}$    & $ \underline {1831} $ & $d$=30 ; $k$ = 7 \\

Combined Rule 23 Wolfram cellular automaton series $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 12 & $u_{8}$    & $ \underline {1831} $ & from 30D to 12D \\
  
  Rule 23 Wolfram cellular automaton series $u_d = 1 + d(2d+1)$ for $d$ = 8 & $u_{8}$    & $ \underline {137} $ & $136 + 1$ \cite{Eddington} \\   
    
  Combined Rule 23 Wolfram cellular automaton series $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 1 & $u_{2\times (1+3)}$    & $ \underline {137} $ & from 12D to 1D \\  
