...
\node [anchor = west,color= red] at (-26,-29.6) {~~~~~~$ \frac {1}{g_1g_2g_3} \approx g_1\frac {2a^2}{\tau} \approx \frac {g_2}{2} \sqrt {\frac {Hç 0}{p}}\approx \frac {H}{\sqrt {H^0}}  $};
...
\node [anchor = east,color=red] at (-3,2) {$\LARGE{\Phi_0^{8} \approx 48 \approx \Phi^7 + 1 $}};
...
\node [anchor = east,color=black!40!green] at (27.95,26.250){$O_M \approx (a^{1/3}/2)f(1/\delta) \approx (d_e/a_s)(\delta+1)^{3570}  \Rightarrow DOUBLE~ a   \approx 137.035999099=$ mesuré (0.15 ppb)~~~~~~~~};
%\node [anchor = west,color=black!40!green] at (27.95,26.250){$\delta = a-137$};
\node [anchor = east,color=black!40!green] at (25.95,24.50){$ f_3(1/\delta) \approx \sqrt a sin \theta (H/p)e^a \Rightarrow a = 137+\delta \approx 137.035999099$: idem (0.03 ppb)~~~~~~~~};
...
\node [anchor = east,color=red] at (-2.25,-16){$\frac {R}{\lambdabar_e} \approx 2^{2^{2^{2^2-1}-1}-1}-1$};
