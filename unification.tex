...
\node [anchor = east,color=red] at (-8,-4.4){$1/g_1g_2g_3 \approx \frac {17\times 137^{3/2}p_W }{4p^2}$  (0.03 ppm)$  \approx 2 + \sqrt 3 $};
...
\node [anchor = east,color=blue] at (35.,14.){  MASSE OVOCYTE $/m_e \approx \Phi^{210/2}$};
