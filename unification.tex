...
\textbf{Pour la valeur centrale $d$ = 16, l’axe donne une valeur très proche de la masse moyenne du bi-codon d’ADN. Avec $G_F$, la constante de Fermi, $G$ et $\hbar$ donnent un temps, le TEMPON qui s’identifie avec le temps de réflexe visuel et correspond au troisième octave inférieur du La bémol.}
