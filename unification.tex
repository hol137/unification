...
\node [anchor = east, text=red] at (34,36.5) {$f(2(\frac {r_H}{\lambdabar_e} = \frac {aH}{p})^{1/2} /d_e) \approx a^{\sqrt a}$ };
...
\node [anchor = east,color=red] at (-20.5,17.550){$\pi^{\pi^{\pi}} \approx \frac {(e^e)^{(e^e)}\approx \frac {P}{30767} }{u_n^2} \approx \frac {P(p-1)^2}{H^{(0)}}  $   };
