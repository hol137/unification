...
\right.
\end{equation}
This shows a double partition of 1836, \textit{this is the arithmetic origin of the DNA bi-codon partition in 4 nucleotides.} The number of nucleons in the Guanine is 329, see below, while $ N_9 + K_9 = 495 = \sqrt{H^{(0)}} $. 
