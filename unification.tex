...
\node [anchor = east,color=red] at (46,16){$ 3^{3^3-1} \approx (2^{2^2-1})^{\sqrt {a_{00}}/2} \approx a^ {(\frac {137}{a})^2\sqrt {a_s}/2} \approx {a_s}^{a^{11}/P} \Rightarrow a^a \approx (\sqrt {a_s} ^  {1/ \sqrt {a_s}})^{\sqrt {pH}} 
...
\node [anchor = west,color=red] at (24,22.5){ $ \frac {R}{\sqrt{\lambdabar_p\lambdabar_H} } = (WZ)^4  $};
