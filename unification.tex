...
\node [anchor = east,color=red] at (12,2){$ 1 + g_1^2 + g_2^2 \approx \frac {ln\tau} {ln\mu} \approx \frac {1} {g_0}  = \frac {2a^3} {pp_G} = \frac {g_2} {g_1g_1} \approx (\frac {\beta e^{\pi}} {S^2} )^2 ~;~ S \approx \sqrt {a_{00}} sin\theta (cos\theta)^2 ~;~0.01 ppm  $};
...
\node [anchor = north,color=red] at (2, 34.75) {$\hbar,G, u  m_{bicodon}, m_{photon}, m_{graviton} \Rightarrow  R_{Cosmos} = R_e^2/2l_P  \approx \lambdabar_e 6^{128}/(1+1/\sqrt 2) \approx l_P (6^{p_G/ \sqrt a} \approx \Phi^{17a^2/ (4\times 137)} \approx 3570^{137/4} $};
