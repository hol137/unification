...
\node [cross,anchor = east,color=red] at (3.15,3.15){$RAMANUJAN(137)\approx a \sqrt{m_em_P}/m_H\approx f(18) (R_e/R)^2$};
...
\node [anchor = east,color=red] at (28.25,26.250){$f(29) \approx$ (NOMBRE DE RAMANUJAN)$^4 e^{4\pi \sqrt{163}}/2p_{hol} $~~~~~~~~ };
...
\node [anchor = east,color=red] at (22.,22.0){$RAM(\sqrt(pn_t))\approx (O_MO_B)^{1/2}\approx P^2/4\pi \approx f(a^{2/3}) \approx f(2p/a)  \approx a^{a^2/n_t} \approx n_t^{n_t/a} \approx e^{32\pi} \approx \Phi^{210} \approx \phi^j $};
