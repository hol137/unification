...
\node [anchor = west,color= red] at (-25,-23) {$ 7\times (2+1) + 6\times (6+1) + 4\times (10+1) + 2\times (14+1) = 107 + 30 = 137 \approx a = a cos^2 \theta + a sin^2 \theta$ };
...
\node [anchor = east,color=red] at (-6,-5.9){$  495 \approx g_1g_2g_3H \approx \frac {H}{n_t} ( a_s^{\frac {1}{g_1}} \approx (3u)^{\frac {1}{g_1g_2}} \approx     e^{\frac {e^e}{2g_3} } )$};
...
\node [anchor = east,color= red] at (-7,-7.9) {$ a^a \approx (2+\sqrt3)^{2^9} \approx (2a^2)^{2^9} \approx \phi^{5\times 153 = 3(2^8-1) }  $};

\node [anchor = west,color= red] at (-8,-7.9) {$ 4a^3/3 \approx (a-136)^{1/2} (1836^2 + a -44 (2\times 153)^{1/5}) \Rightarrow a \approx 137.035999099043  $};



\node [anchor = east,color= red] at (-5.5,-9.9) {~~~~~~$ \Phi^{210} \approx p^{p/a} \approx RAM_{1836} \approx P^2a \frac {\sqrt {Hn_t}}{p} ~~ (2~ ppm) $};

\node [anchor = west,color= red] at (-2.5,-9.9) {$ (\frac {ln(a^{3/2}/3)}{2})^2 - \frac {a(2pp_G)^{1/2}}{Hn_tp_{hol}} \approx a^2 - 137^2 = \pi_a^2  ~~~~\Rightarrow  a \approx 137.03599909944$};
...
%\node [anchor = east,color=red] at (-3,2) {$\Phi_0^{8} \approx 48 \approx \Phi^7 + 1 $};
