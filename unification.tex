...
\node [anchor = west,color= red] at (-28.2,-25.6) {7s+6p+4d+df = $ 7\times 2 + 6\times 6 + 4\times 10 + 2\times 14 = 118 $ (Ogamesson) };
\node [anchor = west,color= red] at (-28.2,-27.6) {7s+6p+4d+df = $ 7\times (2+1) + 6\times 6+1) + 4\times 10+1) + 2\times 14+1) = 107 + 30 = 137 \approx a = a cos^2 \theta + a cos^2 \theta$ };
