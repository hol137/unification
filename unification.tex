...
\node [cross,anchor = west,color=black!40!green] at (3.15,3.15){$ T_{C} \approx 2.73 ~Kelvin \approx T_{H_2}T_{O_2}/T_{H_2O} \approx T_{mam}/j $};
\node [cross,anchor = west,color=black!40!green] at (16.0,1.8){$ hc/k_BT_{mam} \approx \sqrt{Rl_P} $};

\node [cross,anchor = east,color=red] at (3.15,3.15){$RAM_{137}\approx a \sqrt{m_em_P}/m_H ~ (8 ppm)\approx f(18) (R_e/R)^2$};
