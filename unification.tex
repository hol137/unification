...
Combined Rule 23 Wolfram cellular automaton $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 12 & $u_{8}$    & $ \underline {1831} $ & from 30D to 12D \\
  ...
  Combined Rule 23 Wolfram cellular automaton $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 1 & $u_{2\times (1+3)}$    & $ \underline {137} $ & from 12D to 1D \\  
    ...
    Atiyah constant $(2^7 + 2^3 + 2^0)$  & $a_{00}$    & $\underline {137}$ & from three algebra \\
    
    Maximal number of zones defined by 16 straight lines in a plane  & $a_{00}$    & $\underline {137}$ & in Lazy Cutterer series \\
