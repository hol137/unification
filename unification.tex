...
is the side of a cube containing a single CMB photon. The total number of photons in the Hubble sphere $n_{phCMB} \approx (R_e/R)^{1/2}O_M O_B$ and in the Cosmos $N_{phCMB} \approx (R/\lambdabar_e)^{7}  \approx O_M^5$, where O_M and O_B are the orders of the Monster group and te Baby-monster one (Section 6), shows dramatic particularities (190 and 4 ppm):
\begin{equation}
 \left\{
    \begin{array}{ll}
