...
\node [cross,anchor = west,color=red] at (6.15,6.15){$w_5 = \frac {hc/kT_{CMB}}{\lambda_{Wien} \approx l_P\pi^{64} } ~~~~ 4\pi (R_e/\lambda_{Wien})^2 \approx e^a$};
...
\node [anchor = east,color=black] at (18.0,8.25){$f(20) = e^{2^5}  \approx (5/3)^{2^6}/2 ~ \approx \frac {\sqrt{m_Pm_F}}{\pi_a sin\theta} \approx \frac {sin^2 \theta (l_0 = 1 metre)}{r_H}$};
