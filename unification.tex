...
Gravitational proton ratio $P N_L^{-1/2}$ & $p_G$    & $ \underline {1831.531181} $ & ppb  \cite{Sanchez2}  \\
  ...
  Optimised Weak-mixing ratio $W/Z$ & $cos\theta$ & 0.88169557 & 100 \\
  
  Optimised U(1) Gauge coupling $Zsin\theta /H^{(0)}$ &  $g_1$ & 0.3436256 & 100 \\
  
  Adimensional Electric charge $g_1 cos \theta = g_2 sin \theta = (4\pi/a)^{1/2}$  & q & 100 \\
  
  Optimised SU(2) Gauge coupling $W/H^{(0)}$  &  $g_2$  & $\underline {0.6421390}$ & 100 \\ 
 
  Gravitational Coupling $p_tp_G/2a^3$ & $ g_0$  & $\underline { 0.6534149985}$ & 1 \\
  
  Optimised SU(3) Gauge coupling $g_0g_2/g_1$  &  $g_3 $ & 1.2210476 & 100 \\ 
...
% Critical density $3 c^2/ 8\pi R^2$ & $\rho_{cr}$  & $kg m^{-3}$  & $ 9.41197996 \times 10^{-27} $ & 0.3 ~ppb  \\
  ...
  %Official CMB temperature & $T_{CMBoff}$ & K & $2.7255(6)$ & $2 \times 10^5$ \\    
   ...
   Critical Matter versus radiation ratio $\rho c^2/u_{CMB+CNB} $& $K_E$ & - &  \underline {12045.685} & $ p_t H /8\beta \pi^2q \sqrt a \approx p_t^3/(4\pi)^2 \sqrt \pi p_W$(ppm)  \\
   
   Square root of critical entropy $\sqrt {2Mn_{ph}/m_H}$ & $K_n$ &- & \underline {12087.731}  & Eq(7) \\
