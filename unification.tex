...
\node [anchor = west,color= red] at (7,-21.5) {$~;~ \sqrt {a/137}(p_K = \frac {1 + \mu +\tau}{2}) \approx \frac {p_G(N_0^2-1)}{\sqrt {Hp}} \approx  \sqrt {d_e^2\frac {H^{(0)}sin\theta Hp}{6N_0^{\prime}} }~10 ppb   $};
