...
\node [anchor = east,color=red] at (28.25,28.250){$f(30) \approx NOMBRE D'EDDINGTON \times \pi/12 \approx$ Super Période (Cosmon) $\hbar^3/G^2m^5 \approx \hbar^4/G_F^{5/2}\rho_C^{3/2}$ };
