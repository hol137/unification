...
It is said that the present epoch is marked by the domination of matter on radiation. It is true for the energy, and considered as a key parameters, but the reverse for the number of particles. The Table 2 presents two adimensional nearby (0.3 \%) quantities $K_n$ and $K_E$ which, in the standard cosmology, are believed to follow different temporal evolutions. This is a strong argument in favor of a mixture of the steady-state model and the Bang one, since both the Cosmic Microwave Background and the Cosmic Neutrino background are invoked. Such a model has been proposed: the Permanent Holographic Oscillatory Bang (PHOB), where the matter is considered as a very rapid matter-antimatter oscillation, and dark matter a $\pi$-dephased oscillation \cite{Sanchez2}.
