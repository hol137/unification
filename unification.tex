...
Combined R23W: $v_d = u_{2D = 2(d+3)} = 1 + 2(d+3) + 8 (d+3)^2$ for d = 12 & $v_{12}$    & $ \underline {1831} $ & 30D to 12D \\   
 R23W for $d$ = 8:  Eddington's formula\cite{Eddington}: $u_{8}= 136 + 1$ & $u_{8}$   & $ \underline {137} $ & $v_{8}= 495 + 496$ \\      
  ...
  $u_{2d} = 1 + 2d(4d+1)$ Bisection of odd central polygonal numbers for \underline {d = 4}  & $a_{00} $    & \underline {137}  & OEIS (A188135) \\
    ...
    Optimized scalar boson/Electron mass ratio~~;~~ $495 \approx (137/a)^4\Delta_{Ed}/g_0g_1g_3$  & $H^{(0)}$ & $ 495^2 = 245025$  & $H^{(0)}_{mes}$: 245000(250)  \\    
   ...
   Optimized U(1) coupling $Zsin\theta /H^{(0)} \approx (\gamma/y)(n_t/1837)\approx p_W \sqrt 2/H f(2)$ &  $g_1$ & 0.3436256 & $f(2) = e^{\sqrt 2}$\\
  A-dimensional Electric charge $q \approx (6^2/\beta d_e)^{-1/3}$  & $q$ & 0.30297311 & $6 \approx 2^{137/53} $\\
   Optimized SU(2) coupling $W/H^{(0)}\approx g_1(p\beta/p_W)^{1/2} \tau/9\mu \approx (p\beta/n_t)^{1/2}\pi \tau W/Fa^{3/2} $  &  $g_2$  & $0.6421390$ &  $g_2 \approx y/ \Phi^2 \approx \pi g_1/y$  \\ 
 Gravitational Coupling $p_tp_G/2a^3$ & $ g_0$  & $ 0.6534149985$ & 1 ppb, this work \\
  Optimized SU(3) coupling $g_0g_2/g_1 \approx g_2\tau p^2 p_{Ed}/H^4 \approx \Phi a^7 / 137^4p_{Ed}^2  \approx H^{(0)} a_s(ap_t/Z)^2/n_t$  &  $g_3 $ & 1.2210476 & 0.1 ppm, this work\\ 
 ...
 Optimized Muon/Electron mass ratio $\mu \approx (n_t/p_W)^{1/2}Fa^{3/2}/9\pi W & $\mu$ & 206.7682869  & $\mu_{mes}$: 206.7682830 \\     
    ...
    $S_d=\Sigma_1^d (N_d/2)$   & 1 & 4 & 9 & 21 & 40 & 79 & \underline{138} & 250 & \underline{415} & 707 & 1126 & \underline{1836} & 2837 \\
     ...
     $Q_d=q_d + d$    & 5 & 10 & 21 & 42 & 78 & \underline{135} & 220 & 341 & 507 & 728 & 1015 & 1380 & \underline{1836}\\
      ...
      13 final idoneals  & \underline {312} & 330 & 345 & 357 & 385 & 408 & 462 & 520 & 760 & 840 & \underline{1320}  & \underline{1365} &\underline{1848}\\
       $ph_{d}$ (A308970)  & 5 & 11 & 23 & 59 & \underline{137} & 7 & 3 & \underline{761}  & 7129 & 11 & 97  & 13 & 29\\
       
       $ph_{d+13}$ (A308970)  & 1049 & 29 & 17 & 37 & 19 & 37 & 7 & $ph_{21}$ & 3 & \underline{761} & 5  & 109 & $ph_{26}$\\
       
      $p_{2^d + 1}$ (A05149)  & 1 & 3 & 11 & 5 & \underline{137} & \underline{313} & 727 & 1621 & \underline{$3673$} & 8167 &17881  & 38891 &84047\\ 
