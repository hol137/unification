...
%It was emphatised that the charged Leptons masse ratios $ \mu $ and $\tau $ are closed to $(2 \times 3 \times 5 \times 7) = 210 = \mu_0$ and (2+3+5+7)(2 \times 3 \times 5 \times 7) = 3570 = \tau_0$. 
...
\begin{equation}
 \left\{
    ...
    \\
    ~~~~~~~~ \mu_0^7 \approx (tau_0/2)^5 ~~~~ \rightarrow ~~~~ (\mu p_t/n_t)^7 \approx (\tau n_t/2p_t)^7 ~~~~\rightarrow~~~~ n_t/p_t \approx (61/60)^{2/12}
    \\
