...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Golden ratio $\Phi = (1+\sqrt 5)/2$ and Black Body Photon Constant $\phi = \lambda/l_{ph} = (16\pi \zeta(3))^{1/3}$ & $\Phi\approx \phi g_2^2$  & 1.61803398874990 & $\zeta(3) \approx 1.20205691$ \\ 
