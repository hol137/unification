...
\node [anchor = west,color= red] at (-20,-23.3) {$ 7\times (\underline {2}+1) + 6\times (\underline {p}+1) + 4\times (\underline {d}+1) + 2\times (\underline {f}+1) = 107 + 30 = 137 \approx a = a cos^2 \theta + a sin^2 \theta$ };
