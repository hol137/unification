...
\node [anchor = east,color=red] at (22.,22.0){$RAM((pn_t)^{1/2})\approx P^2/4\pi \approx f(a^{2/3}) \approx f(2p/a)  \approx a^{a^2/n_t} \approx n_t^{n_t/a)} \approx (O_MO_B)^{1/2}  \approx e^{32\pi}  \approx |Phi^210 $};
