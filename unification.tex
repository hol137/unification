...
Combined R23W: ${\color{black}u'_d} = u_{2D = 2(d+3)} = 1 + 2(d+3) + 8 (d+3)^2$ for d = 12 & ${\color{black}u'_{12}}$    & $ \underline {1831} $ & 30D to 12D \\   
 R23W for $d$ = 8:  Eddington's formula\cite{Eddington}: $u_{8}= 136 + 1$ & $u_{8}$   & $ \underline {137} $ & $v_{8}= 495 + 496$ \\      
  ...
  $u_{2d} = 1 + 2d(4d+1)$ Bisection of odd central polygonal numbers for \underline {d = 4}  & $a_{00} $    & \underline {137}  & OEIS (A188135) \\
    ...
    Electric coupling constant $a = \alpha^{-1} = c/v_1(1+1/p_t)$~;~$ln\pi \approx \pi_q -2 \approx p\beta^4/a^{3/2}\approx 1+320/(33\times67)$  & $a$    & $\underline {137.035999084(21)}$ & 0.15 ppb ;~aq^2= 4\pi_q\\
...
A-dim. El. charge $q \approx e^{-16a/p} \approx (3/10)\sqrt(6F)/p_{00} \approx (6^2/\beta d_e)^{-1/3}\approx (6\mu/137g_0\Gamma)^2$  & $q$ & 0.30297311 & $6 \approx 2^{137/53}$ (indian music) \\
