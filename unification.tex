...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Euler-Napier constant and opt. numbers, $e_2 = e^e~;~ e_3 = e^{e^e}~;~ e_4 = e^{e^{e^e}} ~~; a' = a-1 $  & $e$    & 2.718281828459042 &  $e_4^{1/aa'}\approx (9/2)^{a'} \approx P^4 sin^2 \theta $\\    
...
A-dimens. El. charge $q \approx 3/\pi^2 \approx (3/10)\sqrt(6F)/p_{00} \approx (6^2/\beta d_e)^{-1/3}\approx (6\mu/137g_0\Gamma)^2$  & $q$ & 0.30297311 & $6 \approx 2^{137/53}$ (indian music) \\
 ...
 Gravitational Coupling $p_tp_G/2a^3 \approx g_1\tau p^2 p_{Ed}/H^4$ & $ g_0$  & $ 0.6534149985$ & 1 ppb, this work \\
  ...
  DNA Adenine-Thymine couple main isotopic mass/$m_H$: $o_1$  &  $o_1 \approx\mu g_0/g_1g_2 \approx o_2 \mu/\Pi_0 g_2g_3\approx o_24g_2g_3/\pi $   & 612.312280 & \cite{Huang} \\
 DNA Guanine-Cytosine couple main isotopic mass/$m_H$: $o_2 \ p_t/3g_1 \sqrt a_s \approx \Pi_0 g_0g_3/g_1 $  &  $o_2$   & 613.299802 & \cite{Huang} \\ 
...
\label{CosmosTable}
 ...
 $  \lambdabar_P ~ (210^{210}/\sqrt(8e))^{1/4}$  & 9.07585 &  \underline{ Confirms the Holic Number $210^{210}\approx \tau^{2\mu/3}\approx e^{e2\mu}\approx \tau_0 ^{d_e^4 r_H/\lambdabar_e}$}  \\
