...
\node [anchor = west,color=black!40!green] at (12.25,12.250){$NEURON_{52.25 Hz} (G_F^{5/4}/\hbar^2 G^{3/2})/3t_e$};
...
\node [anchor = east,color=red] at (28.25,27.750){$(6/5)^{2^{10}} \approx 2^{256}pn_t\beta^4/18^2~ (0.1 ppm) \approx (Ct_0/\lambdabar_e) a_w/WZ \approx (H/24) N_{Ed} \approx f(2e^e)/a_s^2 \approx (H/2\pi) (f(30) \approx (t_{sp}/t_e)~~$ };
