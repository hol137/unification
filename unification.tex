...
\textit{It is foreseen that future computers will use this base 3. Recalling that the conscious music is a multibase computation using only the three bases 2;3;5, it is foreseen that inconscious music or dream could use also the base 7. A symmetrix use of theese 4 bases explain the role of the global base 210, so justifies the muon mass.} 
