...
Combined R23W: $v_d = u_{2D = 2(d+3)} = 1 + 2(d+3) + 8 (d+3)^2$ for d = 12 & $v_{12}$    & $ \underline {1831} $ & from 30D to 12D \\ 
 ...
 R23W for $d$ = 8:  Eddington's formula\cite{Eddington}: $u_{8}= 136 + 1$ & $u_{8}$   & $ \underline {137} $ & $v_{8}= 495 + 496$ \\   
  ...
  Optimised SU(2) Gauge coupling $W/H^{(0)}$  &  $g_2$  & $0.6421390$ &  0.1 ppm; $g_2\approx \sqrt{\pi g_1}/\Phi$  \\ 
 ...
 Fermi mass ratio: $\sqrt {a_w} \approx (4\pi/3)(lnP)^3\approx (p_t/n_t) (137aa_s)^2/4\pi \tau$ \cite{Sanchez2} & $F$   & 573007.3652  & $F_{mes}$: 573007.362 \\
