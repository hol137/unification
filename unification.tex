...
%$ \approx l_P \sqrt{O_M}$ \approx \sqrt{\lambdabar_p l_0}$ (mètre)};
...
\node [cross,anchor = west,color=red] at (6.15,6.15){$w_5 = 5(1-e^{-w_5}) = \frac {hc/kT_{CMB}}{\lambda_{Wien} \approx l_P\pi^{64} } ~~~~ 4\pi (R_e/\lambda_{Wien})^2 \approx e^a$};
