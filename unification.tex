...
{\color{red} The unified Pythagoras Number Natural Philosophy is replaced now by a science showing separated disciplines lacking connexion with the Number Theory. The two pillars of Physics does not agree on the real status of space-time, and the standard physics contains about 30 "free parameters". In the frame of the Permanent Sweeping Holographic Oscillatory Bang model (PSHOB), this article uses the Lucas Large Number to connect gravitation and the gauge couplings. Through the Holic Principle, the mass concept induces a symmetry between the Newton and Planck constants. Using a cellular automaton series, the main dimension 30 of the Topological Axis reduces to unity, through 12D and 4D compatifications. This 1D Holography means a Sweeped Absolute Space, tied to the microwave background, justifying at last the local time relativity for a moving object. The Euler maximal ideonal number plays a central role, in connection with the generalized Riemann conjecture. The supergravity dimension 11 is identified with the first prime of the base 3 Mirimanoff couple, in connection with the arithmetical monster 137, while the second prime of the base 2 Wieferich couple defines the fine-structure constant within its indetermination. This confirms the Atiyah approach and the Eddington's Fundamental Theory, in particular the outstanding non-standard symmetry proton-tau. The Wieferich couple strongly suggest an eta-tau symmetry, tied to basic economic numbers. These overlooked symmetries explain the failure of the present Supersymmetry. The Economic Computation Principle and the Holic Principle justify at last the origin of the main particle masses. This implies physical, chemical, biologic and crystallographic parameters reaching 0.1 ppm precision. This excludes the concepts of Multiverse, Continuum, Infinity, Locality and Zero-mass Particle, and leads to stringent predictions. } 
