...
A-dimens. El. charge $q \approx 3/\pi^2 \approx (3/10)\sqrt(6F)/p_{00} \approx (6^2/\beta d_e)^{-1/3}\approx (6\mu/137g_0\Gamma)^2$  & $q$ & 0.30297311 & $6 \approx 2^{137/53}$ (indian music) \\
 ...
 Gravitational Coupling $p_tp_G/2a^3 \approx g_1\tau p^2 p_{Ed}/H^4$ & $ g_0$  & $ 0.6534149985$ & 1 ppb, this work \\
  ...
  Opt. charged Pion/Electron mass ratio $\Pi_+\Pi_0 \approx 417 \times 419 g_2^2n_t/p_W~~;~~419/417 \approx F^5/Pa^3 $  & $\Pi_+$ & 273.1328373  & $\Pi_{+mes}$: 273.13288(47)  \\
  
  
  
  Opt. neutral Pion/Electron mass ratio $\Pi_0 \approx 3g_2r_H/\lambdabar_e$ & $\Pi_0$ & 264.143971  & $\Pi_{0mes}$: 264.14341(97)\\ 
