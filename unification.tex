...
\node [anchor = west,color=red] at (-5.25,10.250){$(ct_N/\lambdabar_e)^2 \approx R_e/2\lambdabar_e \approx D_{Eg}/l_P ~;~D_{Eg} \approx \sqrt {2R_T l_1} = 3570~ l_1  \Rightarrow  l_1 = 1 metre   $};

\node [anchor = east,color=red] at (-10.25,9.75){$\sum_{2}^{R_1/\lambdabar_e} \frac {1/n} {1/n^2} = r_H/\lambdabar_e = aH/p \Rightarrow \frac {RR_e} {R_1^2} \approx \frac {419-16} {417-16} \approx 2^{\frac {3} {2\times 209} } $};
