...
\node [anchor = east,color=blue] at (-16,-0.2) {$(\frac {137}{4\pi/3})^{1/3} \approx \pi \sqrt \delta \beta^4 \approx \frac {a}{p^{1/2} \beta {1/4}}\approx \frac {\sqrt 6 (6\pi_a^5)^2}{d_e a^3}$};
