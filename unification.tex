...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Neutron/Electron mass ratio ~ $n_t \approx (\pi^2{\color{black}W_5}/4)^3 \approx  p_t + 1 +1/g_0 \approx p_t (61/60)^{1/12} $  & $n_t$ & 1838.6836617  & 0.5 ppb \\     
...
\label{tab:3:table3}
 ...
 Fermi constant $(G_F \rho{cr})^{1/2}/m_{ph}c \approx p_G^{1/2} /sin\theta \approx (a/\pi)^2/6$  & $G_F$ & $J ~m^3$   & $61.435851 \times 10^{-62}$  &  500~ppb\\
