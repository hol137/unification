...
\section{The Topological Axis, the Weak Bosons and the $8^{th}$ Weigel number $K_8 = K_9 = K^-_{9} = K^-_{10} = 165$}
...
The number 165 is very singular because it is a non-trivial binomial number, equal to $\sqrt {H^{(0)}}/3$, where $\sqrt {H^{(0)}} = 495$, another non-trivial binomial number, and the square root of the Higgs/Electron mass ratio. It is suggested to call "coperfect" the antecedent of a perfect number. 
...
\begin{equation}
 \left\{
    ...
    \\
    2\times 3 \times 5\times 7 = 210 \approx 2  K_{12} g_0 g_2      ~~~~~~\Rightarrow~~~~~~  g_0 g_2 =  g_1 g_3 \approx 60/11\times 13 \\
    \\
