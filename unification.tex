...
\title{Erratum to Towards Science Unification Through Number Theory}
...
Considering the ultimate dimension $d = 30$ of the Topological Axis and the optimal base 3, the following direct observations tying the weak bosons to the base 3 were omitted:
...
The EOIS presents the crystallographic series (A120963), without citing Hermann, the first discoverer. By contrast, there is a reference to the Weigel team (Pham Veyssere and Veyseyyre), but without presenting the specific series of positive symmetry numbers $W_n$ for spaces of \textit {even} number of dimensions $n = 2d$: 5,19,59,165,419,1001,... (Table 7). The Weigel-Phan-Veysseyre series shows up the following "Transdimensionnal Theorem": the number of positive operations is the same for dimensions 2n and 2n+1. Moreover, the number of positive operations in dimension $n$ is equal to the number of negative operations in dimension $n+1$. This implies that, for an odd dimension the number of positive and negative operations are equal. Thus, the WPV series may be considered as the generator of the Hermann series: 

\begin{equation}
  W_{n-1}+ W_n = N_{2n}   ~~~~~;~~~~ 2W_n = N_{2n+1}
\end{equation}
 
So, among these WPV numbers $W_n$, 165 is both the number of positive point operations in dimensions 8 and 9, and also the number of negative point operations in dimensions 9 and 10. \textit {So the common 4-space is associated to the spaces of dimensions 8, 9 and 10. This is obviously tied to the superstring compactification from dimension 10}.

The 5 first WPV numbers 5,19,59,165,419 add to 667, which enters four times in the sum of the Herman numbers untill the dimension 12 giving exactly the double of 1836, leading alone the term $W_6 = 1001 = 10^3 + 1$. One observes the following symmetry between the dimensions 10 (Superstring) and 11 (Supergravity):
