...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Wien parameter ${\color{green}W_5} = hc/k_BT \lambda_{Wien} = 5(1-e^{-W_5}) \approx ln2-4lng_1$ &  $W_5$  & 4.96514245  & {\color{green}$W_3\approx~2.821439372$} \\
