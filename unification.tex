...
\node [anchor = east,color=black] at (12.25,12.250){BOSON DE GRANDE UNIFICATION $X_{GUT}$};
...
\node [anchor = east,color=red] at (-5.25,11.250){$\frac {F^5} {Pa^3} = \frac {419} {417} \approx \frac {e^{1/q}} {3^3}  / \approx (g_1g_2g_3)^{-1/{2a}}\approx  (1+\sqrt3)^{1/210} $};

%\node [anchor = east,color=red] at (-5.25,10.250){$F^5/Pa^3 = 419/417 \approx e^{1/q}/3^3 \approx (g_1g_2g_3)^{-1/{2a}}\approx  (1+\sqrt3)^{1/210} $};
