...
\section{The Topological Axis, the Weak Bosons and the Weigel number $K_4 = 165$}
...
The EOIS presents the crystallographic series (A120963), without citing Hermann, the first discoverer. By contrast, there is a reference to the Weigel team, but without presenting the specific series of positive symmetry numbers for spaces of seven number of dimensions $n = 2d$: 5,19,59,165,419,1001,... (Table 7). The Weigel series shows up the following "Transdimensionnal Theorem": the number of positive operations is the same for dimensions 2n and 2n+1. Moreover, the number of positive operations in dimension $n$ is equal to the number of negative operations in dimension $n+1$. This implies that, for an odd dimension the number of positive and negative operations are equal. Among these numbers, 165 is both the number of positive point operations in dimensions 8 and 9, and also the number of negative point operations in dimensions 9 and 10. So the common 4-space is associated to the spaces of dimensions 8, 9 and 10. \textit{This is obviously tied to the superstring compactification from dimension 10}.
...
\begin{equation}
 \left\{
    \begin{array}{ll}
    2\times 1836 = \sum_1^{12} N_d = 4\sum_1^5(W_n) + 10^3 + 4 ~~~~;~~~~ 2\times \sum_1^5(W_d) = 11^3 + 3  ~~~~\Rightarrow \\
    \\ 
