...
\node [anchor = west,color= red] at (-34,-27.5) {$ 2^{\frac {1}{665}} \approx 3^{\frac {1}{1054}} \approx g_0^{\frac {-9}{2H}} \approx g_1^{\frac {-1}{(2^{10})}}  \approx (\frac {a}{137})^4 \approx \approx 4g_1g_Z \approx \frac {\beta^2 \pi_q}{\pi}) \approx\frac {WZ \sqrt a}{a_w} \approx \frac {2a_w}{a_s \pi W^2} \approx (sin\theta)^{\frac {-3571}{a^3}} \approx S^{\frac {p_G}{a^3}}  ~;~tg\theta  \approx \frac {g_2}{g_1} \approx \frac {\sqrt a}{4g_F} \approx \frac {\tau}{9\mu} \approx \frac {\pi \Phi}{e}$ };
