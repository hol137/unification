...
\node [anchor = east,color=red] at (37,27.5){ $ N_{Edd} = 136 \times 2^{256} \approx (3/10) M/m_{neutron} $ ~~(0.05 \%)~;~ $12/\pi \approx \frac {pN_{Edd}}{Hf(30) } \approx \sqrt{\frac {a}{3\pi}} \approx 2\pi \sqrt{\frac {d_e}{e}} \approx Scos\theta \approx \frac {\sqrt{2\times 136}}{\beta S} \approx \frac {pN_{\beta^2}}{8\sqrt 2} \sqrt {9\mu} \approx \frac {\tau g_1}{g_2}    $ };
...
\node [anchor = east,color=red] at (9.5,25){Synthèse triconceptuelle : $\hbar,G, m_e, m_p, m_H \rightarrow R/2~~;~~ \hbar,G, m_N^3 \rightarrow R_e/2  $};
...
\node [anchor = east,color=red] at (36,25.5){$\frac{1836}{12} = 153 = 1^3 + 3^3 + 5^3 \approx \frac{P^2 \beta}{pf(26)} $~ (0.1 ppm)};
...
\node [anchor = west,color=red] at (-5.25,10.250){$(ct_N/\lambdabar_e)^2 \approx R_e/2\lambdabar_e \approx D_/l_P ~;~D_{Eg} \approx \sqrt {2R_T l_1} = 3570~ l_1  \Rightarrow  l_1 = 1 metre   $};

\node [anchor = east,color=red] at (-10.25,9.75){$\sum_{2}^{R_1/\lambdabar_e} \frac {1/n} {1/n^2} \Rightarrow \frac {RR_e} {R_1^2} \approx \frac {419-16} {417-16} \approx 2^{\frac {3} {2\times 209} } $};
