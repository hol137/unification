...
\node [anchor = east,color=red] at (22.,22.5){$RAM_{\sqrt(pn_t)}\approx (O_MO_B)^{1/2}\approx P^2/4\pi \approx f(a^{2/3}) \approx f(2p/a)  \approx a^{2a^2/n_t} \approx n_t^{n_t/a} \approx e^{32\pi} \approx \Phi^{210} \approx \phi^j $};
