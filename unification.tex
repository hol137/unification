...
\node [anchor = north] at (-15.5, 34.2) {$ e^{e^{e^{e^{e^{-W/H^0}}}}} ~~~~~ 2e ~~~~~  f(32) = e^{2^{2^{2^{2}}}} \approx (R_C/\lambdabar_e)(\tau/n_t)^{128/3} ~~~~~~~~~~~~~~~~ (4\pi^2/3)(R_C/r_H)^3 \approx a^a \approx \Pi O_i$;
%\node [anchor = north] at (-24.55, 31.4) {$2e ~~~~ };_1^{20}
