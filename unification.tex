...
\node [anchor = west,color=black!40!green] at (0.,0.0) {\LARGE{BI-CODON d'ADN}};
\node [anchor = east,color=black!40!green] at (0.,0.0) {\LARGE{$m_e~f(16) / \Phi_0^2 \approx H m_H $ masse du}};
...
\node [cross,anchor = west,color=color=black!40!green] at (1.15,8.15){$ hc/k_BT_{mam} \ approx \sqrt{Rl_P} $};
...
\node [anchor = east,color=blue] at (23.95,24.250){$f(1/(a-137)) \approx 2~O_M/a^{1/3} \Rightarrow a \approx 137.0359999099~~$ : mesure (0.15 ppb)~~~~~~~~~~~~};
