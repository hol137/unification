...
Using the main isotopic masses: $~^{1}_{1}H^{(0)} = H \approx 1.0078250324,~ ^{6}_{12}C = C^{(0)} = 12,~ ^{7}_{14}N = N^{(0)}\aprox 14.00307400446, ~^{8}_{16}O = O^{(0)}\approx 15.994914620,~^{15}_{31}P= P^{(0)}\approx 30.973761998$  \cite{Huang}, the masses of the 4 DNA nucleotides, by respect to the hydrogen mass $H$ are close to the Fermi mass ratio: $\sqrt {a_w/pH} \approx 311.9846$, very close to 312, the $53^{th}$ idoneal Euler number, while the Guanine nucleon number is 329 = 312 + (2+3+5+7), whose importance will appear in the next Section, in relation with the sum of primes $\sigma_n$: 
