...
R_c = R_e^2/2l_P \approx 2^{128} l_P (Rg_0/ \lambdabar_H)^2 \approx 9.075773 \times 10^{86} m 
 ...
 \textit{The Table \ref{CosmosTable} presents 37 simple formula confirming this Cosmos radius $R_c$.} In particular, there is the dramatic geometrical property, the "adimensional Cosmos-Universe cuboid" (Fig.1): 
