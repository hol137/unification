...
\node [anchor = text=black] at (-23.,34.75) {\small{Les grandeurs, rapportées à l'électron, entourent la loi: $f_b = b^{2^{d/4}}$~ pour~ $b = e~~~ (1 ppm = 10^{-6})$ }};
...
\node [anchor = east,color=red] at (36,25.5){$\frac{1836}{12} = 153 \approx \frac{P^2 \beta}{pf(26)} $~ (0.1 ppm)};
