...
This suports the Holic Principle : the mass ratios operate by their fifth power, which is also tied to the mean life of unstable particles.

Strangely enough, the EOIS presents crystallographic series (A120963), without citing Herman, the first discoverer.There is a refernce to the the Weigel team, but without presenting the specific series generalising the Weigel Theorem 1,5,5,19,19,59 (Table 7), which seems to connect with the string dimensional compactification.
