...
showing that the prime numbers 11 and 13, following the main sequence 2;3;5;7 play a role in the gauge couplings. The last relation exhibits the double partition of 16 in prime numbers : 16 = 3 + 13 = 5 + 11. Its importance had been preducted ibn the original paper "Holic Principle".


\section{The Lepton Koide sum and the weak term $sin\theta$}
It is observed that the musical interval $2^{1/12}$ shows up in both the Lepton Koide sum and the weak $sin\theta$, and that $2sin theta$ enters the following ppb relation
