...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Wyler Ct. \cite{Wyler} $ p_W = 6\pi^5 \approx (ap_t/137)^2/H \approx \sqrt p_t (s_{65}\sqrt {p_{00}}/p_{Ed})^3 /H\approx (Hp_{00}^7)^{1/2}/p_t^3$ & $p_W$   & \underline {1836.118109}  & \cite{Wyler} $P \approx a_w \sqrt a n_t^3 (p_W/p_t)^5$ \\ 
