...
\node [anchor = west,color=blue] at (-12.,-12.) {Rayon de l'atome d'Hydrogène $\times ~ 2\pi/3$ };
...
\node [anchor = east,color=black!40!green] at (0.,0.0) {\LARGE{$m_e~f(16) / \Phi_0^2 \approx H m_H $ }};
