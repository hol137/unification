...
\node [anchor = west,color=black!40!green] at (0.,0.0) {\LARGE{BI-CODON de DNA}};
...
\node [cross,anchor = east,color=red] at (6.25,4.75){NOMBRE PREMIER D'EULER $(2^{2^5-1}-1) \times \pi ~~ $};
...
\node [anchor = east ,color=red] at (13.2,16.0){$f(24)= e^{64} = (f(12))^8\approx~ $ NOMBRE DU MONSTRE $/H^8$~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~};
