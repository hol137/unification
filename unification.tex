...
\node [anchor = east,color=red] at (20,22.5){ $ u = R_e/R = Hp/a^3 \approx e^{2/e^2}  $ ~~(1.6 ppm) ~~ $ p \approx p_W = 6\pi^5 \approx \frac {a^2d_e}{1836} (2-ln2)^2 \sqrt {\frac {p}{p_G} }$ ~~ (30 ppb)};

\node [anchor = west,color=red] at (24,22.5){ $ R = \sqrt{\lambdabar_p\lambdabar_H} (WZ)^4 \approx \frac {\lambdabar_e}{f(\sqrt a)}(\frac {Z}{W})^{5\times 153} $};
