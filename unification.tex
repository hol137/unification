...
R_c = R_e^2/2l_P \approx 2^{128} l_P (Rg_0/ \lambdabar_H)^2 \approx 9.075773 \times 10^{86} m 
 ...
 \textit{The Table \ref{CosmosTable} presents 37 simple formula confirming this Cosmos radius.}
 
There is an unambigous numerical relation between the Cosmos, its holographic reduced sphere of radius $R_e$ and the Universe \cite{Sanchez3} (fig. \ref{cuboid}), separating the mass concept from the cinematik one. The Universe seems characterized by the constant $c$ in the equivalence between the spatial and temporal terms, hence the following 2 factor :
