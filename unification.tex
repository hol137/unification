...
\node [anchor = east,color=red] at (24.25,26.250){$f(29) \approx$ (NOMBRE DE RAMANUJAN)$^4 e^{4\pi \sqrt{163}}/2p_{hol} ~(1 ppm)$~~~~~~~~ };
...
\node [anchor = north] at (-15.55, 33.8) {$e^{e^{e^{e^{e^{-g_2}}}}} ~~~~~ 2e ~~~  f(32) = e^{2^{2^{2^{2}}}} \approx (R_C/\lambdabar_e)(\tau/n_t)^{128/3} ~~~~~~~~~~~~~~~~ (4\pi^2/3)(R_C/r_H)^3 \approx a^a$};
