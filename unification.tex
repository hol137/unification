...
\node [anchor = east,color=red] at (-20,18){$ 3^{3^3-1} \approx (2^{2^2-1})^{\sqrt {a_00}/2} $};

%\approx a^{\frac {\sqrt {a_s} a^2}{2x137^2}}   } \approx {a_s}^{a^{11}/P} ~~\Rigtharrow a^a \approx \sqrt {a_s} ^  {\sqrt {pH/a_s}}   $};


%\node [anchor = east,color=red] at (0,18){$ 3^{3^3-1} \approx (2^{2^2-1})^{sqrt {a_00}/2} \approx a^{\frac {\sqrt {a_s} a^2}{2x137^2}}   } \approx {a_s}^{a^{11}/P} ~~\Rigtharrow a^a \approx \sqrt {a_s} ^  {\sqrt {pH/a_s}}   $};
