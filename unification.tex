...
%\label{tab:4:table4}
  \hskip-0.0cm\begin{tabular}{llllllllllllll}
    \toprule
    \multicolumn{14}{c}{Table \ref{tab:4:table4} : Cr. Ponct. Sym. ops nbs,   Sum of primes, Rule 23 Wolfram series $u_d$ and final Euler ideodal Nbs}                  \\
    \cmidrule(r){1-14}
...
"perfect couple". The combined Rule 23 Wofram Series shows 137 for the dimension unity, which was predicted in a Sweeping Universe, and , for $d = 12$, the number 1831, the closest interger to the Lucas gravity proton-electron mass ratio. Finally, the largest Euler ideonal number is 1848 = 1836 + 12, which shows dramatic connections with the electric constant $a$, the tau-electron mass ratio and the Topological Function. 
\end{table}
