...
\node [anchor = text=blue] at (-11.,35.75) {\LARGE{AXE ANTHROPIQUE} };
...
\node [anchor = west,color=blue] at (0.,0.0) {\LARGE{masse du BI-CODON d'ADN}};
...
\node [anchor = west,color=blue] at (20.,20.0){$R \approx \frac{P}{a_s (a+1)}(R_T \approx ct_1 /\Phi^8) $};
