...
\node [anchor = east,color=red] at (32,7){$ \frac {R_e l_P}{2 \lambdabar_e l_1}  \approx 60 (3570 \approx \Phi^{17}-1)^{1/2} ~~~(9 ppm)$};
...
La condition critique, qui exprime que la vitesse de libération de l’Univers est $c$, peut être interprétée comme une relation holographique d'Archimède (le périmètre d'un cercle de rayon unité est deux fois son aire) faisant intervenir la longueur d’onde $d$ de l’Univers, appelée Topon, qui brise le mur de Planck d’un facteur $10^{60}$, et est inférieure à la longueur d’onde de l’électron du facteur $f(30) \times 153^2$.
