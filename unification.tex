...
\node [anchor = east,color=red] at (12,23){ $ u = R_e/R = Hp/a^3 \approx e^{2/e^2}  $ ~~(1.6 ppm)  };
...
\node [anchor = east,color=red] at (-11.25,10.250){$\sum_{2}^{R_1/\lambdabar_e} \frac {1/n} {1/n^2} \Rightarrow \frac {RR_e} {R_1^2}\approx 2^{\frac {3} {2\times 209} \approx \frac {419-16} {417-16}} $};
