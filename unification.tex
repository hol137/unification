...
\node [anchor = text=black] at (-12,34) {\small{Résume l'AXE ANTHROPOCOSMIQUE (1 ppm = $10^{-6}$) }};
...
\node [anchor = east,color=blue] at (36.5,14.){$m_{ov} \approx m_{Planck} = (\hbar c/G)^{1/2} \approx em_e \Phi^{210/2}$};
...
\node [anchor = east,color=red] at (32,26){\LARGE{Nombre Biblique} $153 = \frac{1836}{12} = 1^3 + 3^3 + 5^3 \approx \frac{P^2 \beta}{pf(26)} $~ (0.1 ppm)};
