...
where $ m_e^{(red)} = m_e m_p/m_H$ is the formal reduced electron mass in the Hydrogen atom.

Such a pertinence of the Eddington Number means that the Number Theory enters in Physics: this is the main goal of the present article to confirm this. According to Russel \textit{"The most surprising in the modern science is its come back to Pythagorism"}\cite{Alcina}. Indeed, every formalist followed Dirac when he interpreted the Cosmic correlation as age-varying, with a gravitation constant $G$ varying with time. \textit{It was forgotten that Poincare clearly specified that Physics is not possible with varying constants \cite{Poincare2}.}

The String Theory uses only partially the Number Theory. Nobody understand why it is the third perfect number 496 which enters the string group SO(32) order. \textit {This article shows the liaison with 495, the square root of the scalar boson/electron mass ratio.} With its continuum space, the string theory compactification process results in an enormous multiplicity of solutions $(10)^{500}$ \cite{Schwarz}. \textit {By replacing the continuum by a Toponic "quantinuum", hhis article reduces to unity the compactification process, using the celular automaton physics } \cite{tHooft}.     
...
This means that the Restricted Relativity was unduly applied to cosmology. Indeed, it is a \textit{local} theory, based on the concept of an inertial referential, which cannot be defined by theory. However it is observationally evident: the Cosmic Microwave Background (CMB). In liaison with the star on-going production of Helium, this thermal bath was predicted by the steady-state model, with the correct temperature (contrary to the erroneous prediction of Gamow) \cite{Hoyle2}. Even more, the precise thermal spectrum was contradictory with the initial standard model, which was obliged to introduce the monstruous inflation step, with as many problems as it resolves \cite{Sternhardt}. Moreover, one of the three conditions of Sakharov \cite{Sakharov} for the elimination of antimatter during the Big Bang is precisely the rupture of thermal equilibrium. \textit {The Cosmic Microwave Background is the refutation of the Big Bang, but it is unduly presented as its confirmation.}

Also, the steady-state model has predicted an exponential galaxy recession. In the standard model, it was a profound surprise to observe an acceleration of the galactic recession. \textit{The prediction of the accelerated galaxy recession from the concurrent model has been simply forgotten.} Such a conandrum comes from the fact that every phenomena which cannot be explained by the standard model is not taken seriously. In particular the non-Doppler power oscillation of several quasars and the sun \cite{Kotov}. This directly proves the existence of tachyonic physics, which is a necessity since the speed $c$ is far too small to connect a so vast Universe. Indeed, the simplest application of the primary method in Physics, the \textit {c-free} dimensional analysis, gives half the Hubble radius \cite {Sanchez2}. \textit{The foundators of the modern cosmology have missed the most elementary calculation}. Even Eddington did not emphatize that his above formula induces a $R$ value independent of $c$. This is due to the catastrophic use of the so-called "natural units" where $c = 1$, assimilating Time to Space. In his basic text founding Restricted Relativity, Poincare \cite{Poincare2} insisted on the fact that the 4D space-time concept must not be systematised.  
...
Note the formal similitude with Eq(2). This is specified in the Table 2, which presents two adimensional nearby (0.3 \%) quantities $K_n$ and $K_E$ which, in the standard cosmology, are believed to follow different temporal evolutions. {\ textitThe ratio $K_E$ shows a double expression specifying the electric charge to ppm precision}. This is a strong argument in favor of a synthesis of the steady-state model and the standard Big Bang one, since both the Cosmic Microwave Background and the Cosmic Neutrino background are invoked. Such a model has been proposed: the Permanent Holographic Oscillatory Bang (PHOB), where the matter is considered as a very rapid matter-antimatter oscillation, and dark matter a $\pi$-dephased oscillation \cite{Sanchez2}.

The general tendancy of the \textit {formalist mainstream} has been to neglect such correlations, invoking either the hazard or a multiplicity of Universes (the much controversed Multiverse hypothesis). However, the above Eddington Large Number Correlations are now extended to a Bott octonion sequence, by the Topological Axis (Graph 3) which rehabilitates the bosonic String Theory \cite{Sanchez2}. The latter was \textit {unduly} discarded because it involves a tachyon. Quite the contrary this is considered an advantage, to interpret the above non-Doppler quasar oscillation.
...
The Section 2 recalls the application of the Holographic Principle to the PHOB cosmology, presenting new connections with particle phyics, in particular the relation between the gauge couplings $g_1$, $g_2$ and $g_3$ of the groups U(1), SU(2) and SU(3) and definitely prove the Hubble radius invariance, by showing 55 simple formula, with 8 in the 0.1 ppm domain. 

The Section 3 applies the Holic Principle, the degenerate diophantian form of the Holographic Principle. It shows how the mass concept introduces a symmetry between gravitation and quantum physics in the Keplerian Diophantine equation. This connects the Bohr’s orbits with the PHOB model, showing up the mean DNA bi-codon mass which connects to 0.1 ppm with the Topological Axis. The local c-observable base 2 Universe appears as a gauge boson in the base 3 Tachyonic Cosmos with massive photon and graviton. This induces a scalar boson mass tied to the geometric extension of the Weinberg-Sanchez triangle, correlating the three gauge couplings U(1)-SU(2)-SU(3) with the gravity constant $G$.
...
\bibitem{Sanchez3} Sanchez F. M. A Coherent Resonant Cosmology Approach and its Implications in Microphysics and Biophysics, Prog. Theor. Chem. and Phys, Springler, v. 30, p. 384, 375-407 (2017).
...
\bibitem{Sanchez5} Sanchez F.M., Holic Principle, Entelechies, ANPA 16, Sept. 1995. Bowden K.G., 324--343.
