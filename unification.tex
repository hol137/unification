...
It was emphatised that the charged Leptons masse ratios $ \mu $ and $\tau $ are closed to $(2 \times 3 \times 5 \times 7) = 210 = \mu_0$ and (2+3+5+7)(2 \times 3 \times 5 \times 7) = 3570 = \tau_0$. The couples (2;3) and (5;7) were associated by the Holic Principle to the couples (Time-Space) and (Matter-Feld). But it was not recalled that the fractions 3/2 and 7/5 are the first fractions of the convergent series to $\sqrt 2$, and called Pell (or Lambda) numbers, as solutions of the Pell-Fermat equation $Y^2 - 2X^2 = 1 (couple 3;2) or -1 (couple 7;5) $. All the Pell numbers are associated to the entire powers of the generating function $H_1 = 1 + \sqrt 2$, tied to the reduced generating function $h_1 = 1+1/\sqrt 2 \approx g_1^{-1/2}$. One observes:
