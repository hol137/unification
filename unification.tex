...
\node [anchor = text=black] at (-20.,32.75) {\small{Unité de la Super Période $t_{sp}:t_e$. Unité de masse pour Photonde et Gravitonde: $2\pi m_N$}};
...
\node [anchor = west,color=black!40!green] at (12.25,12.250){$NEURON_{52.25 Hz} t_0/3t_e$};
...
\node [anchor = east,color=black] at (29.25,29.250){$f(2e^e) \approx M/m_e = Rc^2/Gm_e = R\lambdabar_e/2l_P^2 = \lambdabar_e/TOPON$ (longueur d'onde de l'Univers) $\approx f(30) \times 153^2$};
...
\node [anchor = south] at (29.25,-31.0) {$2e^e \approx \sqrt(H/2)$};
