...
\node [anchor = west,color= red] at (-5.2,-18.3) {~~~~~~$ \frac {g \approx  1 an/c}{g_0} = gt_0^2/l_0 \approx sin(2 \theta)\sqrt {a_{00}}  \approx 2SZ/W \approx \pi^2 $};
\node [anchor = west,color= red] at (-20.2,-20.3) {~~~~~~$f(2\pi) \approx (\frac {3R}{2\lambdabar_e})^{\frac {1}{30}} \approx \frac {t_K}{t_{ST} \approx 495 s}  $};
