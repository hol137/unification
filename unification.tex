...
\node [anchor = east,color=red] at (21,-1.6){$p_{hol}^2 = \frac {4} {3}(\frac {aH} {p} = \frac {r_H} {\lambdabar_e})^3 \approx \frac {\delta F^4} {\beta Z^4} ~;~ \sqrt p \approx \frac {(20/3)^2} {\delta d_e} $};
