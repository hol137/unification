...
\node [anchor = east,color=red] at (16,17.250){$\hbar,G, m_{bc}^3 \rightarrow 2l_K \rightarrow masse_{photon} \approx masse_{graviton} \times (a_w \approx \frac {f(26)} {f(24)}$};
...
\node [anchor = east,color=red] at (12,25){Synthèse triconceptuelle : $ u = R_e/R = Hp/a^3 \approx e^{2/e^2}  $ ~~(1.6 ppm)  };
...
\node [anchor = north,color=red] at (-14, 34) {$\hbar,G, u  m_{bicodon}, m_{photon}, m_{graviton} \Rightarrow R_{Cosmos} $};
