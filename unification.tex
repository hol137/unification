...
\node [anchor = east,color=black] at (0,-3.0){BOSON DE HIGGS};
...
\node [anchor = north] at (-30,-1.5) {$495^2 = H^{(0)} \approx (\frac {Hp}{F})^7 \approx \frac {WZ\sqrt{2\pi a_s sin\theta}}{F} $};
%\node [anchor = north] at (-33,-1.5) {$495^2 = H^{(0)} \approx (\frac {Hp}{F})^7  $};
