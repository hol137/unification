...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Euler-Mascheroni Ct. $\gamma/\pi = \Gamma/a$ \cite{Atiyah} $\approx ln\Phi / \Phi^2 \approx ln(\xi(3))$ & $\gamma$    & 0.57721566490153 & $\Phi^{\pi/\gamma} \approx e^{\Phi^2}\approx a/10$ \\ 
    Golden ratio and Black Body Photon Constant $\phi = \lambda/l_{ph} = (16\pi \xi(3))^{1/3}$ & $\Phi\approx \phi g_2^2$  & 1.61803398874990 & $\xi(3) \approx 1.20205691$ \\ 
...
Koide Tau/El. mass ratio, with $p_K =(1+\mu+\tau) /2 = (1+\sqrt\mu+\sqrt\tau)^2/3~; ~\tau \approx 120/61g_1^7$ \cite{Koide} & $\tau$ & 3477.441701  &  $\tau_{mes}$: 3477(2) \\ 
...
{\color{black}The 26 sporadic groups include 20 "happy" groups tied to the Monster, and 6 "pariah" groups. Many relations with the physical parameters were published \cite{Sanchez3}, two of them implying formula for $R$ and $R_c$ (Tables 2 and 3). Some precise connections implying the Monster Group order $O_M$ are (4, 1.5, 6 and 14 ppm):
\begin{equation}
 e^a \approx 2O_MZ^2p_t/1839W~~;~~ e^{1/2a} \approx O_M /(2a^2P)^2 \approx \mu^2W/2a^2Z ~~;~~ 2R/R_e \approx O_MZ/P^2FW\sqrt{p_tH}
 \end{equation}
