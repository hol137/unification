...
\node [anchor = east,color=red] at (28.25,27.750){$(6/5)^{2^{10}} \approx 2^{256}pn_t\beta^4/18^2~ (0.1 ppm)  \approx (H/24) N_{Ed} \approx f(2e^e)/a_s^2 \approx (H/2\pi) (f(30) \approx (t_{sp}/t_e)$ };
