...
\node [anchor = text=black] at (-20.,32.75) {\small{Unité de la Super Période $t_{sp}:t_e$. Unité de masse pour la Photonde and Gravitonde: $2\pi m_N$}};
...
\node [anchor = east,color=black] at (12.25,12.250){BOSON UNIFICATEUR $X_{GUT}$};
