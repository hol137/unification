...
\node [anchor = east,color=red] at (15,-8){$\rho_c \approx \frac {m_H} {(l_1 / 10^{1/4})^3} $};
...
\node [anchor = north] at (-27,-1.5) {$495^2 = H^{(0)} \approx (\frac {Hp}{F})^7 \approx \frac {WZ\sqrt{2\pi a_s sin\theta}}{F} $};
