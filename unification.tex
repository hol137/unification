...
\node [anchor = east,color=red] at (-5.25,12.750){$\frac {F^5} {Pa^3} = \frac {419} {417} \approx \frac {e^{1/q}} {3^3} \approx (g_1g_2g_3)^{\frac {-1} {2a}}\approx  (1+\sqrt3)^{\frac {1} {210}} \approx \frac {(3/sin \theta)^6 p_W} {2^{16}d_e^3p} ~ (6 _times 10^{-7})   $};
