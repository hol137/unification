...
%Dimensional numbers\title{Towards Physics-Arithmetics Unification}
...
\author{F. M. Sanchez \thanks{Retired Prof. of Physics, University of Paris 11, Orsay, France, \href{mailto:hol137@yahoo.fr}{hol137@yahoo.fr}} 
   ...
   %\and V. A. Kotov \thanks{Astronomer, Crimean Astrophysical Observatory, Nauchny, Crimea, \href{mailto:vkotov43@mail.ru}%{vkotov43@mail.ru}}
...
%The Holic Principle, based on the simplest Diophantine equations, induces an “Hyper-symmetry” between $G$ and $\hbar$ which leads to Bohr’s orbits. The quasar non-local period, the most precise cosmic measurement ($10^{-6}$), inter-connects the Hubble and the Cosmos radius and their common CMB temperature. This confirms the Permanent Sweeping Holographic Oscillatory Bang model (PSHOB). The mean DNA bi-codon mass is central and connects to $10^{-7}$ with the Topological Axis, which defines a scalar boson mass, connected to the natural geometric extension of the Weinberg triangle, confirming the $G$ value to $10^{-7}$ precision. The multi-dimensional crystallographic symmetries connect the scalar boson with the 9D string dimension reduction. The string dimension series $d = 2 + 4k$ are identified with the Topological Axis dimensions. For the Periodic Table, $k$ is identified with the orbital quantum number, with the association spin 1/2 - string dimension 2. This confirms the triple algebra Atiyah and the Combinatorial Hierarchy formula, leading to the gauge separation. This search towards a Science-Arithmetic Unification excludes the Multiverse, Continuum, Infinity, Locality and Zero mass Particle, leading to stringent predictions.

%% The Holic Principle (HP) is the simplified form of the Holographic Principle (HP*). It is based on the simplest degenerate Diophantine equations. It induces an “hyper-symmetry” between the constants  $G$ and $\hbar$ . This leads to a new expression of Bohr’s orbits. With the very precise quasar non-local period  ($10^{-6}$), this establishes a connection between : the Hubble and Cosmos radius of the Permanent Holographic Oscillatory Bang (PHOB) model and their common CMB temperature. The observable Universe appears as a Cosmos “immergence”, where the mean DNA bi-codon mass is central. It connects to $10^{-7}$ with the mean dimension 16 of the Topological Axis. The latter defines a scalar BE-Higgs boson mass of $495^2 m_e$, connected to the natural geometric extension of the Weinberg triangle, confirming the $G$ value to $10^{-7}$, at  $ + 7.7~ \sigma $ of the official value. We associate computation with symmetry, whose common point is invariance ; Multi-dimensional crystallographic symmetries show the arithmetical origin of the term $495^2$, and establishes tight connections between four elements : the fundamental physical parameters, the string theory dimension reduction, the periodic table and the sporadic groups. The 5 concepts of Continuum, Infinity, Locality, Zero Mass Particle and Multiverse are excluded as «metaphysical». They are replaced by the search towards a Scientific-Arithmetic Unification (SAU). Very stringent predictions result for the observations of the Very Large Telescopes (VLT) in preparation.

%The mass {\color{red}concept} introduces a symmetry between gravitation and quantum physics in the Keplerian Diophantine equation. This connects the Bohr’s orbits with the Permanent Holographic Oscillatory Bang model (PHOB), showing up the mean DNA bi-codon mass which connects to 0.1 ppm with the Topological Axis. The local c-observable base 2 Universe appears as a gauge boson in the base 3 Tachyonic Cosmos with massive photon and graviton. This induces a scalar boson mass tied to the geometric extension of the Weinberg triangle, correlating the three gauge couplings U(1)-SU(2)-SU(3) with the gravity constant $G$. The base 2 Wieferich prime couple shows a non-standard symmetry eta-tau and permits to define the fine-structure constant within its 0.15 ppb indetermination. The base 3 Mirimanoff prime couple connects to 0.1 ppm with the electron-proton-neutron triplet, tied to the  9D-10D-11D crystallographic symmetries, connected with the generalized Riemann hypothesis, through the terminal Euler suitable number. This confirms the Eddington's Fundamental Theory, in particular the non-standard symmetry proton-tau. The running number of the string dimension series of the Topological Axis is identified with the orbital quantum number, associating the spin 1/2 and the string dimension 2. This excludes the concepts of Multiverse, Continuum, Infinity, Locality and Zero mass Particle, and leads to stringent predictions.

{\color{red} Contrary to old tradition, the present science shows separated disciplines. In particular, the Number Theory plays a marginal role in Physics. Even the String Theory has no experimental confirmation. Worse, the two pillars of Physics does not agree on the real status of space-time, and the standard physics contains about 30 "free parameters". In the frame of the Permanent Sweeping Holographic Oscillatory Bang model (PSHOB), this article 
shows the connection between gravitation and the gauge couplings. Through the Holic Principle, the mass concept induces a symmetry between the Newton and Planck constants. The main dimension 30 of the Topological Axis reduces to unity, through 12D and 4D compatifications. This 1D Holography means a Sweeping Absolute Space, justifying at last the local time relativity for a moving object. The Euler maximal ideonal number plays a central role, showing a connection with the generalised Riemann conjecture. The superstring dimension 11 is identified with the first prime of the base 3 Mirimanoff couple, in connection with the arithmetical monster 137, while the second prime of the base 2 Wieferich couple defines the fine-structure constant within its indetermination. This confirms the Atiyah approach and the Eddington's Fundamental Theory, in particular the non-standard symmetry proton-tau. The Wieferich couple suggest an eta-tau symmetry, tied to a basic economic number. These overlooked symmetries, as well as several others described in this article, explain the failure of the present supersymmetry. The Economic Computation Principle and the Holic Principle justify at last the origin of the main particle masses. This implies physical, chemical, biologic and cristallographic parameters untill 0.1 ppm precision. This excludes the concepts of Multiverse, Continuum, Infinity, Locality and Zero-mass Particle, and leads to stringent predictions. } 

\end{abstract}

\keywords{Optimal Correlation Principle \and Economic Computation Principle \and Holographic Principle \and Holic Principle  \and Cosmology \and Supersymmetry \and Number theory  \and String Theory \and Bit-String Physics \and Cellular Automaton \and DNA nucleotides \and Crystallography \and Periodic Table \and Sporadic Groups.}
...
Since the Poincaré-Hilbert opposition, mathematians separated in intuitionnists and formalists. In particular, at a Solvay Congress, Poincaré convinced at last the reticent communauty (including Planck) that there is no means to escape the quantization of the field-matter interaction  \cite{Poincare1}. Poincaré explained also in his "Dernières Pensées" that the cosmology cannot be founded on differential equations, because of the involved "free parameters" in an \textit{unique} Univers \cite{Poincare2}. Las, the mainstream has followed Hilbert and his differential equations, leading nowadays to a blockage of the standard 6 "free parameters" cosmology, with its "mysterious" so-called "dark energy" with the relative density 0.7, by respect to the critical one \cite{Zyla}. 

The situation is even worse in the particle physics, with about 20 "free parameters". The Table 1 presents the main ones, and the Table 2 recalls the main physical constants \cite{Zyla}. For specifying some values, an Optimal Correlation Principle has been applied, interpreting the "free parameters" as computation bases in a Computing Cosmos \cite {Sanchez2}. 

Also, the standard Superssymetry model fails completely, since no confirmation comes from the CERN super-collisionner. This article shows that a number of symmetries have been overlooked, in particular a meson eta-lepton tau symmetry, which could enter a future Corrected Supersymmetry, and also the Eddington's proton-tau symmetry, which could enter a future "Intersymmetry", connecting particles of same spin. It has been forgotten that Eddington predicted the tau fermion, 35 years before its surprising discovery, with a fair estimation of its mass. Starting from an electron-proton symmetry, Eddington deduced a "mesotron-heavy mesotron" one, the old name for the couple muon-tau. This article rehabilitates these symmetries, in liaison with an Economic Computation Principle (ECP), which implies the last ideonal Euler number, connected with the Riemann hypothesis. The ECP favor the form $x^x$ and the numbers exp(exp(... justifying at last the mass ratios, in connection with the Holic Principle, recalled in Section 3. 

The table 1 shows the pertinence of the most famous prime number in Mathematics, the Lucas Number, which enters the last term of the Combinatorial Hierarchy \cite{Bastin} \cite{Noyes}. Indeed, it defines a gravitational proton-mass ratio $p_G$, close to $u_{30}$, from the Bisection of Rule 23 Wolfram series (R23W) for d = 30, the last dimension of the Topological Axis, corresponding to the end k = 4 of the Bott octonion sequence.


. This article shows that $p_G$ enters also a 0.1 ppm correlation with the Higgs-electron mass ratio $ H^{(0)}= 495^2$ \cite{Sanchez2}. This is on the way to resolve the "hierarchy" problem, the huge gap between gravitation and electroweak couplings. 

The Eddington's Fundamental Theory has been disregarded \cite{Eddington}, since, at his epoch, it was strange to interconnect cosmology and microphysics, presenting a so simple Large Number $ N_{Ed} = 136 \times 2^{256}$ as the number of hydrogen atoms in the Universe. Nowadays, nobody recalls that it is precisely the number of \textit{neutron masses} in 30 \% of the Universe critical mass, using the simplest formula involving the Planck mass, and the four basic masses of electron, proton, Hydrogen and neutron, revealing a 4-fold symmetry: 

\begin{equation}\label{Eq2}
M/m_n = m_P^4/m_e m_p m_H m_n \approx (10/3)N_{Ed} 
 \end{equation}

This gives a critical radius $R = 2GM/c^2\approx 13.80$ Giga light-years, at $5 \times 10^{-4} $ from the Hubble radius given by the Eddington-Sanchez's symmetrical double equation \cite {Sanchez2}:

\begin{equation}\label{Eq2}
R/2\lambdabar_H = (M/m_e^{(red)})^{1/2} = \hbar c / G m_e m_p 
 \end{equation}

where $ m_e^{(red)} = m_e m_p/m_H$ is the formal reduced electron mass in the Hydrogen atom. Such a pertinence of the Eddington Number means that the Number Theory enters in Physics: this is the main goal of the present article to confirm this. According to Russel \textit{"The most surprising in the modern science is its come back to Pythagorism"}\cite{Alcina}. Indeed, every formalist followed Dirac when he interpreted the Cosmic Large Number correlation as age-varying, with a gravitation constant $G$ varying with time. \textit{It was forgotten that Poincare clearly specified that Physics is not possible with varying constants \cite{Poincare2}.}

The String Theory uses only partially the Number Theory. In particular nobody understand why 496, the string group SO(32) dimension is the third perfect number. \textit {This article shows the liaison with 495, the square root of the scalar boson/electron mass ratio.} With its continuum space, the string theory compactification process results in an enormous multiplicity of solutions $(10)^{500}$ \cite{Schwarz}. \textit {By replacing the continuum by a "quantinuum", this article eliminates this multiplicity, using the celular automaton process \cite{tHooft}, to comes back to the predicted 1D Sweeping Holography process \cite{Sanchez1}. }     

A cosmology founded on \textit{integral} equations must take into account the well-known Newtonian gravitational potential energy $ E_{pot} -(3/5)GM^2/R$ of an homogeneous ball of mass $M$ and radius $R$. For the critical radius $R = 2GM/c^2$, this is the energy $ E_{pot} = -(3/10)Mc^2$, which is exactly the opposite of the \textit{non-relativist} kinetic energy $E_{kin}$ of the receeding galaxies in the steady-state model, \cite {Sanchez2} which is so characterised by the classical integral equation, explaining directly the density 0.3 of the matter + dark matter : 
% 
...
\textit {The deepest mystery of standard cosmology is the clearest evidence for its opponent simplest model, the non-relativist permanent Newtonian model, proving undue complication in the standard cosmology.} Recall that the Newtonian Cosmology is sufficient to obtain the principal results from General Relativity, as shown by Bondi \cite {Bondi}. In particular the above critical formula $R = 2GM/c^2$ states simply that the liberation speed at the surface is the classical non-relativist speed $(2GM/R)^{1/2}$, identified to $c$. So one may consider that receeding galaxies reach the speed $c$ and exceed it when they disappear at the Hubble horizon.

This means that the Restricted Relativity was unduly applied to cosmology. Indeed, it is a \textit{local} theory, based on the concept of an inertial referential, which cannot be defined by theory. However the Newton Absolute Space is observationally evident: the Cosmic Microwave Background (CMB). In liaison with the star on-going production of Helium, such a thermal bath was predicted by the steady-state model, with the correct temperature (contrary to the erroneous prediction of Gamow) \cite{Hoyle2}. Even more, the precise thermal spectrum was contradictory with the initial standard Big Bang model, which was obliged to introduce the monstruous inflation step, with as many problems as it resolves \cite{Sternhardt}. Moreover, one of the three conditions of Sakharov \cite{Sakharov} for the elimination of antimatter during the Big Bang is precisely the rupture of thermal equilibrium. \textit {The Cosmic Microwave Background is the refutation of the Big Bang, but it is unduly presented as its confirmation.}

Also, the steady-state model has predicted an exponential galaxy recession. In the standard model, it was a profound surprise to observe an acceleration of the galactic recession. \textit{The prediction of the accelerated galaxy recession from the concurrent model has been simply forgotten.} Such a conandrum comes from the fact that every phenomena which cannot be explained by the standard model is not taken seriously. In particular the non-Doppler power oscillation of several quasars and the sun \cite{Kotov}. This directly proves the existence of tachyonic physics, which is a necessity since the speed $c$ is far too small to connect a so vast Universe. Indeed, the simplest application of the primary method in Physics, the \textit {c-free} dimensional analysis, gives half the Hubble radius \cite {Sanchez3}. \textit{The foundators of the modern cosmology have missed the most elementary calculation}. Even Eddington did not emphatize that his above formula induces a $R$ value independent of $c$. This is due to the catastrophic use of the so-called "natural units" where $c = 1$, assimilating Time to Space. In his basic text founding Restricted Relativity, Poincare \cite{Poincare3} insisted on the fact that the 4D space-time concept must not be systematised.  

It is said that the present epoch is marked by the domination of matter on radiation. This is true for the energy, but the reverse holds for the ratio of particles numbers, considered as a standard key parameter, called "Critical Entropy" (the factor 2 being the polarisation factor):

\begin{equation}\label{Eq2}
Mc^2 /(E_{CMB} + E_{CNB}) \approx (2n_{ph}/n_H)^{1/2}~~~~~~~~~~; ~~~ n_{ph} = (4\pi/3)(R/l_{phCMB})^3    ~~;~~ n_ H= M/m_H
 \end{equation}

Note the formal similitude with Eq(2). This is specified in the Table 2, which presents two adimensional nearby (0.3 \%) quantities $K_n$ and $K_E$ which, in the standard cosmology, are believed to follow different temporal evolutions. {\textit The ratio $K_E$ shows a double expression specifying the electric charge to ppm precision}. This is a strong argument in favor of a synthesis of the steady-state model and the standard Big Bang one, since both the Cosmic Microwave Background and the Cosmic Neutrino background are invoked. Such a model has been proposed: the Permanent Sweeping Holographic Oscillatory Bang (PSHOB), where the matter is considered as a very rapid matter-antimatter oscillation, and dark matter a $\pi$-dephased oscillation \cite{Sanchez4}.

The general tendancy of the \textit {formalist mainstream} has been to neglect such correlations, invoking either the hazard or a multiplicity of Universes (the much controversed Multiverse hypothesis \cite{Rees}). However, the above Eddington Large Number Correlations are now extended to a Bott octonion sequence, by the Topological Axis (Graph 3) which rehabilitates the bosonic String Theory \cite{Sanchez2}. The latter was \textit {unduly} discarded because it involves a tachyon. Quite the contrary this is considered an advantage, to interpret the above non-Doppler quasar oscillation.

A great hope of theoretical physics is the Holographic Principle, which is precisely of integral type (not differential). However the standard model cannot use it on the Hubble sphere because its radius is considered as variable. Supposing that it is invariant, we have applied this principle by introducing the Topon, the wavelength of the whole Universe, to demonstrate the critical cosmic character, which, in the standard model introduces an hypothetical inflation. So the latter becomes unnecessary. This could not have been seen before, because this Topon rejects the Planck wall by a factor $10^{60}$. But it is very surprising that \textit {Cosmologists, which consider the Universes as a whole, have not introduced the Universe wavelength (Topon), which explain at last the $10^{120}$ energy ratio quantum vacuum/Universe. \cite{Sanchez2} }

The Section 2 recalls the application of the Holographic Principle to the PSHOB cosmology, presenting new connections with particle phyics, in particular the relation between gravitation and the gauge couplings $g_1$, $g_2$ and $g_3$ of the groups U(1), SU(2) and SU(3). This definitely prove the Hubble radius invariance, confirmed by the Table 4 showing 55 simple formula, with 8 in the 0.1 ppm domain. 

The Section 3 applies the Holic Principle, the degenerate diophantian form of the Holographic Principle. It shows how the mass concept introduces a symmetry between gravitation and quantum physics in the Keplerian Diophantine equation. This connects the Bohr’s orbits with the PSHOB model, showing up the mean DNA bi-codon mass which connects to 0.1 ppm with the Topological Axis. The local c-observable base 2 Universe appears as a gauge boson in the base 3 Tachyonic Cosmos with massive photon and graviton. This induces a scalar boson mass tied to the geometric extension of the Weinberg-Sanchez triangle, correlating the three gauge couplings U(1)-SU(2)-SU(3) with the gravity constant $G$.

The Section 4 is devoted to the properties of the DNA, showing a double 0.1 ppm connection with the Topological Axis and the main "free parameters". 

The Section 5 studies the multi-dimensional cristallography, with emphasis to its relation with the "rule 23" celular automaton Wolfram series. In liaison with the string compactification problem, this leads to a characterisation of the main integer parameters 137 and 1836. The latter is connected with the maximal Euler suitable number, tied to the generalized Riemann hypothesis. The base 2 Wieferich last prime permits to define the fine-structure constant within its 0.15 ppb indetermination. Considering the connection between crystallography and the Periodic Table, the running number of the string dimension series of the Topological Axis is identified with the orbital quantum number, associating the spin 1/2 and the string dimension 2.

The conclusion, Section 6, presents a series of stringent predictions concerning cosmology, particle physics, chemistry and biology.
} 
%
...
corresponding to  $ H_0 \approx 70.790 ~~ km s^{-1} Mpc^{-1}$, compatible with the above last measurement. Moreover, this value connects within $10^{-3}$ with the reduced topological function $g(k) = exp(2^{k+1/2})/k$, for $k = 6 $, see Graphics \ref{AxeTopologique}. {\color{red} This value k = 6  corresponds to the privileged dimension 26 of the string bosonic theory} :  
...
This Topological Axis rehabilitates the Large Number Correlations, whose the \textit{single} official justification is the Anthropic Principle,  which also is used to justify the so-called "biologic fine-tuning" through the Multiverse model \cite {Rees}. But such a rough argument cannot explain the above precision, so \textit{the Topological Axis recover the ancestral idea of an unique Universe.} 


%The aim of this article is to confirm this, in particular the pertinence of the Holic Principle, the diophantine form of the Holographic Principle, supporting an invariant Hubble radius. Also we show that the DNA characteristic mass is a central physical parameter, via $10^{-7}$ fine-tunnig with the mean dimension 16 of the Topologic Axis, which so was indeed \textit{predictive}. 
...
%
%confirming this Cosmos radiuThe Table \ref{tab:6:table6} shows 52 simple formula for $R$. This recalls the 14 molecular formula of Jean Perrin that established definitely the existence of atoms.

The Table \ref{tab:6:table6} shows 55 simple formulas for the Hubble radius $R$. This recalls the 14 molecular formula of Jean Perrin that definitely established the existence of atoms, based on 6 different theories. In this table also, numeric terms from different approaches are used:  \cite{Davies}, \cite{Rees}, \cite{Eddington}, \cite{Bastin} and \cite{Atiyah}. But the most significant is the Holic Theory, recalled below, characterized by "primeval 7", the number $210 = 2 \times 3\times 5\times7$. The appearance of $210^{210}$ and $\mu^{\mu}$ resolves at last a complete mystery in the standard model: the \textit{arithmetic} origin of the muon/electron mass ratio. Note that the approximation $\mu \approx 210$ is central in the Bit-String Physics \cite{Noyes}, and will be confirmed below. \textit {A naturel complement of the above Optimal Correlation Principle (OCP) is the Economic Computation Principle (ECP) favoring the $x^x$ form}. In particular Moreover, $e^{e^e}$ connects with the Mirimanoff prime couple, central in Number Theory, showing a non-standard symmetry meson eta-lepton tau and leads below to an expression for the inverse fine-structure constant $a$ in its 0.15 ppb indetermination (section 5.3).


%In this article, the search for precision correlations uses the precisely defined values obtained by the "Optimal Correlation Principle" (Tables 1 and 2) \cite{Sanchez3}. It is supposed that the scalar boson/electron mass ratio is $H^{(0)}=495^2$, as confirmed in this article to 0.1 ppm. The corresponding gauge coupling \textit{brute} constants for the groups U(1) and SU(2) are, with $cos \theta = W/Z$ : 

%The optimized gravitation constant is $G \approx 6.675453718$ (SI). By respect to the electron mass, the Planck mass is $P \approx 2.389015908~\times~ 10^{22}$, the weak bosons masses are $W \approx 157340.1093$ and $Z \approx 178451.7402$, \textit{in ppb accordance} with the $4^{th}$ formula of table 2. The leptons masses are $\mu \approx 206.7682869$ and $\tau \approx 3477.441701$, obtained trought the so elegant Koide empiric relation \cite{Koide}. The \textit{inverse} coupling constants are noted $a = 1/\alpha$ (electric coupling), $\sqrt{a_w} \approx 573007.3652$ (weak coupling), $a_s = a_w/2\pi (pH)^{3/2}\approx 8.4354502914$ (strong coupling), $a_G = hc/Gm_p m_H \approx 1.691936~\times~10^{38}$ (gravitational coupling). Note that $a_w \approx (2\times 137\Gamma)^3$ was very precisely related to the Atiyah's constant $\Gamma=\gamma a/\pi$.  

%with $q$ the \textit{adimensional} electric charge. 

%This "Maximal Correlation Principle" between the standad "free parameters" will induce the value of the SU(3) coupling $g_3 \approx 1.221$, see Eq.(5). This Principle is consistent with the identification of the "free parameters" with "computation bases". This supports the pertinence of the "economic numbers" $a^a$, $210^{210}$ and $\mu^{\mu}$. Indeed, it was shown that the "basic economic numbers" of the form exp(exp(exp... plays a central role in the cosmic computation, entering two formula in the Hubble radius Table \ref{tab:6:table6}. 

%Albeit contrary mention, this article uses the Well defined particle data, defined by maximal correlation \cite{Sanchez3}. 
...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Maximal Number of Intersection of Diagonals from a 16-gone & $p_{00}$   & \underline {1836} & OEIS (A000332) \\
...
Combined R23W: $v_d = u_{2D = 2(d+3)} = 1 + 2(d+3) + 8 (d+3)^2$ for d = 12 & $u_{8}$    & $ \underline {1831} $ & from 30D to 12D \\ 
  
 R23W for $d$ = 8:  Eddington's formula: $u_{8}= 136 + 1$ & $u_{8}$   & $ \underline {137} $ & \cite{Eddington} \\   
    
  Combined R23W for d = 1 & $u_{2\times (1+3)}$    & $ \underline {137} $ & from 12D to 1D \\  
    
    Atiyah constant $2^7 + 2^3 + 2^0$  & $a_{00}$    & $\underline {137}$ & from three algebra \cite{Atiyah} \\
    ...
    Square root of $88^2 + 105^2$, where 105 = Part(19) , 88 = Part(18)    & $a_{00}$    & $\underline {137}$ & $88 \times 105 = 5\times s_{65}$ \\
    ...
    Optimised series with the last Wieferich prime $137 + 1/28 + 1/W_2$  & $a_0$    & $\underline {137.035999104}$ &  \\
  ...
  Optimised SU(2) Gauge coupling $W/H^{(0)}$  &  $g_2$  & $\underline {0.6421390}$ &  0.1 ppm \\ 
 
  Gravitational Coupling $p_tp_G/2a^3$ & $ g_0$  & $\underline { 0.6534149985}$ & 1 ppb \\
  
  Optimised SU(3) Gauge coupling $g_0g_2/g_1$  &  $g_3 $ & 1.2210476 & 0.1 ppm \\ 
 ...
 DNA Guanine-Cytosine couple principal mass/$m_H$ &  $o_2$   & 613.299802 & \cite{Huang} \\ 
   ...
   % This seems connectedOptimized "Effective m(Z) Squared Weak-mixing angle" $(ln\Phi)^2$  & $(\sin \theta_{effZ})^2$    & 0.23156482 & this work (0.23148(4)) \\
                         
    
    %Measured Muon/Electron mass ratio  & $\mu_{meas}$ & 206.7682830  & 22 ppb \\     
   ...
   % Measured Tau/Electron mass ratio  & $\tau_{meas}$ & 3477(2)  & $7\times 10^4$ \\        
    Optimized Koide Tau/Electron mass ratio  & $\tau$ & 3477.441701  &  $\tau_{mes}$: 3477(2) \\  
 Fermi Sanchez-Atiyah mass ratio: $\sqrt {a_w}$ & $F$   & 573007.3652  & $F_{mes}$: 573007.362 \\

Product Eta-Tau mass ratioes  & $ \eta \tau$ & \underline{$3.728~\times 10^6$}  &  \\ 

Product of the Wieferich primes 1093 $ \times $ 3511  & $W_1 W_2$  & \underline{$3.837 ~\times 10^6$}  &  $W_1/\eta \approx (W_2 \beta /\tau)^2$\\ 

Third Primary Economic Number $e_3$  & $e^{e^e}$   & \underline{$3.814 ~\times 10^6$} & $e_3/e_2 \approx ap_t$  \\  
...
\end{table}
 ...
 \begin{table}
%\label{tab:3:table3}
\caption[Table \ref{tab:3:table3}: Physical constants]{ Physical constants}
\label{tab:3:table3}
 ...
 Rydbergh reduced wavelength $\lambdabar_e(2aH/p)^2$ & $\lambdabar_{Ryd}$  & m  & $1.45190673 \times 10^{-8} $ & 0.3~ppb  \\
...
% Critical density $3 c^2/ 8\pi R^2$ & $\rho_{cr}$  & $kg m^{-3}$  & $ 9.41197996 \times 10^{-27} $ & 0.3 ~ppb  \\
  ...
  %Official CMB temperature & $T_{CMBoff}$ & K & $2.7255(6)$ & $2 \times 10^5$ \\    
   ...
   CMB reduced wavelength $\hbar c/ k_B T_{CMB}$ & $\lambdabar_{CMB}  $ & m & $8.4007166 \times 10^{-4} $ & \cite{Sanchez2} \\
   CMB Wien wavelength $\lambda_{WCMB}/w_i$ & $\lambda_{CMB}/w_i $ & m & $1.0630825  \times 10^{-3} $ & \cite{Sanchez2} \\
   ...
   CMB density energy $(\pi^2/15)\hbar c/\lambda_{CMB}^4 $& $u_{CMB} =  $ & $J m^{-3}$ &  $4.1767647  \times 10^{-14} $ &  \\
   
   Radiation density energy $ u_{CMB}+u{CNB}  = y u_{CMB}$ & $u_{rad}  $ & $J m^{-3}$ &  $7.0224862  \times 10^{-14} $ &  \\
   
   Critical Matter versus radiation ratio $\rho c^2/u_{CMB+CNB} $& $K_E$ & - &  \underline {12045.685} & $ p_t H /8\beta \pi^2q \sqrt a \approx p_t^3/(4\pi)^2 \sqrt \pi p_W$  \\
   
   Square root of critical entropy $(2Mn_{ph}/m_H)^{1/2}$ & $K_n$ &- & \underline {12087.731}  & $(K_E K_n p_t/n_t)^{1/2} \approx g_2 a^2$ \\
   
   
   
   Optimised CNB temperature $T_{CMB}/(11/4)^{1/3}$ & $T_{CNB}$ & K & $1.9455976$ &   \\
   
   Neutrino (CNB) reduced wavelength  $\lambdabar_{CNB} \times (11/4)^{1/3} $ & $\lambdabar_{CNB} = $ & m & $1.176957 \times 10^{-3} $ & \cite{Sanchez2} \\
   ...
   Cosmos holographic reduced mass & $M_N$ & kg & $1.15308454 \times 10^{53} $ & \cite{Sanchez2} \\
...
%ymin=0,
%ymax=2,
%title={characteristics length follow the law $exp(2^{d/4})$, unit length: electron Compton reduced wavelength: $\hbar/m_ec=\lambdabar_e$}, 
...
%With the electric charge \draw[color=red] (5.,0.) -- (5.,3.43);
...
\node [anchor = text=black] at (-28.,-38.0) {\small{Bosonic string dimensions: $d=4k+2$ from k=0 to k=7 (Bott sequence). From k= 0 to k = 4: spectroscopic numbers}};
...
\node [anchor = west,color=black!40!green] at (0.,0.0) {$\times~4/g_3 $};
...
\node [cross,anchor = west,color=red] at (3.15,3.15){$\Rightarrow 2.73 Kelvin \approx T_{mam}/j$};
...
\end{tikzpicture}
\caption[Graphics \ref{AxeTopologique}: Topological Axis ]{The Topological Axis follows the law $exp(2^{d/4})$ for the main physical characteristics lengths, with unit length the electron Compton reduced wavelength: $\hbar/ m_ec=\lambdabar_e$. This is the reunion of height 2D-1D holographic relations, hence the name `Topological Axis', and the extrapolation towards smaller numbers of the Eddington's Large Number correlations. The double natural logarithms $y = ln(ln(Y))$ of the main dimensionless physical quantities ($Y$) corresponds to the special string dimension series, which identifies with the spectroscopic series with spin 2, where $k$ is the orbital quantum number, $d = 4k + 2$, from $k = 0$ to $k = 7$, characteristics of a Bott octonion sequence, as anticipated by Atiyah, whose constant $\Gamma=\gamma a/\pi$ is central. The mean value $d=16$ connects directly with the DNA bi-codon, decisive in the Holic Cosmology, where $g_3$ is the Weinberg-Sanchez SU(3) unification factor (Eq(4)), $\phi_s$ a special value of the golden number, $m_N = a m_e$ the Nambu mass, and $j = 8\pi^2/ln2$ the scale factor \cite{Sanchez3}.}
%\end{figure}
%\label{tab:1:table1}
...
\label{tab:6:table6}
 ...
 %$ R_e\lambdabar_H/g_3l_P2^{129/2} $  & 13.81197801 & From $1/g_0 = 1+g_1^2+g_2^2\approx2a^3/pp_G$\\
 
 $ (\lambdabar_{p} \lambdabar_{H})^{1/2} a_w^{7/2} a/2\sqrt 5 $  & 13.81197801 & From $(WZ)^8 \approx a^2a_w^7/20$\\
 
 %$ 2l_P (aZ/(\sqrt a_w +\pi_q/3))^2 2^{3\times 127/2} $ & 13.81197674 & Liaison between Z and the electric charge $q$ \\
...
% $ R/\lambdabar_e  \approx 6H (2\pi_{hol} a^3)^5 $& 13.81197676    &  Holographique, avec     $\pi_{hol} = 3 + 1/(7+1/(16+2/e^{2e}))$\\
 ...
 $ (32 \beta^2 /\pi^3) \lambdabar_{CMB}^3/ \lambdabar_Z^2$ & 13.8119962 & from the holographic relation $2\pi R/\lambdabar_e \approx (4\pi/3) (\lambdabar_{CMB}/\lambdabar_{H_2})^3$ \\ 
 ...
 $(H/p_W)(2\pi^2 a^3)^5 \lambdabar_{e} $ & 13.811956 & with $p_W = 6\pi^5$, 5D holography in the gravitational Hydrogen molecule \cite{Sanchez3}  \\
  ...
  %$ 4 a^4 \lambdabar_{e} (pn)^{17/4} p_K^{3/2}/p_W  $ & 13.811963 & Mean proton-neutron mass as calculation basis  \\
...
%  $ \lambdabar_{CNB}^2 \lambdabar_{CMB}^4 (ln\Phi)^8/l_P^4 R_C H^0 $  & 13.812   & Confirms the scalar boson $H^{(0)}$ and the pertinence of $ln\Phi \approx \sin \theta_{Zeff} $ \\
 ...
 % $ \lambdabar_{CMB}^6 (sin~\theta)^{2\sqrt a}/R_Cl_P^4$  & 13.809    & Liaison Cosmos-CMB thermal background \\
 ...
 %$ 2 \lambdabar_{e} (3/\sqrt2)^{10\sqrt {137}} $ & 13.81 & Corresponds to $P^2 \approx (3/\sqrt2)^a$ et $p\approx (3/\sqrt2)^{10}$     \\
...
$ \lambdabar_{e} \Gamma^{55/2}$ & 13.77 & Atiyah's constant $\Gamma$ calculation basis   \\  
 ...
 %$ (\lambdabar_{e}^2/R_1) (6/\pi_q)^{2r_H/\lambdabar_e}$  & 13.77    & with $\pi_q$ de la séparation de jauge \\
...
\subsection{The Cosmic Gravity-Microphysics connection}

The standard theory associates conservation law with symmetry. However, more generally, a conservation law can be seen as the result of a computation. So, the main hypothesis is that the Cosmos, considered as a black-hole of radius $R_C$ is a super-computer, a very controversial domain \cite{Sanchez2}. In particular, Y. Ng \cite{Ng} introduces wrongly a "quantum foam" of dimension $(Rl_P^2)^{1/3} \approx 10^{-15} $ m, a length independantly found through the Optimal Computation Principle\cite{Sanchez5}. With the above hypothesis of an \textit{invariant} Hubble radius $R$, this can be rather associated with the \textit{invariant} electron classical radius. Hence, the "classical radius" of the Universe was defined as \textit{the radius which is the simplest elimination of $c$ between the classical electron radius and the Planck length formula. Indeed the speed $c$ is dramatically too small to inter-connect a so vast Cosmos}: 
...
In this manner, in conformity with the standard model, $g_3$ is connected with the strong coupling constant, but implying the Wien factor, whose pertinence is not reckognised in the present standard model. Indeed, the Wien factor but must be central in the PSHOB cosmology, due to the thermal character of the Cosmic Microwave Background (CMB). There is a direct confirmation, precise to 0.1 ppm, of the CMB temperature invariance:

\begin{equation}\label{Eq6}
K_n = (32 \xi(3) /3\pi)^{1/2} R l_P/(\lambdabar_{CMB}^3 \lambdabar_H)^{1/2} \approx K_E (1-1/12^2)^{-1/2} 
 \end{equation}

\textit{This means there is a symmetry between radiation and matter, totally unexpected in the present standard theory. This relation has the same form than that of Eddington : $\sqrt (M/m_e) = R/2\lambdabar_H$, equivalent to eq. (1)}.
...
%The base 2 Wieferich prime couple shows a non-standard symmetry eta-tau and permits to define the fine-structure constant within its 0.15 ppb indetermination. The base 3 Mirimanoff prime couple connects to 0.1 ppm with the electron-proton-neutron triplet, tied to the  9D-10D-11D crystallographic symmetries, connected with the , through the terminal Euler suitable number. This confirms the Eddington's Fundamental Theory, in particular the non-standard symmetry proton-tau. . This excludes the concepts of Multiverse, Continuum, Infinity, Locality and Zero mass Particle, and leads to .
...
(Fig. 2).
%(figure \ref{tab:10:table10}). 
%(fig. \ref{tab:10:table10}).


%This confirms that the non-local period is tied to the computer Cosmos procedure. 
...
%By contrast, \textit{the Cosmos uses the holic exponent 210 of the base 3}. To 60 ppb:
%\begin{equation}
%((p_G/2an_t) R_C/\lambdabar_p)^{1/210} \approx 3
 %\end{equation}
...
\end{tikzpicture}
\caption[Figure \ref{figure2}: The $\hbar Gc$ Trihedra]{The Trihedra of Constants $\hbar Gc$.  The $c$-local visible Universe is a Cosmos bosonic "immergence"}
\end{figure}
...
By respect to the hydrogen mass $H$, the masses of the 4 DNA nucleotides are, using the main isotopes: $~^{1}_{1}H^{(0)} = H,~ ^{6}_{12}C = C^{(0)},~ ^{7}_{14}N = N^{(0)}, ~^{8}_{16}O = O^{(0)},~^{15}_{31}P= P^{(0)}$  \cite{Huang}, close to the Fermi mass ratio: $\sqrt {a_w/pH} \approx 311.9846$
...
%\subsection{The crystallographic connections}
...
%\label{tab:4:table4}
  \hskip-0.0cm\begin{tabular}{llllllllllllll}
    \toprule
    \multicolumn{14}{c}{Table \ref{tab:4:table4} : Number of Crystallographic Ponctual Symmetry operations $N_d$ and Wolfram series $u_d$}                  \\
    \cmidrule(r){1-14}
    ...
    $K_d$ (positive $PSO_{Cr}$)  & 1 & 5 & 5 & 19 & 19 & 59 & 59 & 165 & \underline{165} & 419 & 419 & 1001& 1001 \\
     ...
     13 final Euler ideonal nbrs  & 312 & 330 & 345 & 357 & 385 & 408 & 462 & 520 & 760 & 840 & \underline{1320}  & \underline{1365} & \underline{1848}\\
     
     
     
     $Q_d=q_d + d$  (extended $q_d$)   & 5 & 10 & 21 & 42 & 78 & \underline{135} & 220 & 341 & 507 & 728 & 1015 & 1380 & \underline{1836}\\
    
     %$K^{(d)}_-$  &  & 1 & 5 & 15 & 35 & 70 & 126 & 210 & 330 & \underline 495& 715 & 2001  \\
     
      %$K^{(d)}/2$   & 1 & 3 & 5 & 12 & 19 & 39 & 59 & 112 & 165 & 292 & 419 & 710  \\
      ...
      $u_d = 1 + d(2d+1)$ & 4 & 11 & 22 & 37 & 56 & 79 & 106 & \underline{137}  & 172 & 211 & 254 & 301 & 352 \\
      
      $v_d = u_{2 D = 2(d+3)}$ & \underline{137}  & 211 & 301 & 407 & 529 & 667 & 821 & 991  & 1177 & 1379 & 1597 & \underline{1831} & 2081 \\
...
%One notes that $N_9 = 330 = \binom{11}{4} = 2 K_9 = 2 \binom{11}{3}$, so:  
 %\begin{equation}
 %495 = \binom{12}{4} = \binom{11}{3} + \binom{11}{4} = 3\binom{11}{3} = 3K_9 = \binom{32}{2} - 1 = 496 -1
 %\end{equation}
...
%Moreover the number 1839, which is close to the neutron/electron mass ratio, appears also in the Table 5, and so implies the following: 


%\begin{equation}\label{Eq31}
%1839 = \sum_{10}^{12} K_d = \sum_1^{12} (N_d/2) + 3   ~~~~ \Rightarrow~~~~ \sum_2^9K_d = (K_{12}-9)/2 = 496  
 %\end{equation}
 
%\textit{This identifies the partial sum up to the 9D space with the above dimension of the canonic group SO(32), central in string theory. Thus the couple proton-neutron is represented by the crystallogaphic symmetries.} 
...
\begin{equation}\label{Eq33}
 ...
 %This introduces $(H/p)^{1/32} \approx (2d_e)^2 p m_{cd}^{0}/m_H \mu^3 (1+g_1^2 + g_2^2)$. 
...
%The only known couple of Wieferich numbers: $p_{W1} = 1093 = 1+ 4(16^2 + 16 + 1) =1 + 4(136+137) \approx 4 \Pi_+ $ and $p_{W2} = 3511 = 1+ 6(8^3 + 8^2 + 8 +1)$ is close to the \textit {supersymmetric} couple (meson $\eta$, fermion $\tau$). They connect with the only known couple of Mirimanoff numbers, which uses the base 3 instead of the Fermat-Wieferich base 2: $p_{M1}$ = 11 and $p_{M2} = 1006003 = 1003^2 - 6$, where $1003 = K_9 + K_{10} + K_{11}$ shows up in the Crystallographic Table. 
...
%Note that another special partition is $137 = (2s_0 + 3)/3^3 = 5\times 3^3 + 2$, where $5$ and $3^3$ are the two first co-perfect numbers. The base 3 relation with $s_0$ follows 

 %\begin{equation}
%2s_0 = 5\times 3^6 + 2\times 3^3 -3
% \end{equation}

%opening further study.
 %% replaced C_{32}^2 by \binom{32}{2}
...
%This is clearly related to the above Holic Principle
...
\bibitem{Zyla} Zyla. P.A. et al. (Particle Data Group), Prog. Theor. Exp. Phys. OB3CO1(2020).

\bibitem{Sanchez2} F.M. Sanchez, V. Kotov, M. Grosmann, D. Weigel, R. Veysseyre, C. Bizouard, N. Flawisky, D. Gayral, L. Gueroult, ``Back to Cosmos''. Progress in Physics, vol. 15, issue 2, (2019).
...
\bibitem {tHooft} t'Hooft G. The Cellular Automaton Interpretation of Quantum Mechanics. ArXiv:1405.1548v3 (2015).
...
\bibitem {Hoyle2} Hoyle F. et al., A Different Approach to Cosmology, p. 83. C.U.P, Cambridge (2000).

\bibitem {Sternhardt} Obied, G.; Ooguri, H.; Steinhardt, Paul J. (2018). "On the Cosmological Implications of the String Swampland". Phys. Lett. B. 784: 271–276. arXiv:1806.09718v2.

\bibitem{Sakharov}A. D. Sakharov, ZhETF Pis. Red. 5, 32 (1967) [ JETP Lett. 5, 24 (1967)

\bibitem{Kotov} Kotov V. A. and Lyuty V. M., “The 160-min. Periodicity in the optical and X-ray observations of extragalactic objects.” Compt. Rend. Acad. Sci. Paris 310, Ser. II, 743-748 (1990).

\bibitem{Sanchez3} Sanchez F.M., “Towards the grand unified Holic Theory”. Current Issues in Cosmology. Ed. J.-C. Pecker and J. Narlikar. Cambridge Univ. Press, 257-260 (2006).


\bibitem{Poincare3} Poincaré H., La mécanique nouvelle, Eds. Gauthiers-Villars (1924), Jacques Gabay (1989).
...
\bibitem{Sanchez4} Sanchez F. M. A Coherent Resonant Cosmology Approach and its Implications in Microphysics and Biophysics, Prog. Theor. Chem. and Phys, Springler, v. 30, p. 384, 375-407 (2017).
...
\bibitem{Sanchez4} Sanchez F.M., Kotov V. and Bizouard C., 'Towards a synthesis of two cosmologies: the steady- state flickering Universe'. Journal of Cosmology, vol 17 (2011).
...
\bibitem{Bekenstein} Bekenstein J. ``Black holes and entropy'', Phys. Rev. D 7:2333-2346 Issue:8. PhysRevD.7.2333 (1973).
...
\bibitem{Seiberg} Seiberg N. Emergent Spacetime. The Quantum Structure of Space and Time, Proccedings of the 23rd Sovay Conference on Physics, Brussels, Belgium, ed. Gross, Henneaux, Sevrin, World Scientific, 2005, 163-178.
...
\bibitem{Wyler} Wyler A., "L'espace symetrique du groupe des equations de Maxwell" C. R. Acad. Sc. Paris, t. 269, 743-745 (1969). Wyler A., C.R. Acad. Sci, and t. 272, 186-188 (1971).
...
\bibitem{Weinberger} Weinberger, P. Exponents of the class groups of complex quadratic fields. Acta Arithmetica 22 (1973), pp. 117-124.
...
\bibitem{Ribenboim} Paulo Ribenboim, 13 Lectures on Fermat's Last Theorem, Springer, 1979, pp. 23, 152-153.

\bibitem{Oganessian} Oganessian Y. et al. (2002). "Results from the first 249Cf + 48Ca experiment" (PDF). JINR Com, Dubna.

\bibitem{Schrodinger} Schrödinger E., "What is Life?", Macmillan (1944). 
