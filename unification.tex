...
\node [anchor = west,color=blue] at (-11,-12.) { \LARGE{Rayon de l'atome d'Hydrogène}$~ \approx 3f(10) \lambdabar_e /2\pi $};
...
\node [anchor = west,color=blue] at (-10,20.0){\LARGE{Rayon de l'Univers} $/  \lambdabar_e \approx f(26)/6 \approx (6/\pi)^{r_H/\lambdabar_e}$};
