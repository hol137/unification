...
It is said that the present epoch is marked by the domination of matter on radiation. It is true for the energy, and considered as a key parameter, but the reverse holds for the number of particles (the factor 2 is iterprted as the polarisation factor):

\begin{equation}\label{Eq2}
Mc^2 /(E_{CMB} + E_{CNB}) \approx \sqrt {2n_{phCMB}/n_H}~~~~~~~~~~ n_ H= M/m_H
 \end{equation}
...
% Critical density $3 c^2/ 8\pi R^2$ & $\rho_{cr}$  & $kg m^{-3}$  & $ 9.41197996 \times 10^{-27} $ & 0.3   \\
  ...
  %Official CMB temperature & $T_{CMBoff}$ & K & $2.7255(6)$ & $2 \times 10^5$ \\    
   ...
   Radiation density energy = $y u_{CMB}$ & $u_{CMB+CNB}  $ & $J m^{-3}$ &  $7.0224862  \times 10^{-14} $ &  \\
