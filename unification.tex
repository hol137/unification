...
\node [anchor = west,color=red] at (-19,-24.0) {$\Phi^4 \approx (2R_e/R \approx 4g_0)^2 \approx \sqrt {ag_1}  \approx (g_3/g_2 \approx 6/\pi = \frac {mètre}{coudée})^3   \approx  (H^0/Z \approx a/100)^6  \approx (1/g_2g_3 \approx 4/\pi)^8  $};
