...
\node [anchor = west,color=red] at (-24,-24.1) {$\Phi^4 \approx (2u \approx 4g_0)^2 \approx \sqrt {ag_1}  \approx (\frac {g_3}{g_2} \approx \frac {6}{\pi} = \frac {metre}{coudee})^3   \approx  (g_Z \approx a/100)^6  \approx ( \frac {1}{g_2g_3} \approx \frac {4}{\pi})^8  $};
