...
\begin{equation}
 \left\{
    \begin{array}{ll}
    (K_8 + K_{12})/2 = N{10} - 1 \approx p_G/\pi \\
    \\
    2\times 3 \times 5\times 7 = 210 \approx g_1 g_3 K_{12}/2       ~~~~~~\Rightarrow~~~~~~  g_1 g_3  = g_0 g_2 \approx 60/11\times 13 \\
    \\
...
showing that the prime numbers 11 and 13, following the main sequence 2;3;5;7 play a role in the gauge couplings. The last relation exhibits the double partition of 16 in prime numbers: 16 = 3 + 13 = 5 + 11. Its importance had been predicted in the original paper "Holic Principle". This explains the elimination of 7 of $1001 = 7 \times 11 \times 13$ in the above relations.
