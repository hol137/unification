...
Rule 23 Wolfram cellular automaton cutted series (R23WCACS) $ u_d = 1 + d(2d+1)$ for $d$ = 30, $k$ = 7  & $u_{30}$    & $ \underline {1831} $ & EOIS(A266438) \\

Combined R23WCACS $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 12 & $u_{8}$    & $ \underline {1831} $ & from 30D to 12D \\ 
  
 R23WCACS for $d$ = 8 & $u_{8}$    & $ \underline {137} $ & $136 + 1$ \cite{Eddington} \\   
    
  Combined R23WCACS $u_{2d\prime = 2(d+3)} = 1 + 2d + 8 d^2$ for d = 1 & $u_{2\times (1+3)}$    & $ \underline {137} $ & from 12D to 1D \\  
