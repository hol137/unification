...
red
\node [anchor = east,color=red] at (27.75,-3.5){$(\frac { \sqrt {e^{e^e}}}{a_s} )^3 \approx 3570 ~\tau$~~ (30 ppm)};

\node [anchor = east,color=red] at (16.75,-3.5){$p_{hol} = (4(r_H/\lambdabar_e = aH/p)^3/3)^{1/2}$};
